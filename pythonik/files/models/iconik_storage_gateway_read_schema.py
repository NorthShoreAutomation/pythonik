...
from ..models.iconik_storage_gateway_read_schema_roles_item import (
...
if TYPE_CHECKING:
    from ..models.iconik_storage_gateway_read_schema_storages import (
...
T = TypeVar("T", bound="IconikStorageGatewayReadSchema")


@_attrs_define
class IconikStorageGatewayReadSchema:
    """
    Attributes:
        ...
        roles (list[IconikStorageGatewayReadSchemaRolesItem] | Unset): Set of roles this gateway can perform when part
            of cluster
        settings (ISGConfigSettingsSchema | None | Unset): Application configuration settings as key-value pairs
        status (IconikStorageGatewayReadSchemaStatus | Unset):
        storage_addr (str | Unset): Server address for direct transfers between storage gateways
        storages (IconikStorageGatewayReadSchemaStorages | Unset): Storage mount points mapped by storage ID
    ...
    roles: list[IconikStorageGatewayReadSchemaRolesItem] | Unset = UNSET
    settings: ISGConfigSettingsSchema | None | Unset = UNSET
    status: IconikStorageGatewayReadSchemaStatus | Unset = UNSET
    storage_addr: str | Unset = UNSET
    storages: IconikStorageGatewayReadSchemaStorages | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _roles is not UNSET:
            ...
            for roles_item_data in _roles:
                roles_item = IconikStorageGatewayReadSchemaRolesItem(roles_item_data)
        ...
        if isinstance(_status, Unset):
            ...
            status = IconikStorageGatewayReadSchemaStatus(_status)

        storage_addr = d.pop("storage_addr", UNSET)

        _storages = d.pop("storages", UNSET)
        storages: IconikStorageGatewayReadSchemaStorages | Unset
        if isinstance(_storages, Unset):
            storages = UNSET
        else:
            storages = IconikStorageGatewayReadSchemaStorages.from_dict(_storages)
        ...
        iconik_storage_gateway_read_schema = cls(
            enabled=enabled,
            name=name,
        ...
        iconik_storage_gateway_read_schema.additional_properties = d
        return iconik_storage_gateway_read_schema
