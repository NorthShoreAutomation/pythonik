...
T = TypeVar("T", bound="PlaylistsSchema")


@_attrs_define
class PlaylistsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[Playlist] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[Playlist] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[Playlist] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = Playlist.from_dict(objects_type_0_item_data)
                ...
                pass
            return cast(list[Playlist] | None | Unset, data)
        ...
        playlists_schema.additional_properties = d
