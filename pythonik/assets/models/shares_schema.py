...
T = TypeVar("T", bound="SharesSchema")
...
class SharesSchema:
    """
    Attributes:
        objects (list[ShareSchema] | None | Unset):
    """

    objects: list[ShareSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[ShareSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = ShareSchema.from_dict(
                ...
                pass
            return cast(list[ShareSchema] | None | Unset, data)
        ...
        shares_schema.additional_properties = d
