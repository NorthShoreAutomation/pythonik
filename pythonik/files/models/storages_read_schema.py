...
if TYPE_CHECKING:
    ...
    from ..models.storages_read_schema_facets_type_0 import (
        StoragesReadSchemaFacetsType0,
    )


T = TypeVar("T", bound="StoragesReadSchema")


@_attrs_define
class StoragesReadSchema:
    """
    Attributes:
        facets (None | StoragesReadSchemaFacetsType0 | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[StorageReadSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: None | StoragesReadSchemaFacetsType0 | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[StorageReadSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, StoragesReadSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(data: object) -> None | StoragesReadSchemaFacetsType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = StoragesReadSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | StoragesReadSchemaFacetsType0 | Unset, data)
        ...
        def _parse_objects(data: object) -> list[StorageReadSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = StorageReadSchema.from_dict(
        ...
        storages_read_schema.additional_properties = d
        return storages_read_schema
