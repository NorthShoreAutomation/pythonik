...
if TYPE_CHECKING:
    from ..models.bulk_collection_ac_ls_update_schema_callback_data_request_type_0 import (
        BulkCollectionACLsUpdateSchemaCallbackDataRequestType0,
    )
    from ..models.bulk_collection_ac_ls_update_schema_callback_data_type_0 import (
        BulkCollectionACLsUpdateSchemaCallbackDataType0,
    )


T = TypeVar("T", bound="BulkCollectionACLsUpdateSchema")


@_attrs_define
class BulkCollectionACLsUpdateSchema:
    """
    Attributes:
        ...
        callback_data (BulkCollectionACLsUpdateSchemaCallbackDataType0 | None | Unset):
        callback_data_request (BulkCollectionACLsUpdateSchemaCallbackDataRequestType0 | None | Unset):
    ...
    callback_data_request: (
        BulkCollectionACLsUpdateSchemaCallbackDataRequestType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.callback_data, Unset):
            ...
            self.callback_data, BulkCollectionACLsUpdateSchemaCallbackDataType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_callback_data(
            data: object,
        ) -> BulkCollectionACLsUpdateSchemaCallbackDataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                callback_data_type_0 = (
                    BulkCollectionACLsUpdateSchemaCallbackDataType0.from_dict(data)
                )
                ...
                pass
            return cast(
                BulkCollectionACLsUpdateSchemaCallbackDataType0 | None | Unset, data
            )
        ...
        def _parse_callback_data_request(
            ...
            try:
                ...
                callback_data_request_type_0 = (
                    BulkCollectionACLsUpdateSchemaCallbackDataRequestType0.from_dict(
                        data
                    )
                )
        ...
        bulk_collection_ac_ls_update_schema = cls(
            collection_ids=collection_ids,
            include_assets=include_assets,
            include_collections=include_collections,
            job_id=job_id,
        ...
        bulk_collection_ac_ls_update_schema.additional_properties = d
        return bulk_collection_ac_ls_update_schema
