...
if TYPE_CHECKING:
    ...
    from ..models.transcoders_by_storage_schema_facets import (
...
class TranscodersByStorageSchema:
    """
    Attributes:
        facets (TranscodersByStorageSchemaFacets | Unset):
        first_url (str | Unset):
        last_url (str | Unset):
        next_url (str | Unset):
        objects (list[TranscoderByStorageReadSchema] | Unset):
        page (int | Unset):
        pages (int | Unset):
        per_page (int | Unset):
        prev_url (str | Unset):
    ...
    facets: TranscodersByStorageSchemaFacets | Unset = UNSET
    first_url: str | Unset = UNSET
    last_url: str | Unset = UNSET
    next_url: str | Unset = UNSET
    objects: list[TranscoderByStorageReadSchema] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_facets, Unset):
            ...
            facets = TranscodersByStorageSchemaFacets.from_dict(_facets)
        ...
        if _objects is not UNSET:
            ...
            for objects_item_data in _objects:
                objects_item = TranscoderByStorageReadSchema.from_dict(
                    objects_item_data
                )
