...
T = TypeVar("T", bound="SequenceCreateSchema")


@_attrs_define
class SequenceCreateSchema:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sequence_create_schema.additional_properties = d
        return sequence_create_schema
