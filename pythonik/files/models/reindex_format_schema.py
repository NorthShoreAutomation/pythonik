...
T = TypeVar("T", bound="ReindexFormatSchema")


@_attrs_define
class ReindexFormatSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_format_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_format_schema.additional_properties = d
        return reindex_format_schema
