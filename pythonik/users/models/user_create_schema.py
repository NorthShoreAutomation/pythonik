...
from ..models.user_create_schema_onboarding_goal import UserCreateSchemaOnboardingGoal
from ..models.user_create_schema_status import UserCreateSchemaStatus
...
class UserCreateSchema:
    ...
    Attributes:
        ...
        metadata (Any | Unset):
        onboarding_goal (None | Unset | UserCreateSchemaOnboardingGoal):
        ...
        status (None | Unset | UserCreateSchemaStatus):
    ...
    onboarding_goal: None | Unset | UserCreateSchemaOnboardingGoal = UNSET
    ...
    status: None | Unset | UserCreateSchemaStatus = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.onboarding_goal, UserCreateSchemaOnboardingGoal):
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, UserCreateSchemaStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_onboarding_goal(
            data: object,
        ) -> None | Unset | UserCreateSchemaOnboardingGoal:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                onboarding_goal_type_1 = UserCreateSchemaOnboardingGoal(data)

                return onboarding_goal_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UserCreateSchemaOnboardingGoal, data)
        ...
        def _parse_status(data: object) -> None | Unset | UserCreateSchemaStatus:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = UserCreateSchemaStatus(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UserCreateSchemaStatus, data)
