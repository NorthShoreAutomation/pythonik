...
class UserElasticSchema:
    ...
    Attributes:
        ...
        metadata (Any | Unset):
        onboarding_goal (UserElasticSchemaOnboardingGoal | Unset):
        password (str | Unset):
        ...
        status (UserElasticSchemaStatus | Unset):
    ...
    onboarding_goal: UserElasticSchemaOnboardingGoal | Unset = UNSET
    ...
    status: UserElasticSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_onboarding_goal, Unset):
            ...
            onboarding_goal = UserElasticSchemaOnboardingGoal(_onboarding_goal)
        ...
        if isinstance(_status, Unset):
            ...
            status = UserElasticSchemaStatus(_status)
