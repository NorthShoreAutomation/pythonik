...
T = TypeVar("T", bound="TransferCollectionToStorageRequest")


@_attrs_define
class TransferCollectionToStorageRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfer_collection_to_storage_request = cls(
            id=id,
        ...
        transfer_collection_to_storage_request.additional_properties = d
        return transfer_collection_to_storage_request
