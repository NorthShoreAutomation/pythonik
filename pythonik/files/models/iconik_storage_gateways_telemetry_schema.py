...
T = TypeVar("T", bound="IconikStorageGatewaysTelemetrySchema")


@_attrs_define
class IconikStorageGatewaysTelemetrySchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[IconikStorageGatewayTelemetrySchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[IconikStorageGatewayTelemetrySchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[IconikStorageGatewayTelemetrySchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = IconikStorageGatewayTelemetrySchema.from_dict(
                ...
                pass
            return cast(list[IconikStorageGatewayTelemetrySchema] | None | Unset, data)
        ...
        iconik_storage_gateways_telemetry_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        iconik_storage_gateways_telemetry_schema.additional_properties = d
        return iconik_storage_gateways_telemetry_schema
