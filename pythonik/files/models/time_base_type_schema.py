...
T = TypeVar("T", bound="TimeBaseTypeSchema")


@_attrs_define
class TimeBaseTypeSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        time_base_type_schema = cls(
            denominator=denominator,
            numerator=numerator,
        )

        time_base_type_schema.additional_properties = d
        return time_base_type_schema
