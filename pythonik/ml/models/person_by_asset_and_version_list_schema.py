...
class PersonByAssetAndVersionListSchema:
    """
    Attributes:
        objects (list[PersonByAssetAndVersion] | None | Unset):
    """

    objects: list[PersonByAssetAndVersion] | None | Unset = UNSET
        ...
        def _parse_objects(
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = PersonByAssetAndVersion.from_dict(
