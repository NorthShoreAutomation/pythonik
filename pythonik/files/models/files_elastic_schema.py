...
if TYPE_CHECKING:
    from ..models.file_elastic_schema import FileElasticSchema
    from ..models.files_elastic_schema_facets_type_0 import (
        FilesElasticSchemaFacetsType0,
    )


T = TypeVar("T", bound="FilesElasticSchema")


@_attrs_define
class FilesElasticSchema:
    """
    Attributes:
        facets (FilesElasticSchemaFacetsType0 | None | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[FileElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: FilesElasticSchemaFacetsType0 | None | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[FileElasticSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, FilesElasticSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(data: object) -> FilesElasticSchemaFacetsType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = FilesElasticSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(FilesElasticSchemaFacetsType0 | None | Unset, data)
        ...
        def _parse_objects(data: object) -> list[FileElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = FileElasticSchema.from_dict(
                ...
                pass
            return cast(list[FileElasticSchema] | None | Unset, data)
        ...
        files_elastic_schema.additional_properties = d
        return files_elastic_schema
