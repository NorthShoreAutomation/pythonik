...
if TYPE_CHECKING:
    ...
    from ..models.segment_elastic_schema_metadata import SegmentElasticSchemaMetadata
...
class SegmentElasticSchema:
    ...
    Attributes:
        ...
        metadata (SegmentElasticSchemaMetadata | Unset):
        ...
        status (SegmentElasticSchemaStatus | Unset):
    ...
    metadata: SegmentElasticSchemaMetadata | Unset = UNSET
    ...
    status: SegmentElasticSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.drawing_schema import DrawingSchema
        from ..models.face_bounding_box_schema import FaceBoundingBoxSchema
        from ..models.segment_elastic_schema_metadata import (
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = SegmentElasticSchemaMetadata.from_dict(_metadata)
        ...
        if isinstance(_status, Unset):
            ...
            status = SegmentElasticSchemaStatus(_status)
