...
T = TypeVar("T", bound="TransferSavedSearchToStorageRequest")


@_attrs_define
class TransferSavedSearchToStorageRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfer_saved_search_to_storage_request = cls(
            id=id,
        ...
        transfer_saved_search_to_storage_request.additional_properties = d
        return transfer_saved_search_to_storage_request
