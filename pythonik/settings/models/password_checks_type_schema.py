...
T = TypeVar("T", bound="PasswordChecksTypeSchema")


@_attrs_define
class PasswordChecksTypeSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        password_checks_type_schema = cls(
            digits=digits,
            lowercase=lowercase,
        ...
        password_checks_type_schema.additional_properties = d
        return password_checks_type_schema
