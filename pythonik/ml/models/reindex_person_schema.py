...
T = TypeVar("T", bound="ReindexPersonSchema")


@_attrs_define
class ReindexPersonSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_person_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_person_schema.additional_properties = d
        return reindex_person_schema
