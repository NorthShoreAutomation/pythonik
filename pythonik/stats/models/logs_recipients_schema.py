...
T = TypeVar("T", bound="LogsRecipientsSchema")


@_attrs_define
class LogsRecipientsSchema:
    """
    Attributes:
        objects (list[LogsRecipientSchema] | None | Unset):
    """

    objects: list[LogsRecipientSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[LogsRecipientSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = LogsRecipientSchema.from_dict(
                ...
                pass
            return cast(list[LogsRecipientSchema] | None | Unset, data)

        objects = _parse_objects(d.pop("objects", UNSET))

        logs_recipients_schema = cls(
            objects=objects,
        )

        logs_recipients_schema.additional_properties = d
        return logs_recipients_schema
