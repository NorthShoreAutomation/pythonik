...
class FileSetSchema:
    ...
    Attributes:
        ...
        status (FileSetSchemaStatus | Unset):
        storage_id (UUID | Unset):
        type_ (FileSetSchemaType | Unset):
    ...
    status: FileSetSchemaStatus | Unset = UNSET
    storage_id: UUID | Unset = UNSET
    type_: FileSetSchemaType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = FileSetSchemaStatus(_status)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = FileSetSchemaType(_type_)
        ...
        file_set_schema.additional_properties = d
        return file_set_schema
