...
class AssetPostCreate:
    ...
    Attributes:
        title (str):
        analyze_status (AssetPostCreateAnalyzeStatus | Unset):
        archive_status (AssetPostCreateArchiveStatus | Unset):
        ...
        face_recognition_status (AssetPostCreateFaceRecognitionStatus | Unset):
        favoured (bool | Unset):
        ...
        publication_status (AssetPostCreatePublicationStatus | Unset):  Default:
            AssetPostCreatePublicationStatus.PUBLISHED.
        site_name (None | str | Unset):
        status (AssetPostCreateStatus | Unset):
        time_end_milliseconds (int | Unset):
        time_start_milliseconds (int | Unset):
        type_ (AssetPostCreateType | Unset):
    ...
    title: str
    analyze_status: AssetPostCreateAnalyzeStatus | Unset = UNSET
    archive_status: AssetPostCreateArchiveStatus | Unset = UNSET
    ...
    face_recognition_status: AssetPostCreateFaceRecognitionStatus | Unset = UNSET
    ...
    publication_status: AssetPostCreatePublicationStatus | Unset = (
        AssetPostCreatePublicationStatus.PUBLISHED
    )
    site_name: None | str | Unset = UNSET
    status: AssetPostCreateStatus | Unset = UNSET
    time_end_milliseconds: int | Unset = UNSET
    time_start_milliseconds: int | Unset = UNSET
    type_: AssetPostCreateType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_analyze_status, Unset):
            ...
            analyze_status = AssetPostCreateAnalyzeStatus(_analyze_status)
        ...
        if isinstance(_archive_status, Unset):
            ...
            archive_status = AssetPostCreateArchiveStatus(_archive_status)
        ...
        if isinstance(_face_recognition_status, Unset):
            ...
            face_recognition_status = AssetPostCreateFaceRecognitionStatus(
        ...
        if isinstance(_publication_status, Unset):
            ...
            publication_status = AssetPostCreatePublicationStatus(_publication_status)
        ...
        if isinstance(_status, Unset):
            ...
            status = AssetPostCreateStatus(_status)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = AssetPostCreateType(_type_)
