...
T = TypeVar("T", bound="StoragesQueryParamsSchema")


@_attrs_define
class StoragesQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        storages_query_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        storages_query_params_schema.additional_properties = d
        return storages_query_params_schema
