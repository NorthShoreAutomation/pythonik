...
if TYPE_CHECKING:
    ...
    from ..models.job_schema_children_progress import JobSchemaChildrenProgress
    from ..models.job_schema_job_context import JobSchemaJobContext
    from ..models.job_schema_metadata import JobSchemaMetadata
...
class JobSchema:
    ...
    Attributes:
        ...
        children_progress (JobSchemaChildrenProgress | Unset):
        ...
        id (UUID | Unset):
        job_context (JobSchemaJobContext | Unset):
        message (str | Unset):
        metadata (JobSchemaMetadata | Unset):
    ...
    children_progress: JobSchemaChildrenProgress | Unset = UNSET
    ...
    id: UUID | Unset = UNSET
    job_context: JobSchemaJobContext | Unset = UNSET
    message: str | Unset = UNSET
    metadata: JobSchemaMetadata | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_children_progress, Unset):
            ...
            children_progress = JobSchemaChildrenProgress.from_dict(_children_progress)
        ...
        if isinstance(_job_context, Unset):
            ...
            job_context = JobSchemaJobContext.from_dict(_job_context)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = JobSchemaMetadata.from_dict(_metadata)
