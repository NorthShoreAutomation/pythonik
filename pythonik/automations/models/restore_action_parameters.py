...
T = TypeVar("T", bound="RestoreActionParameters")


@_attrs_define
class RestoreActionParameters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restore_action_parameters.additional_properties = d
        return restore_action_parameters
