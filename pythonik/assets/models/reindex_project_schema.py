...
T = TypeVar("T", bound="ReindexProjectSchema")


@_attrs_define
class ReindexProjectSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_project_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_project_schema.additional_properties = d
        return reindex_project_schema
