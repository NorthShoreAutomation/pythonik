...
T = TypeVar("T", bound="TranscribeActionParameters")


@_attrs_define
class TranscribeActionParameters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transcribe_action_parameters = cls(
            engine=engine,
            force=force,
            language=language,
            speakers=speakers,
        ...
        transcribe_action_parameters.additional_properties = d
        return transcribe_action_parameters
