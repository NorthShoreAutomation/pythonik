...
T = TypeVar("T", bound="JobsBulkActionSchema")


@_attrs_define
class JobsBulkActionSchema:
    """
    Attributes:
        job_ids (list[UUID]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobs_bulk_action_schema = cls(
            job_ids=job_ids,
        )

        jobs_bulk_action_schema.additional_properties = d
        return jobs_bulk_action_schema
