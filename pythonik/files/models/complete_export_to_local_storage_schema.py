...
if TYPE_CHECKING:
    from ..models.complete_export_to_local_storage_schema_job_steps import (
...
class CompleteExportToLocalStorageSchema:
    ...
    Attributes:
        ...
        job_id (UUID | Unset):
        job_steps (CompleteExportToLocalStorageSchemaJobSteps | Unset):
    ...
    job_steps: CompleteExportToLocalStorageSchemaJobSteps | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_job_steps, Unset):
            ...
            job_steps = CompleteExportToLocalStorageSchemaJobSteps.from_dict(_job_steps)
