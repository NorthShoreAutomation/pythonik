...
from ..models.user_create_schema_type import UserCreateSchemaType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.user_create_schema_onboarding_goal_type_1 import (
        UserCreateSchemaOnboardingGoalType1,
    )
    from ..models.user_create_schema_status_type_1 import UserCreateSchemaStatusType1
...
class UserCreateSchema:
    ...
    Attributes:
        ...
        metadata (Any | Unset):
        onboarding_goal (None | Unset | UserCreateSchemaOnboardingGoalType1):
        ...
        status (None | Unset | UserCreateSchemaStatusType1):
    ...
    onboarding_goal: None | Unset | UserCreateSchemaOnboardingGoalType1 = UNSET
    ...
    status: None | Unset | UserCreateSchemaStatusType1 = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.user_create_schema_status_type_1 import (
        ...
        elif isinstance(self.onboarding_goal, UserCreateSchemaOnboardingGoalType1):
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, UserCreateSchemaStatusType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = UserCreateSchemaType(d.pop("type"))
        ...
        def _parse_onboarding_goal(
            data: object,
        ) -> None | Unset | UserCreateSchemaOnboardingGoalType1:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                onboarding_goal_type_1 = UserCreateSchemaOnboardingGoalType1.from_dict(
                    data
                )
                ...
                pass
            return cast(None | Unset | UserCreateSchemaOnboardingGoalType1, data)
        ...
        def _parse_status(data: object) -> None | Unset | UserCreateSchemaStatusType1:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                status_type_1 = UserCreateSchemaStatusType1.from_dict(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UserCreateSchemaStatusType1, data)
