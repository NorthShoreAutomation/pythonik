...
from ..models.acl_update_schema_mode import ACLUpdateSchemaMode
from ..models.acl_update_schema_permissions_item import ACLUpdateSchemaPermissionsItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="ACLUpdateSchema")


@_attrs_define
class ACLUpdateSchema:
    """
    Attributes:
        mode (ACLUpdateSchemaMode):
        permissions (list[ACLUpdateSchemaPermissionsItem]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        mode = ACLUpdateSchemaMode(d.pop("mode"))

        permissions = []
        _permissions = d.pop("permissions")
        for permissions_item_data in _permissions:
            permissions_item = ACLUpdateSchemaPermissionsItem(permissions_item_data)
        ...
        acl_update_schema.additional_properties = d
        return acl_update_schema
