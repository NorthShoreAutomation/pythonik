...
from ..models.asset_history_schema_operation_type import AssetHistorySchemaOperationType
from ..types import UNSET, Unset

T = TypeVar("T", bound="AssetHistorySchema")


@_attrs_define
class AssetHistorySchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        asset_history_schema.additional_properties = d
        return asset_history_schema
