...
if TYPE_CHECKING:
    ...
    from ..models.groups_schema_facets_type_0 import GroupsSchemaFacetsType0


T = TypeVar("T", bound="GroupsSchema")
...
class GroupsSchema:
    """
    Attributes:
        facets (GroupsSchemaFacetsType0 | None | Unset):
    ...
    facets: GroupsSchemaFacetsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, GroupsSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(data: object) -> GroupsSchemaFacetsType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = GroupsSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GroupsSchemaFacetsType0 | None | Unset, data)
        ...
        groups_schema.additional_properties = d
        return groups_schema
