...
T = TypeVar("T", bound="AssetPostCreateSchema")


@_attrs_define
class AssetPostCreateSchema:
    """
    Attributes:
        title (str):
        analyze_status (AssetPostCreateSchemaAnalyzeStatus | Unset):
        archive_status (AssetPostCreateSchemaArchiveStatus | Unset):
        ...
        face_recognition_status (AssetPostCreateSchemaFaceRecognitionStatus | Unset):
        favoured (bool | Unset):
        ...
        publication_status (AssetPostCreateSchemaPublicationStatus | Unset):  Default:
            AssetPostCreateSchemaPublicationStatus.PUBLISHED.
        site_name (None | str | Unset):
        status (AssetPostCreateSchemaStatus | Unset):
        time_end_milliseconds (int | Unset):
        time_start_milliseconds (int | Unset):
        type_ (AssetPostCreateSchemaType | Unset):
    ...
    title: str
    analyze_status: AssetPostCreateSchemaAnalyzeStatus | Unset = UNSET
    archive_status: AssetPostCreateSchemaArchiveStatus | Unset = UNSET
    ...
    face_recognition_status: AssetPostCreateSchemaFaceRecognitionStatus | Unset = UNSET
    ...
    publication_status: AssetPostCreateSchemaPublicationStatus | Unset = (
        AssetPostCreateSchemaPublicationStatus.PUBLISHED
    )
    site_name: None | str | Unset = UNSET
    status: AssetPostCreateSchemaStatus | Unset = UNSET
    time_end_milliseconds: int | Unset = UNSET
    time_start_milliseconds: int | Unset = UNSET
    type_: AssetPostCreateSchemaType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_analyze_status, Unset):
            ...
            analyze_status = AssetPostCreateSchemaAnalyzeStatus(_analyze_status)
        ...
        if isinstance(_archive_status, Unset):
            ...
            archive_status = AssetPostCreateSchemaArchiveStatus(_archive_status)
        ...
        if isinstance(_face_recognition_status, Unset):
            ...
            face_recognition_status = AssetPostCreateSchemaFaceRecognitionStatus(
        ...
        if isinstance(_publication_status, Unset):
            ...
            publication_status = AssetPostCreateSchemaPublicationStatus(
                _publication_status
            )
        ...
        if isinstance(_status, Unset):
            ...
            status = AssetPostCreateSchemaStatus(_status)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = AssetPostCreateSchemaType(_type_)
        ...
        asset_post_create_schema.additional_properties = d
        return asset_post_create_schema
