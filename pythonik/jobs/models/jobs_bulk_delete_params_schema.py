...
from ..models.jobs_bulk_delete_params_schema_status_type_0_item import (
    JobsBulkDeleteParamsSchemaStatusType0Item,
)
from ..models.jobs_bulk_delete_params_schema_type_type_0_item import (
...
class JobsBulkDeleteParamsSchema:
    ...
    Attributes:
        ...
        status (list[JobsBulkDeleteParamsSchemaStatusType0Item] | None | Unset):
        type_ (list[JobsBulkDeleteParamsSchemaTypeType0Item] | None | Unset):
    """
    ...
    status: list[JobsBulkDeleteParamsSchemaStatusType0Item] | None | Unset = UNSET
    type_: list[JobsBulkDeleteParamsSchemaTypeType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_status(
            data: object,
        ) -> list[JobsBulkDeleteParamsSchemaStatusType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for status_type_0_item_data in _status_type_0:
                    status_type_0_item = JobsBulkDeleteParamsSchemaStatusType0Item(
                ...
                pass
            return cast(
                list[JobsBulkDeleteParamsSchemaStatusType0Item] | None | Unset, data
            )
        ...
        def _parse_type_(
            data: object,
        ) -> list[JobsBulkDeleteParamsSchemaTypeType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for type_type_0_item_data in _type_type_0:
                    type_type_0_item = JobsBulkDeleteParamsSchemaTypeType0Item(
                ...
                pass
            return cast(
                list[JobsBulkDeleteParamsSchemaTypeType0Item] | None | Unset, data
            )
