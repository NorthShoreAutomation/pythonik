...
class FilesSchema:
    ...
    Attributes:
        ...
        objects (list[FileSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[FileSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[FileSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = FileSchema.from_dict(objects_type_0_item_data)
                ...
                pass
            return cast(list[FileSchema] | None | Unset, data)
        ...
        files_schema.additional_properties = d
        return files_schema
