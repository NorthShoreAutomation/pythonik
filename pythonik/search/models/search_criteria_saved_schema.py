...
from ..models.search_criteria_saved_schema_doc_types_type_0_item import (
...
T = TypeVar("T", bound="SearchCriteriaSavedSchema")


@_attrs_define
class SearchCriteriaSavedSchema:
    """
    Attributes:
        doc_types (list[SearchCriteriaSavedSchemaDocTypesType0Item] | None | Unset):
    ...
    doc_types: list[SearchCriteriaSavedSchemaDocTypesType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_doc_types(
            data: object,
        ) -> list[SearchCriteriaSavedSchemaDocTypesType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for doc_types_type_0_item_data in _doc_types_type_0:
                    doc_types_type_0_item = SearchCriteriaSavedSchemaDocTypesType0Item(
                ...
                pass
            return cast(
                list[SearchCriteriaSavedSchemaDocTypesType0Item] | None | Unset, data
            )
        ...
        search_criteria_saved_schema = cls(
            doc_types=doc_types,
        ...
        search_criteria_saved_schema.additional_properties = d
        return search_criteria_saved_schema
