...
from ..models.file_base_schema_status import FileBaseSchemaStatus
from ..models.file_base_schema_template_engine import FileBaseSchemaTemplateEngine
...
class FileBaseSchema:
    ...
    Attributes:
        ...
        size (int | None | Unset):
        status (FileBaseSchemaStatus | None | Unset):
        storage_id (None | Unset | UUID):
        template (None | str | Unset):
        template_engine (FileBaseSchemaTemplateEngine | None | Unset):
    ...
    status: FileBaseSchemaStatus | None | Unset = UNSET
    storage_id: None | Unset | UUID = UNSET
    template: None | str | Unset = UNSET
    template_engine: FileBaseSchemaTemplateEngine | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, FileBaseSchemaStatus):
        ...
        elif isinstance(self.template_engine, FileBaseSchemaTemplateEngine):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_status(data: object) -> FileBaseSchemaStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = FileBaseSchemaStatus(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(FileBaseSchemaStatus | None | Unset, data)
        ...
        def _parse_template_engine(
            data: object,
        ) -> FileBaseSchemaTemplateEngine | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                template_engine_type_1 = FileBaseSchemaTemplateEngine(data)

                return template_engine_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(FileBaseSchemaTemplateEngine | None | Unset, data)
