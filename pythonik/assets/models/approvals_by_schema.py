...
T = TypeVar("T", bound="ApprovalsBySchema")


@_attrs_define
class ApprovalsBySchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[ApprovalBySchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[ApprovalBySchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[ApprovalBySchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = ApprovalBySchema.from_dict(
        ...
        approvals_by_schema.additional_properties = d
        return approvals_by_schema
