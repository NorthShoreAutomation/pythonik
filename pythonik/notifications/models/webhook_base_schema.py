...
from ..models.webhook_base_schema_status import WebhookBaseSchemaStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.webhook_base_schema_headers_type_0 import (
        WebhookBaseSchemaHeadersType0,
    )


T = TypeVar("T", bound="WebhookBaseSchema")


@_attrs_define
class WebhookBaseSchema:
    """
    Attributes:
        event_type (str): Type of events. Example assets, collections Example: assets.
        id (UUID):
        status (WebhookBaseSchemaStatus):  Example: ENABLED.
        ...
        headers (None | Unset | WebhookBaseSchemaHeadersType0): Define the key-value pairs your third party provider
    ...
    event_type: str
    id: UUID
    status: WebhookBaseSchemaStatus
    url: str
    ...
    headers: None | Unset | WebhookBaseSchemaHeadersType0 = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.headers, Unset):
            headers = UNSET
        elif isinstance(self.headers, WebhookBaseSchemaHeadersType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = WebhookBaseSchemaStatus(d.pop("status"))
        ...
        def _parse_headers(
            data: object,
        ) -> None | Unset | WebhookBaseSchemaHeadersType0:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                headers_type_0 = WebhookBaseSchemaHeadersType0.from_dict(data)

                return headers_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | WebhookBaseSchemaHeadersType0, data)
        ...
        webhook_base_schema.additional_properties = d
        return webhook_base_schema
