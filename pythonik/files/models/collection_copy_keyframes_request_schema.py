...
T = TypeVar("T", bound="CollectionCopyKeyframesRequestSchema")


@_attrs_define
class CollectionCopyKeyframesRequestSchema:
    """
    Attributes:
        id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collection_copy_keyframes_request_schema = cls(
            id=id,
            custom_keyframe=custom_keyframe,
            custom_poster=custom_poster,
        )

        collection_copy_keyframes_request_schema.additional_properties = d
        return collection_copy_keyframes_request_schema
