...
if TYPE_CHECKING:
    ...
    from ..models.storages_read_schema_facets import StoragesReadSchemaFacets
...
class StoragesReadSchema:
    """
    Attributes:
        facets (StoragesReadSchemaFacets | Unset):
        first_url (str | Unset):
        last_url (str | Unset):
        next_url (str | Unset):
        objects (list[StorageReadSchema] | Unset):
        page (int | Unset):
        pages (int | Unset):
        per_page (int | Unset):
        prev_url (str | Unset):
    ...
    facets: StoragesReadSchemaFacets | Unset = UNSET
    first_url: str | Unset = UNSET
    last_url: str | Unset = UNSET
    next_url: str | Unset = UNSET
    objects: list[StorageReadSchema] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_facets, Unset):
            ...
            facets = StoragesReadSchemaFacets.from_dict(_facets)
        ...
        if _objects is not UNSET:
            ...
            for objects_item_data in _objects:
                objects_item = StorageReadSchema.from_dict(objects_item_data)
