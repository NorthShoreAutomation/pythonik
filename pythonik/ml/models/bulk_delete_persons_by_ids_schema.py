...
T = TypeVar("T", bound="BulkDeletePersonsByIdsSchema")


@_attrs_define
class BulkDeletePersonsByIdsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_delete_persons_by_ids_schema = cls(
            person_ids=person_ids,
        )

        bulk_delete_persons_by_ids_schema.additional_properties = d
        return bulk_delete_persons_by_ids_schema
