...
T = TypeVar("T", bound="TransferAssetToStorageRequestSchema")


@_attrs_define
class TransferAssetToStorageRequestSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfer_asset_to_storage_request_schema = cls(
            id=id,
        ...
        transfer_asset_to_storage_request_schema.additional_properties = d
        return transfer_asset_to_storage_request_schema
