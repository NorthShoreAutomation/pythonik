...
if TYPE_CHECKING:
    ...
    from ..models.asset_post_elastic_formats_type_0_item import (
        AssetPostElasticFormatsType0Item,
    )
    from ..models.asset_post_elastic_keyframes_type_0_item import (
...
class AssetPostElastic:
    ...
    Attributes:
        ...
        keyframes (list[AssetPostElasticKeyframesType0Item] | None | Unset):
        ...
        metadata (AssetPostElasticMetadataType0 | None | Unset):
    ...
    keyframes: list[AssetPostElasticKeyframesType0Item] | None | Unset = UNSET
    ...
    metadata: AssetPostElasticMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, AssetPostElasticMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_files(
            data: object,
        ) -> list[AssetPostElasticFilesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for files_type_0_item_data in _files_type_0:
                    files_type_0_item = AssetPostElasticFilesType0Item.from_dict(
                ...
                pass
            return cast(list[AssetPostElasticFilesType0Item] | None | Unset, data)

        files = _parse_files(d.pop("files", UNSET))

        def _parse_formats(
            data: object,
        ) -> list[AssetPostElasticFormatsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for formats_type_0_item_data in _formats_type_0:
                    formats_type_0_item = AssetPostElasticFormatsType0Item.from_dict(
                ...
                pass
            return cast(list[AssetPostElasticFormatsType0Item] | None | Unset, data)
        ...
        def _parse_keyframes(
            data: object,
        ) -> list[AssetPostElasticKeyframesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for keyframes_type_0_item_data in _keyframes_type_0:
                    keyframes_type_0_item = (
                        AssetPostElasticKeyframesType0Item.from_dict(
                ...
                pass
            return cast(list[AssetPostElasticKeyframesType0Item] | None | Unset, data)
        ...
        def _parse_metadata(
            data: object,
        ) -> AssetPostElasticMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = AssetPostElasticMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AssetPostElasticMetadataType0 | None | Unset, data)
        ...
        def _parse_proxies(
            data: object,
        ) -> list[AssetPostElasticProxiesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for proxies_type_0_item_data in _proxies_type_0:
                    proxies_type_0_item = AssetPostElasticProxiesType0Item.from_dict(
                ...
                pass
            return cast(list[AssetPostElasticProxiesType0Item] | None | Unset, data)
