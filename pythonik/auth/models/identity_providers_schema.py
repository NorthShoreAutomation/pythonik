...
T = TypeVar("T", bound="IdentityProvidersSchema")


@_attrs_define
class IdentityProvidersSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[IdentityProviderSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[IdentityProviderSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[IdentityProviderSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = IdentityProviderSchema.from_dict(
                ...
                pass
            return cast(list[IdentityProviderSchema] | None | Unset, data)
        ...
        identity_providers_schema.additional_properties = d
        return identity_providers_schema
