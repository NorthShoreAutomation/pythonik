...
T = TypeVar("T", bound="ReindexStorageGatewaySchema")


@_attrs_define
class ReindexStorageGatewaySchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_storage_gateway_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_storage_gateway_schema.additional_properties = d
        return reindex_storage_gateway_schema
