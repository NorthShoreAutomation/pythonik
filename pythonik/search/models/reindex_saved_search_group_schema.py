...
T = TypeVar("T", bound="ReindexSavedSearchGroupSchema")


@_attrs_define
class ReindexSavedSearchGroupSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_saved_search_group_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_saved_search_group_schema.additional_properties = d
        return reindex_saved_search_group_schema
