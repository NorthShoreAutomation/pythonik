...
if TYPE_CHECKING:
    from ..models.export_asset_request import ExportAssetRequest


T = TypeVar("T", bound="BulkExportAssetRequestSchema")


@_attrs_define
class BulkExportAssetRequestSchema:
    """
    Attributes:
        objects (list[ExportAssetRequest] | None | Unset): List of assets to export. Each asset should contain the asset
            ID.
        parent_job_id (None | Unset | UUID): Parent job ID
    """

    objects: list[ExportAssetRequest] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[ExportAssetRequest] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = ExportAssetRequest.from_dict(
                ...
                pass
            return cast(list[ExportAssetRequest] | None | Unset, data)
        ...
        bulk_export_asset_request_schema = cls(
            objects=objects,
            parent_job_id=parent_job_id,
        )

        bulk_export_asset_request_schema.additional_properties = d
        return bulk_export_asset_request_schema
