...
T = TypeVar("T", bound="TranscodeElasticQueueRecord")


@_attrs_define
class TranscodeElasticQueueRecord:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transcode_elastic_queue_record = cls(
        ...
        transcode_elastic_queue_record.additional_properties = d
        return transcode_elastic_queue_record
