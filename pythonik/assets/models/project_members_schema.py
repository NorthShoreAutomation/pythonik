...
T = TypeVar("T", bound="ProjectMembersSchema")


@_attrs_define
class ProjectMembersSchema:
    """
    Attributes:
        objects (list[ProjectMemberSchema] | None | Unset):
    """

    objects: list[ProjectMemberSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[ProjectMemberSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = ProjectMemberSchema.from_dict(
                ...
                pass
            return cast(list[ProjectMemberSchema] | None | Unset, data)

        objects = _parse_objects(d.pop("objects", UNSET))

        project_members_schema = cls(
            objects=objects,
        )

        project_members_schema.additional_properties = d
        return project_members_schema
