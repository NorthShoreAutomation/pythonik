...
if TYPE_CHECKING:
    from ..models.file_schema_status_type_1 import FileSchemaStatusType1
    from ..models.file_schema_template_engine_type_1 import (
        FileSchemaTemplateEngineType1,
    )
    from ..models.file_schema_upload_credentials_type_0 import (
...
class FileSchema:
    ...
    Attributes:
        ...
        file_set_status (None | str | Unset):
        format_id (None | Unset | UUID):
        format_status (None | str | Unset):
        id (None | Unset | UUID):
        ...
        size (int | None | Unset):
        status (FileSchemaStatusType1 | None | Unset):
        storage_id (None | Unset | UUID):
        storage_method (None | str | Unset):
        system_domain_id (None | Unset | UUID):
        template (None | str | Unset):
        template_engine (FileSchemaTemplateEngineType1 | None | Unset):
        upload_credentials (FileSchemaUploadCredentialsType0 | None | Unset):
        upload_filename (None | str | Unset):
        upload_method (None | str | Unset):
        upload_url (None | str | Unset): On a file creation for Backblaze B2 storage in case when request to Backblaze
            failed, upload_url field will be empty. You can try getting upload_url again by requesting created file with
            `generate_signed_post_url` set to true.
        url (None | str | Unset):
    ...
    file_set_status: None | str | Unset = UNSET
    format_id: None | Unset | UUID = UNSET
    format_status: None | str | Unset = UNSET
    id: None | Unset | UUID = UNSET
    multipart_upload_url: None | str | Unset = UNSET
    name: None | str | Unset = UNSET
    parent_id: None | Unset | UUID = UNSET
    size: int | None | Unset = UNSET
    status: FileSchemaStatusType1 | None | Unset = UNSET
    storage_id: None | Unset | UUID = UNSET
    storage_method: None | str | Unset = UNSET
    system_domain_id: None | Unset | UUID = UNSET
    template: None | str | Unset = UNSET
    template_engine: FileSchemaTemplateEngineType1 | None | Unset = UNSET
    upload_credentials: FileSchemaUploadCredentialsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        file_set_status: None | str | Unset
        if isinstance(self.file_set_status, Unset):
            file_set_status = UNSET
        else:
            file_set_status = self.file_set_status
        ...
        format_status: None | str | Unset
        if isinstance(self.format_status, Unset):
            format_status = UNSET
        else:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, FileSchemaStatusType1):
        ...
        elif isinstance(self.template_engine, FileSchemaTemplateEngineType1):
        ...
        elif isinstance(self.upload_credentials, FileSchemaUploadCredentialsType0):
        ...
        if file_set_status is not UNSET:
            field_dict["file_set_status"] = file_set_status
        if format_id is not UNSET:
            field_dict["format_id"] = format_id
        if format_status is not UNSET:
            field_dict["format_status"] = format_status
        if id is not UNSET:
            field_dict["id"] = id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        file_set_id = UUID(d.pop("file_set_id"))

        original_name = d.pop("original_name")

        type_ = FileSchemaType(d.pop("type"))
        ...
        def _parse_file_set_status(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        file_set_status = _parse_file_set_status(d.pop("file_set_status", UNSET))
        ...
        def _parse_format_status(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        format_status = _parse_format_status(d.pop("format_status", UNSET))
        ...
        def _parse_status(data: object) -> FileSchemaStatusType1 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                status_type_1 = FileSchemaStatusType1.from_dict(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(FileSchemaStatusType1 | None | Unset, data)
        ...
        def _parse_template_engine(
            data: object,
        ) -> FileSchemaTemplateEngineType1 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                template_engine_type_1 = FileSchemaTemplateEngineType1.from_dict(data)

                return template_engine_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(FileSchemaTemplateEngineType1 | None | Unset, data)

        template_engine = _parse_template_engine(d.pop("template_engine", UNSET))

        def _parse_upload_credentials(
            data: object,
        ) -> FileSchemaUploadCredentialsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                upload_credentials_type_0 = FileSchemaUploadCredentialsType0.from_dict(
                    data
                )
                ...
                pass
            return cast(FileSchemaUploadCredentialsType0 | None | Unset, data)
