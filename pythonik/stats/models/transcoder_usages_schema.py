...
if TYPE_CHECKING:
    from ..models.transcoder_usages_elastic_schema import TranscoderUsagesElasticSchema


T = TypeVar("T", bound="TranscoderUsagesSchema")


@_attrs_define
class TranscoderUsagesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[TranscoderUsagesElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[TranscoderUsagesElasticSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.transcoder_usages_elastic_schema import (
        ...
        def _parse_objects(
            data: object,
        ) -> list[TranscoderUsagesElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = TranscoderUsagesElasticSchema.from_dict(
                ...
                pass
            return cast(list[TranscoderUsagesElasticSchema] | None | Unset, data)
        ...
        transcoder_usages_schema.additional_properties = d
        return transcoder_usages_schema
