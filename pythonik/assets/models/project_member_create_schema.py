...
T = TypeVar("T", bound="ProjectMemberCreateSchema")


@_attrs_define
class ProjectMemberCreateSchema:
    """
    Attributes:
        id (UUID): User ID in iconik
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_member_create_schema = cls(
            id=id,
        ...
        project_member_create_schema.additional_properties = d
        return project_member_create_schema
