...
T = TypeVar("T", bound="ArchiveSavedSearchRequest")


@_attrs_define
class ArchiveSavedSearchRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        archive_saved_search_request = cls(
            id=id,
        ...
        archive_saved_search_request.additional_properties = d
        return archive_saved_search_request
