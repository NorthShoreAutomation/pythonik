...
from ..models.user_schema_onboarding_goal import UserSchemaOnboardingGoal
from ..models.user_schema_status import UserSchemaStatus
...
class UserSchema:
    ...
    Attributes:
        ...
        metadata (Any | Unset):
        onboarding_goal (None | Unset | UserSchemaOnboardingGoal):
        ...
        status (None | Unset | UserSchemaStatus):
    ...
    onboarding_goal: None | Unset | UserSchemaOnboardingGoal = UNSET
    ...
    status: None | Unset | UserSchemaStatus = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.onboarding_goal, UserSchemaOnboardingGoal):
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, UserSchemaStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_onboarding_goal(
            data: object,
        ) -> None | Unset | UserSchemaOnboardingGoal:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                onboarding_goal_type_1 = UserSchemaOnboardingGoal(data)

                return onboarding_goal_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UserSchemaOnboardingGoal, data)
        ...
        def _parse_status(data: object) -> None | Unset | UserSchemaStatus:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = UserSchemaStatus(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UserSchemaStatus, data)
