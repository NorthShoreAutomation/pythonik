...
T = TypeVar("T", bound="MergedSettingsSchema")


@_attrs_define
class MergedSettingsSchema:
    """
    Attributes:
        ...
        billing_tier (str | Unset):
        client_ip (str | Unset):
        collections_get_parent_acls (bool | None | Unset):
        cors_hosts (list[str] | Unset):
        ...
        domain_has_preloaded_assets (bool | Unset):
        drm (MergedSettingsSchemaDrm | Unset): DRM setting Default: MergedSettingsSchemaDrm.NONE.
        ...
        mfa_methods (list[MergedSettingsSchemaMfaMethodsType0Item] | None | Unset):
        mfa_required (bool | None | Unset):
        password_checks (None | PasswordChecksType | Unset):
        ...
        watermark (MergedSettingsSchemaWatermark | Unset): Watermark setting Default:
            MergedSettingsSchemaWatermark.NONE.
    ...
    domain_has_preloaded_assets: bool | Unset = UNSET
    drm: MergedSettingsSchemaDrm | Unset = MergedSettingsSchemaDrm.NONE
    ...
    is_plg_domain: bool | Unset = UNSET
    ...
    mfa_methods: list[MergedSettingsSchemaMfaMethodsType0Item] | None | Unset = UNSET
    mfa_required: bool | None | Unset = UNSET
    password_checks: None | PasswordChecksType | Unset = UNSET
    ...
    watermark: MergedSettingsSchemaWatermark | Unset = (
        MergedSettingsSchemaWatermark.NONE
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_plg_domain = self.is_plg_domain
        ...
        elif isinstance(self.password_checks, PasswordChecksType):
        ...
        if isinstance(self.usage_history, Unset):
            usage_history = UNSET
        elif isinstance(self.usage_history, UsageHistory):
        ...
        if domain_has_preloaded_assets is not UNSET:
            field_dict["domain_has_preloaded_assets"] = domain_has_preloaded_assets
        if drm is not UNSET:
            field_dict["drm"] = drm
        ...
        if is_plg_domain is not UNSET:
            field_dict["is_plg_domain"] = is_plg_domain
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        billing_tier = d.pop("billing_tier", UNSET)
        ...
        cors_hosts = cast(list[str], d.pop("cors_hosts", UNSET))
        ...
        domain_has_preloaded_assets = d.pop("domain_has_preloaded_assets", UNSET)

        _drm = d.pop("drm", UNSET)
        drm: MergedSettingsSchemaDrm | Unset
        if isinstance(_drm, Unset):
            drm = UNSET
        else:
            drm = MergedSettingsSchemaDrm(_drm)
        ...
        is_plg_domain = d.pop("is_plg_domain", UNSET)
        ...
        def _parse_mfa_methods(
            data: object,
        ) -> list[MergedSettingsSchemaMfaMethodsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for mfa_methods_type_0_item_data in _mfa_methods_type_0:
                    mfa_methods_type_0_item = MergedSettingsSchemaMfaMethodsType0Item(
                ...
                pass
            return cast(
                list[MergedSettingsSchemaMfaMethodsType0Item] | None | Unset, data
            )
        ...
        def _parse_password_checks(data: object) -> None | PasswordChecksType | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                password_checks_type_1 = PasswordChecksType.from_dict(data)

                return password_checks_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PasswordChecksType | Unset, data)
        ...
        def _parse_usage_history(data: object) -> None | Unset | UsageHistory:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                usage_history_type_1 = UsageHistory.from_dict(data)

                return usage_history_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UsageHistory, data)
        ...
        if isinstance(_watermark, Unset):
            ...
            watermark = MergedSettingsSchemaWatermark(_watermark)
        ...
        merged_settings_schema = cls(
            ...
            domain_has_preloaded_assets=domain_has_preloaded_assets,
            drm=drm,
        ...
        merged_settings_schema.additional_properties = d
        return merged_settings_schema
