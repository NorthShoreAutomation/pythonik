...
from ..models.search_query_params_schema_types_type_0_item import (
    SearchQueryParamsSchemaTypesType0Item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SearchQueryParamsSchema")


@_attrs_define
class SearchQueryParamsSchema:
    """
    Attributes:
        ...
        types (list[SearchQueryParamsSchemaTypesType0Item] | None | Unset): Comma-separated list of asset types to
    ...
    types: list[SearchQueryParamsSchemaTypesType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_types(
            data: object,
        ) -> list[SearchQueryParamsSchemaTypesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for types_type_0_item_data in _types_type_0:
                    types_type_0_item = SearchQueryParamsSchemaTypesType0Item(
                ...
                pass
            return cast(
                list[SearchQueryParamsSchemaTypesType0Item] | None | Unset, data
            )

        types = _parse_types(d.pop("types", UNSET))

        search_query_params_schema = cls(
            page=page,
            per_page=per_page,
            scroll=scroll,
            scroll_id=scroll_id,
        ...
        search_query_params_schema.additional_properties = d
        return search_query_params_schema
