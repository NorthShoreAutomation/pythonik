...
from ..models.search_query_params_schema_types_item import (
...
class SearchQueryParamsSchema:
    ...
    Attributes:
        ...
        types (list[SearchQueryParamsSchemaTypesItem] | Unset): Comma-separated list of asset types to include in
    ...
    types: list[SearchQueryParamsSchemaTypesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _types is not UNSET:
            ...
            for types_item_data in _types:
                types_item = SearchQueryParamsSchemaTypesItem(types_item_data)
