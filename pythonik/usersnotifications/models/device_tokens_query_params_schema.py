...
T = TypeVar("T", bound="DeviceTokensQueryParamsSchema")


@_attrs_define
class DeviceTokensQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        device_tokens_query_params_schema = cls(
            per_page=per_page,
        )

        device_tokens_query_params_schema.additional_properties = d
        return device_tokens_query_params_schema
