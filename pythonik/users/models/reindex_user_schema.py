...
T = TypeVar("T", bound="ReindexUserSchema")


@_attrs_define
class ReindexUserSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_user_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_user_schema.additional_properties = d
        return reindex_user_schema
