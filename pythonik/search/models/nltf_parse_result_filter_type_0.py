...
T = TypeVar("T", bound="NltfParseResultFilterType0")


@_attrs_define
class NltfParseResultFilterType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        nltf_parse_result_filter_type_0 = cls()
        ...
        nltf_parse_result_filter_type_0.additional_properties = additional_properties
        return nltf_parse_result_filter_type_0
