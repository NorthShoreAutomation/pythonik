...
from ...models.get_storage_gateway_clusters_by_cluster_id_response_default import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    response_default = GetStorageGatewayClustersByClusterIdResponseDefault.from_dict(
        response.json()
    )
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Any | GetStorageGatewayClustersByClusterIdResponseDefault | IconikStorageGatewayClusterReadSchema]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | GetStorageGatewayClustersByClusterIdResponseDefault | IconikStorageGatewayClusterReadSchema
    """
