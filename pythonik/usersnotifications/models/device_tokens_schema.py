...
T = TypeVar("T", bound="DeviceTokensSchema")


@_attrs_define
class DeviceTokensSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[DeviceTokenSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[DeviceTokenSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[DeviceTokenSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = DeviceTokenSchema.from_dict(
                ...
                pass
            return cast(list[DeviceTokenSchema] | None | Unset, data)
        ...
        device_tokens_schema.additional_properties = d
        return device_tokens_schema
