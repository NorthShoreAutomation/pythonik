...
if TYPE_CHECKING:
    from ..models.collection_schema_keyframes_item import CollectionSchemaKeyframesItem
    from ..models.collection_schema_metadata import CollectionSchemaMetadata
...
class CollectionSchema:
    ...
    Attributes:
        ...
        custom_order_status (CollectionSchemaCustomOrderStatus | Unset):
        ...
        keyframes (list[CollectionSchemaKeyframesItem] | Unset):
        metadata (CollectionSchemaMetadata | Unset):
        ...
        status (CollectionSchemaStatus | Unset):
    ...
    custom_order_status: CollectionSchemaCustomOrderStatus | Unset = UNSET
    ...
    keyframes: list[CollectionSchemaKeyframesItem] | Unset = UNSET
    metadata: CollectionSchemaMetadata | Unset = UNSET
    ...
    status: CollectionSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.collection_schema_keyframes_item import (
        ...
        if isinstance(_custom_order_status, Unset):
            ...
            custom_order_status = CollectionSchemaCustomOrderStatus(
        ...
        if _keyframes is not UNSET:
            ...
            for keyframes_item_data in _keyframes:
                keyframes_item = CollectionSchemaKeyframesItem.from_dict(
                    keyframes_item_data
                )
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = CollectionSchemaMetadata.from_dict(_metadata)
        ...
        if isinstance(_status, Unset):
            ...
            status = CollectionSchemaStatus(_status)
