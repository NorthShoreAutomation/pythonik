...
if TYPE_CHECKING:
    ...
    from ..models.local_transcode_input_schema import LocalTranscodeInputSchema
    from ..models.local_transcode_job_schema_analysis_data_type_0 import (
...
T = TypeVar("T", bound="LocalTranscodeJobSchema")


@_attrs_define
class LocalTranscodeJobSchema:
    """
    Attributes:
        input_ (LocalTranscodeInputSchema):
        amazon_rekognition (bool | None | Unset):
        analysis_data (LocalTranscodeJobSchemaAnalysisDataType0 | None | Unset):
        ...
        job_steps (list[JobStepSchema] | None | Unset):
    ...
    analysis_data: LocalTranscodeJobSchemaAnalysisDataType0 | None | Unset = UNSET
    ...
    job_steps: list[JobStepSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.analysis_data, Unset):
            analysis_data = UNSET
        elif isinstance(self.analysis_data, LocalTranscodeJobSchemaAnalysisDataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        input_ = LocalTranscodeInputSchema.from_dict(d.pop("input"))
        ...
        def _parse_analysis_data(
            data: object,
        ) -> LocalTranscodeJobSchemaAnalysisDataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                analysis_data_type_0 = (
                    LocalTranscodeJobSchemaAnalysisDataType0.from_dict(data)
                )

                return analysis_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(LocalTranscodeJobSchemaAnalysisDataType0 | None | Unset, data)
        ...
        def _parse_job_steps(data: object) -> list[JobStepSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for job_steps_type_0_item_data in _job_steps_type_0:
                    job_steps_type_0_item = JobStepSchema.from_dict(
                ...
                pass
            return cast(list[JobStepSchema] | None | Unset, data)
        ...
        local_transcode_job_schema = cls(
            input_=input_,
        ...
        local_transcode_job_schema.additional_properties = d
        return local_transcode_job_schema
