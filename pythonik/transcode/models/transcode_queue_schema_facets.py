...
T = TypeVar("T", bound="TranscodeQueueSchemaFacets")


@_attrs_define
class TranscodeQueueSchemaFacets:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        transcode_queue_schema_facets = cls()
        ...
        transcode_queue_schema_facets.additional_properties = additional_properties
        return transcode_queue_schema_facets
