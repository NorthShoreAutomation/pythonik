...
T = TypeVar("T", bound="SequenceItemsSchema")


@_attrs_define
class SequenceItemsSchema:
    """
    Attributes:
        objects (list[SequenceItemSchema] | None | Unset):
    """

    objects: list[SequenceItemSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[SequenceItemSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = SequenceItemSchema.from_dict(
                ...
                pass
            return cast(list[SequenceItemSchema] | None | Unset, data)

        objects = _parse_objects(d.pop("objects", UNSET))

        sequence_items_schema = cls(
            objects=objects,
        )

        sequence_items_schema.additional_properties = d
        return sequence_items_schema
