...
T = TypeVar("T", bound="DeleteQueueCollectionsQueryParamsSchema")


@_attrs_define
class DeleteQueueCollectionsQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_queue_collections_query_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        delete_queue_collections_query_params_schema.additional_properties = d
        return delete_queue_collections_query_params_schema
