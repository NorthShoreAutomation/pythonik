...
class UserCreateSchema:
    ...
    Attributes:
        ...
        metadata (Any | Unset):
        onboarding_goal (UserCreateSchemaOnboardingGoal | Unset):
        password (str | Unset):
        ...
        status (UserCreateSchemaStatus | Unset):
    ...
    onboarding_goal: UserCreateSchemaOnboardingGoal | Unset = UNSET
    ...
    status: UserCreateSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_onboarding_goal, Unset):
            ...
            onboarding_goal = UserCreateSchemaOnboardingGoal(_onboarding_goal)
        ...
        if isinstance(_status, Unset):
            ...
            status = UserCreateSchemaStatus(_status)
