...
T = TypeVar("T", bound="RestoreAssetToStorageRequestSchema")


@_attrs_define
class RestoreAssetToStorageRequestSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restore_asset_to_storage_request_schema = cls(
            id=id,
        ...
        restore_asset_to_storage_request_schema.additional_properties = d
        return restore_asset_to_storage_request_schema
