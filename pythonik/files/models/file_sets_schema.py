...
T = TypeVar("T", bound="FileSetsSchema")


@_attrs_define
class FileSetsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[FileSetSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[FileSetSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[FileSetSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = FileSetSchema.from_dict(
                ...
                pass
            return cast(list[FileSetSchema] | None | Unset, data)
        ...
        file_sets_schema.additional_properties = d
        return file_sets_schema
