...
class TokenMultiplatformLoginSchema:
    ...
    Attributes:
        app_id (UUID | Unset):
        auth_system_domains (list[MultiPlatformDomainUserSystemSchema] | Unset):
        ...
        system_domain_status (TokenMultiplatformLoginSchemaSystemDomainStatus | Unset):
    ...
    auth_system_domains: list[MultiPlatformDomainUserSystemSchema] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_system_domain_status, Unset):
            ...
            system_domain_status = TokenMultiplatformLoginSchemaSystemDomainStatus(
