...
T = TypeVar("T", bound="PlaylistKeyframesSchema")


@_attrs_define
class PlaylistKeyframesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[PlaylistKeyframeSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[PlaylistKeyframeSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[PlaylistKeyframeSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = PlaylistKeyframeSchema.from_dict(
                ...
                pass
            return cast(list[PlaylistKeyframeSchema] | None | Unset, data)
        ...
        playlist_keyframes_schema.additional_properties = d
        return playlist_keyframes_schema
