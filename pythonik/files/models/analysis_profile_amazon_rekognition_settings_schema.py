...
T = TypeVar("T", bound="AnalysisProfileAmazonRekognitionSettingsSchema")
...
class AnalysisProfileAmazonRekognitionSettingsSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        analysis_profile_amazon_rekognition_settings_schema.additional_properties = d
        return analysis_profile_amazon_rekognition_settings_schema
