...
T = TypeVar("T", bound="ReindexEmbeddingSchema")


@_attrs_define
class ReindexEmbeddingSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_embedding_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_embedding_schema.additional_properties = d
        return reindex_embedding_schema
