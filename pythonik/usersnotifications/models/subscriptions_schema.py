...
T = TypeVar("T", bound="SubscriptionsSchema")


@_attrs_define
class SubscriptionsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[SubscriptionSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[SubscriptionSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[SubscriptionSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = SubscriptionSchema.from_dict(
                ...
                pass
            return cast(list[SubscriptionSchema] | None | Unset, data)
        ...
        subscriptions_schema.additional_properties = d
