...
T = TypeVar("T", bound="ProxiesSchema")
...
class ProxiesSchema:
    ...
    objects: list[Proxy] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[Proxy] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = Proxy.from_dict(objects_type_0_item_data)
                ...
                pass
            return cast(list[Proxy] | None | Unset, data)
        ...
        proxies_schema.additional_properties = d
        return proxies_schema
