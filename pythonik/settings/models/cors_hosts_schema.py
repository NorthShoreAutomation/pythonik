...
T = TypeVar("T", bound="CORSHostsSchema")


@_attrs_define
class CORSHostsSchema:
    """
    Attributes:
        objects (list[CORSHostSchema] | None | Unset):
    """

    objects: list[CORSHostSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[CORSHostSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = CORSHostSchema.from_dict(
                ...
                pass
            return cast(list[CORSHostSchema] | None | Unset, data)

        objects = _parse_objects(d.pop("objects", UNSET))

        cors_hosts_schema = cls(
            objects=objects,
        )

        cors_hosts_schema.additional_properties = d
        return cors_hosts_schema
