...
if TYPE_CHECKING:
    from ..models.file_schema_upload_credentials import FileSchemaUploadCredentials
...
class FileSchema:
    ...
    Attributes:
        ...
        size (int | Unset):
        status (FileSchemaStatus | Unset):
        storage_id (UUID | Unset):
        storage_method (str | Unset):
        system_domain_id (UUID | Unset):
        template (str | Unset):
        template_engine (FileSchemaTemplateEngine | Unset):
        upload_credentials (FileSchemaUploadCredentials | Unset):
        upload_filename (str | Unset):
        upload_method (str | Unset):
        upload_url (str | Unset): On a file creation for Backblaze B2 storage in case when request to Backblaze failed,
            upload_url field will be empty. You can try getting upload_url again by requesting created file with
    ...
    status: FileSchemaStatus | Unset = UNSET
    storage_id: UUID | Unset = UNSET
    storage_method: str | Unset = UNSET
    system_domain_id: UUID | Unset = UNSET
    template: str | Unset = UNSET
    template_engine: FileSchemaTemplateEngine | Unset = UNSET
    upload_credentials: FileSchemaUploadCredentials | Unset = UNSET
    upload_filename: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = FileSchemaStatus(_status)
        ...
        if isinstance(_template_engine, Unset):
            ...
            template_engine = FileSchemaTemplateEngine(_template_engine)
        ...
        if isinstance(_upload_credentials, Unset):
            ...
            upload_credentials = FileSchemaUploadCredentials.from_dict(
                _upload_credentials
            )

        upload_filename = d.pop("upload_filename", UNSET)
