...
T = TypeVar("T", bound="BulkReindexPersonsSchema")


@_attrs_define
class BulkReindexPersonsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_reindex_persons_schema.additional_properties = d
        return bulk_reindex_persons_schema
