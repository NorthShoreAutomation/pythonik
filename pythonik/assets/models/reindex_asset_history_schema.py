...
T = TypeVar("T", bound="ReindexAssetHistorySchema")


@_attrs_define
class ReindexAssetHistorySchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_asset_history_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_asset_history_schema.additional_properties = d
        return reindex_asset_history_schema
