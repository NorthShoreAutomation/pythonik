...
T = TypeVar("T", bound="ReindexSegmentSchema")


@_attrs_define
class ReindexSegmentSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_segment_schema = cls(
            ignore_comments=ignore_comments,
            realms=realms,
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_segment_schema.additional_properties = d
        return reindex_segment_schema
