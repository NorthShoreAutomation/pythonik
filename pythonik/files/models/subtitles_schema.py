...
T = TypeVar("T", bound="SubtitlesSchema")


@_attrs_define
class SubtitlesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[Subtitle] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[Subtitle] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[Subtitle] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = Subtitle.from_dict(objects_type_0_item_data)
                ...
                pass
            return cast(list[Subtitle] | None | Unset, data)
        ...
        subtitles_schema.additional_properties = d
        return subtitles_schema
