...
T = TypeVar("T", bound="ReindexSegmentsSchema")


@_attrs_define
class ReindexSegmentsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        segment_ids = []
        _segment_ids = d.pop("segment_ids")
        ...
        reindex_segments_schema.additional_properties = d
        return reindex_segments_schema
