...
class UserSamlCreateSchema:
    ...
    Attributes:
        ...
        metadata (Any | Unset):
        onboarding_goal (UserSamlCreateSchemaOnboardingGoal | Unset):
        password (str | Unset):
    ...
    onboarding_goal: UserSamlCreateSchemaOnboardingGoal | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_onboarding_goal, Unset):
            ...
            onboarding_goal = UserSamlCreateSchemaOnboardingGoal(_onboarding_goal)
        ...
        if isinstance(_status, Unset):
            ...
            status = UserSamlCreateSchemaStatus(_status)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = UserSamlCreateSchemaType(_type_)
