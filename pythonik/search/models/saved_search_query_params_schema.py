...
T = TypeVar("T", bound="SavedSearchQueryParamsSchema")


@_attrs_define
class SavedSearchQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        saved_search_query_params_schema.additional_properties = d
        return saved_search_query_params_schema
