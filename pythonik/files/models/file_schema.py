...
from ..models.file_schema_status import FileSchemaStatus
from ..models.file_schema_template_engine import FileSchemaTemplateEngine
...
class FileSchema:
    ...
    Attributes:
        ...
        size (int | None | Unset):
        status (FileSchemaStatus | None | Unset):
        storage_id (None | Unset | UUID):
        storage_method (None | str | Unset):
        system_domain_id (None | Unset | UUID):
        template (None | str | Unset):
        template_engine (FileSchemaTemplateEngine | None | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, FileSchemaStatus):
        ...
        elif isinstance(self.template_engine, FileSchemaTemplateEngine):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_status(data: object) -> FileSchemaStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = FileSchemaStatus(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(FileSchemaStatus | None | Unset, data)
        ...
        def _parse_template_engine(
            data: object,
        ) -> FileSchemaTemplateEngine | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                template_engine_type_1 = FileSchemaTemplateEngine(data)

                return template_engine_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(FileSchemaTemplateEngine | None | Unset, data)
