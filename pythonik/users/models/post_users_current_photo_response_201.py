...
T = TypeVar("T", bound="PostUsersCurrentPhotoResponse201")


@_attrs_define
class PostUsersCurrentPhotoResponse201:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_users_current_photo_response_201 = cls(
            photo=photo,
            photo_big=photo_big,
            photo_small=photo_small,
        )

        post_users_current_photo_response_201.additional_properties = d
        return post_users_current_photo_response_201
