...
T = TypeVar("T", bound="ReindexFileSetSchema")


@_attrs_define
class ReindexFileSetSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_file_set_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_file_set_schema.additional_properties = d
        return reindex_file_set_schema
