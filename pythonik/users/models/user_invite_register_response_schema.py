...
class UserInviteRegisterResponseSchema:
    ...
    Attributes:
        id (None | Unset | UUID):
        is_existing_user (bool | None | Unset):
    """

    id: None | Unset | UUID = UNSET
    is_existing_user: bool | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_existing_user: bool | None | Unset
        if isinstance(self.is_existing_user, Unset):
            is_existing_user = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_is_existing_user(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        is_existing_user = _parse_is_existing_user(d.pop("is_existing_user", UNSET))
