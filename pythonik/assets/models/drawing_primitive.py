...
from ..models.drawing_primitive_type import DrawingPrimitiveType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.drawing_point import DrawingPoint


T = TypeVar("T", bound="DrawingPrimitive")
...
class DrawingPrimitive:
    """
    Attributes:
        type_ (DrawingPrimitiveType):
        color (None | str | Unset):
        opacity (float | None | Unset):
        points (list[DrawingPoint] | None | Unset):
        text (None | str | Unset):
    ...
    points: list[DrawingPoint] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = DrawingPrimitiveType(d.pop("type"))
        ...
        def _parse_points(data: object) -> list[DrawingPoint] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for points_type_0_item_data in _points_type_0:
                    points_type_0_item = DrawingPoint.from_dict(points_type_0_item_data)
                ...
                pass
            return cast(list[DrawingPoint] | None | Unset, data)
        ...
        drawing_primitive.additional_properties = d
        return drawing_primitive
