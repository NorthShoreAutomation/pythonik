...
if TYPE_CHECKING:
    from ..models.storage_access_elastic_schema import StorageAccessElasticSchema


T = TypeVar("T", bound="StorageAccessesSchema")


@_attrs_define
class StorageAccessesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[StorageAccessElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[StorageAccessElasticSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[StorageAccessElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = StorageAccessElasticSchema.from_dict(
                ...
                pass
            return cast(list[StorageAccessElasticSchema] | None | Unset, data)
        ...
        storage_accesses_schema.additional_properties = d
        return storage_accesses_schema
