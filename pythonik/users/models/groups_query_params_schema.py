...
T = TypeVar("T", bound="GroupsQueryParamsSchema")


@_attrs_define
class GroupsQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        groups_query_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        groups_query_params_schema.additional_properties = d
        return groups_query_params_schema
