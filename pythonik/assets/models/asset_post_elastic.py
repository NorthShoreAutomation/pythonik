...
if TYPE_CHECKING:
    ...
    from ..models.asset_post_elastic_files_item import AssetPostElasticFilesItem
    from ..models.asset_post_elastic_formats_item import AssetPostElasticFormatsItem
    from ..models.asset_post_elastic_keyframes_item import AssetPostElasticKeyframesItem
    from ..models.asset_post_elastic_metadata import AssetPostElasticMetadata
    from ..models.asset_post_elastic_proxies_item import AssetPostElasticProxiesItem
    from ..models.asset_version import AssetVersion
    from ..models.relation_elastic import RelationElastic
    from ..models.user import User


T = TypeVar("T", bound="AssetPostElastic")


@_attrs_define
class AssetPostElastic:
    """
    Attributes:
        title (str):
        analyze_status (AssetPostElasticAnalyzeStatus | Unset):
        ancestor_collections (list[str] | Unset): Unordered list of all ancestor collection ids
        approval (ApprovalSchema | Unset):
        archive_status (AssetPostElasticArchiveStatus | Unset):
        ...
        face_recognition_status (AssetPostElasticFaceRecognitionStatus | Unset):
        favoured (bool | Unset):
        files (list[AssetPostElasticFilesItem] | Unset):
        formats (list[AssetPostElasticFormatsItem] | Unset):
        has_unconfirmed_persons (bool | Unset):
        id (UUID | Unset):
        in_collections (list[str] | Unset):
        is_blocked (bool | Unset):
        is_online (bool | Unset):
        keyframes (list[AssetPostElasticKeyframesItem] | Unset):
        ...
        metadata (AssetPostElasticMetadata | Unset):
        ...
        position (int | Unset):
        proxies (list[AssetPostElasticProxiesItem] | Unset):
        publication_status (AssetPostElasticPublicationStatus | Unset):  Default:
            AssetPostElasticPublicationStatus.PUBLISHED.
        relations (list[RelationElastic] | Unset):
        site_name (None | str | Unset):
        status (AssetPostElasticStatus | Unset):
        time_end_milliseconds (int | Unset):
        time_start_milliseconds (int | Unset):
        type_ (AssetPostElasticType | Unset):
    ...
    title: str
    analyze_status: AssetPostElasticAnalyzeStatus | Unset = UNSET
    ancestor_collections: list[str] | Unset = UNSET
    approval: ApprovalSchema | Unset = UNSET
    archive_status: AssetPostElasticArchiveStatus | Unset = UNSET
    ...
    face_recognition_status: AssetPostElasticFaceRecognitionStatus | Unset = UNSET
    favoured: bool | Unset = UNSET
    files: list[AssetPostElasticFilesItem] | Unset = UNSET
    formats: list[AssetPostElasticFormatsItem] | Unset = UNSET
    ...
    keyframes: list[AssetPostElasticKeyframesItem] | Unset = UNSET
    ...
    metadata: AssetPostElasticMetadata | Unset = UNSET
    ...
    proxies: list[AssetPostElasticProxiesItem] | Unset = UNSET
    publication_status: AssetPostElasticPublicationStatus | Unset = (
        AssetPostElasticPublicationStatus.PUBLISHED
    )
    relations: list[RelationElastic] | Unset = UNSET
    site_name: None | str | Unset = UNSET
    status: AssetPostElasticStatus | Unset = UNSET
    time_end_milliseconds: int | Unset = UNSET
    time_start_milliseconds: int | Unset = UNSET
    type_: AssetPostElasticType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.asset_post_elastic_files_item import AssetPostElasticFilesItem
        from ..models.asset_post_elastic_formats_item import AssetPostElasticFormatsItem
        from ..models.asset_post_elastic_keyframes_item import (
        ...
        if isinstance(_analyze_status, Unset):
            ...
            analyze_status = AssetPostElasticAnalyzeStatus(_analyze_status)
        ...
        if isinstance(_archive_status, Unset):
            ...
            archive_status = AssetPostElasticArchiveStatus(_archive_status)
        ...
        if isinstance(_face_recognition_status, Unset):
            ...
            face_recognition_status = AssetPostElasticFaceRecognitionStatus(
        ...
        if _files is not UNSET:
            ...
            for files_item_data in _files:
                files_item = AssetPostElasticFilesItem.from_dict(files_item_data)
        ...
        if _formats is not UNSET:
            ...
            for formats_item_data in _formats:
                formats_item = AssetPostElasticFormatsItem.from_dict(formats_item_data)
        ...
        if _keyframes is not UNSET:
            ...
            for keyframes_item_data in _keyframes:
                keyframes_item = AssetPostElasticKeyframesItem.from_dict(
                    keyframes_item_data
                )
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = AssetPostElasticMetadata.from_dict(_metadata)
        ...
        if _proxies is not UNSET:
            ...
            for proxies_item_data in _proxies:
                proxies_item = AssetPostElasticProxiesItem.from_dict(proxies_item_data)
        ...
        if isinstance(_publication_status, Unset):
            ...
            publication_status = AssetPostElasticPublicationStatus(_publication_status)
        ...
        if isinstance(_status, Unset):
            ...
            status = AssetPostElasticStatus(_status)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = AssetPostElasticType(_type_)
        ...
        asset_post_elastic.additional_properties = d
        return asset_post_elastic
