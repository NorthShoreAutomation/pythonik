...
T = TypeVar("T", bound="EditSegmentForBulkSchema")


@_attrs_define
class EditSegmentForBulkSchema:
    """
    Attributes:
        asset_id (UUID):
        id (UUID):
        segment_type (EditSegmentForBulkSchemaSegmentType):
        ...
        metadata (EditSegmentForBulkSchemaMetadataType0 | None | Unset):
    ...
    metadata: EditSegmentForBulkSchemaMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, EditSegmentForBulkSchemaMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        segment_type = EditSegmentForBulkSchemaSegmentType(d.pop("segment_type"))
        ...
        def _parse_metadata(
            data: object,
        ) -> EditSegmentForBulkSchemaMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = EditSegmentForBulkSchemaMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EditSegmentForBulkSchemaMetadataType0 | None | Unset, data)
        ...
        edit_segment_for_bulk_schema = cls(
            asset_id=asset_id,
            id=id,
            segment_type=segment_type,
        ...
        edit_segment_for_bulk_schema.additional_properties = d
        return edit_segment_for_bulk_schema
