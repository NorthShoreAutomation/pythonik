...
T = TypeVar("T", bound="MetadataFieldMappingsSchema")


@_attrs_define
class MetadataFieldMappingsSchema:
    """
    Attributes:
        objects (list[MetadataFieldMappingSchema] | None | Unset):
    """

    objects: list[MetadataFieldMappingSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[MetadataFieldMappingSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = MetadataFieldMappingSchema.from_dict(
                ...
                pass
            return cast(list[MetadataFieldMappingSchema] | None | Unset, data)

        objects = _parse_objects(d.pop("objects", UNSET))

        metadata_field_mappings_schema = cls(
            objects=objects,
        )

        metadata_field_mappings_schema.additional_properties = d
        return metadata_field_mappings_schema
