...
T = TypeVar("T", bound="RestoreAssetToStorageRequest")


@_attrs_define
class RestoreAssetToStorageRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restore_asset_to_storage_request = cls(
            id=id,
        ...
        restore_asset_to_storage_request.additional_properties = d
        return restore_asset_to_storage_request
