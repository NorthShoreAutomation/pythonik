...
from ..models.file_elastic_schema_status import FileElasticSchemaStatus
from ..models.file_elastic_schema_template_engine import FileElasticSchemaTemplateEngine
...
class FileElasticSchema:
    ...
    Attributes:
        ...
        size (int | None | Unset):
        status (FileElasticSchemaStatus | None | Unset):
        storage_id (None | Unset | UUID):
        template (None | str | Unset):
        template_engine (FileElasticSchemaTemplateEngine | None | Unset):
    ...
    status: FileElasticSchemaStatus | None | Unset = UNSET
    storage_id: None | Unset | UUID = UNSET
    template: None | str | Unset = UNSET
    template_engine: FileElasticSchemaTemplateEngine | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, FileElasticSchemaStatus):
        ...
        elif isinstance(self.template_engine, FileElasticSchemaTemplateEngine):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_status(data: object) -> FileElasticSchemaStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = FileElasticSchemaStatus(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(FileElasticSchemaStatus | None | Unset, data)
        ...
        def _parse_template_engine(
            data: object,
        ) -> FileElasticSchemaTemplateEngine | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                template_engine_type_1 = FileElasticSchemaTemplateEngine(data)

                return template_engine_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(FileElasticSchemaTemplateEngine | None | Unset, data)
