...
T = TypeVar("T", bound="RemoveAssetRestrictionActionParameters")


@_attrs_define
class RemoveAssetRestrictionActionParameters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remove_asset_restriction_action_parameters.additional_properties = d
        return remove_asset_restriction_action_parameters
