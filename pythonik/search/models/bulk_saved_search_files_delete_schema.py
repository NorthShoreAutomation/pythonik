...
T = TypeVar("T", bound="BulkSavedSearchFilesDeleteSchema")


@_attrs_define
class BulkSavedSearchFilesDeleteSchema:
    """
    Attributes:
        job_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_saved_search_files_delete_schema = cls(
            job_id=job_id,
            search_ids=search_ids,
            storage_id=storage_id,
        )

        bulk_saved_search_files_delete_schema.additional_properties = d
        return bulk_saved_search_files_delete_schema
