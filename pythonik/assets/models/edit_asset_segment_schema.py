...
if TYPE_CHECKING:
    ...
    from ..models.edit_asset_segment_schema_metadata import (
...
class EditAssetSegmentSchema:
    ...
    Attributes:
        ...
        metadata (EditAssetSegmentSchemaMetadata | Unset):
        ...
        status (EditAssetSegmentSchemaStatus | Unset):
    ...
    metadata: EditAssetSegmentSchemaMetadata | Unset = UNSET
    ...
    status: EditAssetSegmentSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = EditAssetSegmentSchemaMetadata.from_dict(_metadata)
        ...
        if isinstance(_status, Unset):
            ...
            status = EditAssetSegmentSchemaStatus(_status)
