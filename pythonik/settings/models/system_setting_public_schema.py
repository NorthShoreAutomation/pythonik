...
T = TypeVar("T", bound="SystemSettingPublicSchema")


@_attrs_define
class SystemSettingPublicSchema:
    """
    Attributes:
        ...
        drm (SystemSettingPublicSchemaDrm | Unset): DRM setting Default: SystemSettingPublicSchemaDrm.NONE.
        ...
        mfa_methods (list[SystemSettingPublicSchemaMfaMethodsType0Item] | None | Unset):
        ...
        watermark (SystemSettingPublicSchemaWatermark | Unset): Watermark setting Default:
            SystemSettingPublicSchemaWatermark.NONE.
    ...
    drm: SystemSettingPublicSchemaDrm | Unset = SystemSettingPublicSchemaDrm.NONE
    ...
    watermark: SystemSettingPublicSchemaWatermark | Unset = (
        SystemSettingPublicSchemaWatermark.NONE
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        drm: SystemSettingPublicSchemaDrm | Unset
        if isinstance(_drm, Unset):
            drm = UNSET
        else:
            drm = SystemSettingPublicSchemaDrm(_drm)
        ...
        def _parse_mfa_methods(
            data: object,
        ) -> list[SystemSettingPublicSchemaMfaMethodsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(
                list[SystemSettingPublicSchemaMfaMethodsType0Item] | None | Unset, data
            )
        ...
        if isinstance(_watermark, Unset):
            ...
            watermark = SystemSettingPublicSchemaWatermark(_watermark)
        ...
        system_setting_public_schema = cls(
        ...
        system_setting_public_schema.additional_properties = d
        return system_setting_public_schema
