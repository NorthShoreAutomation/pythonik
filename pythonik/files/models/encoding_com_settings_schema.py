...
T = TypeVar("T", bound="EncodingComSettingsSchema")


@_attrs_define
class EncodingComSettingsSchema:
    """
    Attributes:
        user_id (str):
        user_key (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        encoding_com_settings_schema = cls(
            user_id=user_id,
            user_key=user_key,
        ...
        encoding_com_settings_schema.additional_properties = d
        return encoding_com_settings_schema
