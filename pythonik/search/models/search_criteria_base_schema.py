...
from ..models.search_criteria_base_schema_doc_types_item import (
...
class SearchCriteriaBaseSchema:
    """
    Attributes:
        doc_types (list[SearchCriteriaBaseSchemaDocTypesItem] | Unset):
    ...
    doc_types: list[SearchCriteriaBaseSchemaDocTypesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _doc_types is not UNSET:
            ...
            for doc_types_item_data in _doc_types:
                doc_types_item = SearchCriteriaBaseSchemaDocTypesItem(
                    doc_types_item_data
                )
