...
T = TypeVar("T", bound="ReindexSavedSearchSchema")


@_attrs_define
class ReindexSavedSearchSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_saved_search_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_saved_search_schema.additional_properties = d
        return reindex_saved_search_schema
