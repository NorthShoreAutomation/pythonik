...
class CreateCollectionContentOrderingSchema:
    """
    Attributes:
        custom_order_sort (str | Unset): Initial sort order for an ordered collection. Specified as a comma separated
            list of fieldnames with direction. For example - date_created,asc;status,desc
    """

    custom_order_sort: str | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        custom_order_sort = d.pop("custom_order_sort", UNSET)
