...
T = TypeVar("T", bound="SharesACLSchema")


@_attrs_define
class SharesACLSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[ShareACLSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[ShareACLSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[ShareACLSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = ShareACLSchema.from_dict(
                ...
                pass
            return cast(list[ShareACLSchema] | None | Unset, data)
        ...
        shares_acl_schema.additional_properties = d
        return shares_acl_schema
