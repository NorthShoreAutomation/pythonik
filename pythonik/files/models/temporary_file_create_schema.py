...
T = TypeVar("T", bound="TemporaryFileCreateSchema")


@_attrs_define
class TemporaryFileCreateSchema:
    """
    Attributes:
        directory_path (str):
        original_name (str):
        type_ (TemporaryFileCreateSchemaType):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        path_exist: bool | None | Unset
        if isinstance(self.path_exist, Unset):
            path_exist = UNSET
        else:
            path_exist = self.path_exist
        ...
        if isinstance(self.upload_credentials, Unset):
            ...
            self.upload_credentials, TemporaryFileCreateSchemaUploadCredentialsType0
        ):
        ...
        if path_exist is not UNSET:
            field_dict["path_exist"] = path_exist
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = TemporaryFileCreateSchemaType(d.pop("type"))
        ...
        def _parse_path_exist(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        path_exist = _parse_path_exist(d.pop("path_exist", UNSET))
        ...
        def _parse_upload_credentials(
            ...
            try:
                ...
                upload_credentials_type_0 = (
                    TemporaryFileCreateSchemaUploadCredentialsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | TemporaryFileCreateSchemaUploadCredentialsType0 | Unset, data
            )
        ...
        temporary_file_create_schema = cls(
            directory_path=directory_path,
            original_name=original_name,
            type_=type_,
            asset_id=asset_id,
        ...
        temporary_file_create_schema.additional_properties = d
        return temporary_file_create_schema
