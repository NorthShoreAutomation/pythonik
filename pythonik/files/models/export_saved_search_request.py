...
T = TypeVar("T", bound="ExportSavedSearchRequest")


@_attrs_define
class ExportSavedSearchRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_saved_search_request = cls(
            id=id,
        ...
        export_saved_search_request.additional_properties = d
        return export_saved_search_request
