...
class EditSegmentSchema:
    ...
    Attributes:
        ...
        metadata (EditSegmentSchemaMetadataType0 | None | Unset):
    ...
    metadata: EditSegmentSchemaMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, EditSegmentSchemaMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(
            data: object,
        ) -> EditSegmentSchemaMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = EditSegmentSchemaMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EditSegmentSchemaMetadataType0 | None | Unset, data)
