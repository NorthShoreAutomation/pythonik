...
class Playlist:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_keyframes(
            data: object,
        ) -> list[PlaylistKeyframesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for keyframes_type_0_item_data in _keyframes_type_0:
                    keyframes_type_0_item = PlaylistKeyframesType0Item.from_dict(
                ...
                pass
            return cast(list[PlaylistKeyframesType0Item] | None | Unset, data)
