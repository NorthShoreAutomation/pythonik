...
if TYPE_CHECKING:
    ...
    from ..models.edit_segment_schema_metadata import EditSegmentSchemaMetadata
    from ..models.face_bounding_box import FaceBoundingBox
    from ..models.transcription_type import TranscriptionType
    from ..models.user import User


T = TypeVar("T", bound="EditSegmentSchema")


@_attrs_define
class EditSegmentSchema:
    """
    Attributes:
        segment_type (EditSegmentSchemaSegmentType):
        asset_id (UUID | Unset):
        ...
        metadata (EditSegmentSchemaMetadata | Unset):
        ...
        status (EditSegmentSchemaStatus | Unset):
    ...
    metadata: EditSegmentSchemaMetadata | Unset = UNSET
    ...
    status: EditSegmentSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        segment_type = EditSegmentSchemaSegmentType(d.pop("segment_type"))
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = EditSegmentSchemaMetadata.from_dict(_metadata)
        ...
        if isinstance(_status, Unset):
            ...
            status = EditSegmentSchemaStatus(_status)
        ...
        edit_segment_schema.additional_properties = d
        return edit_segment_schema
