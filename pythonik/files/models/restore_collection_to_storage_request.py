...
T = TypeVar("T", bound="RestoreCollectionToStorageRequest")


@_attrs_define
class RestoreCollectionToStorageRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restore_collection_to_storage_request = cls(
            id=id,
        ...
        restore_collection_to_storage_request.additional_properties = d
        return restore_collection_to_storage_request
