...
T = TypeVar("T", bound="ReindexViewDateSchema")


@_attrs_define
class ReindexViewDateSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_view_date_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_view_date_schema.additional_properties = d
        return reindex_view_date_schema
