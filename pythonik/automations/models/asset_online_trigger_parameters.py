...
T = TypeVar("T", bound="AssetOnlineTriggerParameters")


@_attrs_define
class AssetOnlineTriggerParameters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        asset_online_trigger_parameters = cls(
            only_first_version=only_first_version,
            wait_for_transcode=wait_for_transcode,
        )

        asset_online_trigger_parameters.additional_properties = d
        return asset_online_trigger_parameters
