...
class Proxy:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.upload_credentials, ProxyUploadCredentialsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_upload_credentials(
            data: object,
        ) -> None | ProxyUploadCredentialsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                upload_credentials_type_0 = ProxyUploadCredentialsType0.from_dict(data)

                return upload_credentials_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProxyUploadCredentialsType0 | Unset, data)
