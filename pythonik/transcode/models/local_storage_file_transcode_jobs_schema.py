...
T = TypeVar("T", bound="LocalStorageFileTranscodeJobsSchema")


@_attrs_define
class LocalStorageFileTranscodeJobsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[LocalStorageFileTranscodeJobSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[LocalStorageFileTranscodeJobSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[LocalStorageFileTranscodeJobSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = LocalStorageFileTranscodeJobSchema.from_dict(
                ...
                pass
            return cast(list[LocalStorageFileTranscodeJobSchema] | None | Unset, data)
        ...
        local_storage_file_transcode_jobs_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        local_storage_file_transcode_jobs_schema.additional_properties = d
        return local_storage_file_transcode_jobs_schema
