...
T = TypeVar("T", bound="SequencesSchema")


@_attrs_define
class SequencesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[SequenceSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[SequenceSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[SequenceSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = SequenceSchema.from_dict(
                ...
                pass
            return cast(list[SequenceSchema] | None | Unset, data)
        ...
        sequences_schema.additional_properties = d
        return sequences_schema
