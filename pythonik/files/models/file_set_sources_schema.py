...
if TYPE_CHECKING:
    from ..models.file_set_source_schema import FileSetSourceSchema


T = TypeVar("T", bound="FileSetSourcesSchema")


@_attrs_define
class FileSetSourcesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[FileSetSourceSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[FileSetSourceSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[FileSetSourceSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = FileSetSourceSchema.from_dict(
                ...
                pass
            return cast(list[FileSetSourceSchema] | None | Unset, data)
        ...
        file_set_sources_schema.additional_properties = d
        return file_set_sources_schema
