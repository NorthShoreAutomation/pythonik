...
T = TypeVar("T", bound="BillingsSchema")


@_attrs_define
class BillingsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[BillingSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[BillingSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[BillingSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = BillingSchema.from_dict(
                ...
                pass
            return cast(list[BillingSchema] | None | Unset, data)
        ...
        billings_schema.additional_properties = d
        return billings_schema
