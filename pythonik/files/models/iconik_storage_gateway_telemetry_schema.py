...
class IconikStorageGatewayTelemetrySchema:
    ...
    Attributes:
        ...
        start_status (IconikStorageGatewayTelemetrySchemaStartStatus | Unset):
        start_status_message (str | Unset):
        status (IconikStorageGatewayTelemetrySchemaStatus | Unset):
    ...
    start_status: IconikStorageGatewayTelemetrySchemaStartStatus | Unset = UNSET
    start_status_message: str | Unset = UNSET
    status: IconikStorageGatewayTelemetrySchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_start_status, Unset):
            ...
            start_status = IconikStorageGatewayTelemetrySchemaStartStatus(_start_status)
        ...
        if isinstance(_status, Unset):
            ...
            status = IconikStorageGatewayTelemetrySchemaStatus(_status)
