...
if TYPE_CHECKING:
    ...
    from ..models.users_schema_facets import UsersSchemaFacets
...
class UsersSchema:
    """
    Attributes:
        facets (UsersSchemaFacets | Unset):
        first_url (str | Unset):
        last_url (str | Unset):
        next_url (str | Unset):
        objects (list[UserElasticSchema] | Unset):
        page (int | Unset):
        pages (int | Unset):
        per_page (int | Unset):
        prev_url (str | Unset):
    ...
    facets: UsersSchemaFacets | Unset = UNSET
    first_url: str | Unset = UNSET
    last_url: str | Unset = UNSET
    next_url: str | Unset = UNSET
    objects: list[UserElasticSchema] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_facets, Unset):
            ...
            facets = UsersSchemaFacets.from_dict(_facets)
        ...
        if _objects is not UNSET:
            ...
            for objects_item_data in _objects:
                objects_item = UserElasticSchema.from_dict(objects_item_data)
