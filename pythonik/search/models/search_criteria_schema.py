...
from ..models.search_criteria_schema_doc_types_type_0_item import (
...
class SearchCriteriaSchema:
    """
    Attributes:
        doc_types (list[SearchCriteriaSchemaDocTypesType0Item] | None | Unset):
    ...
    doc_types: list[SearchCriteriaSchemaDocTypesType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_doc_types(
            data: object,
        ) -> list[SearchCriteriaSchemaDocTypesType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for doc_types_type_0_item_data in _doc_types_type_0:
                    doc_types_type_0_item = SearchCriteriaSchemaDocTypesType0Item(
                ...
                pass
            return cast(
                list[SearchCriteriaSchemaDocTypesType0Item] | None | Unset, data
            )
