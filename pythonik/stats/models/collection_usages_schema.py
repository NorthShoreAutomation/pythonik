...
class CollectionUsagesSchema:
    ...
    Attributes:
        ...
        last_url (str | Unset):
        next_url (str | Unset):
        objects (list[CollectionUsagesElasticSchema] | Unset):
        page (int | Unset):
        pages (int | Unset):
        per_page (int | Unset):
        prev_url (str | Unset):
    ...
    objects: list[CollectionUsagesElasticSchema] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _objects is not UNSET:
            ...
            for objects_item_data in _objects:
                objects_item = CollectionUsagesElasticSchema.from_dict(
                    objects_item_data
                )
