...
if TYPE_CHECKING:
    from ..models.webhook_base_schema_headers import WebhookBaseSchemaHeaders
...
class WebhookBaseSchema:
    ...
    Attributes:
        ...
        headers (WebhookBaseSchemaHeaders | Unset): Define the key-value pairs your third party provider requires here
    ...
    headers: WebhookBaseSchemaHeaders | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        headers: WebhookBaseSchemaHeaders | Unset
        if isinstance(_headers, Unset):
            headers = UNSET
        else:
            headers = WebhookBaseSchemaHeaders.from_dict(_headers)
