...
T = TypeVar("T", bound="ReindexShareSchema")


@_attrs_define
class ReindexShareSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_share_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_share_schema.additional_properties = d
        return reindex_share_schema
