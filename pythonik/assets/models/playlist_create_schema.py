...
from ..models.playlist_create_schema_status import PlaylistCreateSchemaStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.playlist_create_schema_keyframes_type_0_item import (
        PlaylistCreateSchemaKeyframesType0Item,
    )
    from ..models.playlist_item import PlaylistItem


T = TypeVar("T", bound="PlaylistCreateSchema")


@_attrs_define
class PlaylistCreateSchema:
    """
    Attributes:
        name (str):
        ...
        keyframes (list[PlaylistCreateSchemaKeyframesType0Item] | None | Unset):
        playlist_items (list[PlaylistItem] | None | Unset):
        project_id (None | Unset | UUID):
        status (None | PlaylistCreateSchemaStatus | Unset):
    ...
    keyframes: list[PlaylistCreateSchemaKeyframesType0Item] | None | Unset = UNSET
    playlist_items: list[PlaylistItem] | None | Unset = UNSET
    project_id: None | Unset | UUID = UNSET
    status: None | PlaylistCreateSchemaStatus | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, PlaylistCreateSchemaStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_keyframes(
            data: object,
        ) -> list[PlaylistCreateSchemaKeyframesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for keyframes_type_0_item_data in _keyframes_type_0:
                    keyframes_type_0_item = (
                        PlaylistCreateSchemaKeyframesType0Item.from_dict(
                ...
                pass
            return cast(
                list[PlaylistCreateSchemaKeyframesType0Item] | None | Unset, data
            )

        keyframes = _parse_keyframes(d.pop("keyframes", UNSET))

        def _parse_playlist_items(data: object) -> list[PlaylistItem] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for playlist_items_type_0_item_data in _playlist_items_type_0:
                    playlist_items_type_0_item = PlaylistItem.from_dict(
                ...
                pass
            return cast(list[PlaylistItem] | None | Unset, data)
        ...
        def _parse_status(data: object) -> None | PlaylistCreateSchemaStatus | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = PlaylistCreateSchemaStatus(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PlaylistCreateSchemaStatus | Unset, data)
        ...
        playlist_create_schema.additional_properties = d
        return playlist_create_schema
