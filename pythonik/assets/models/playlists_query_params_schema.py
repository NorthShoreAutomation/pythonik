...
T = TypeVar("T", bound="PlaylistsQueryParamsSchema")


@_attrs_define
class PlaylistsQueryParamsSchema:
    """
    Attributes:
        ids (None | str | Unset): A comma separated list of playlist IDs to filter by
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        playlists_query_params_schema = cls(
            ids=ids,
            page=page,
            per_page=per_page,
            sort=sort,
        ...
        playlists_query_params_schema.additional_properties = d
        return playlists_query_params_schema
