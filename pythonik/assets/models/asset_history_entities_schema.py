...
if TYPE_CHECKING:
    from ..models.asset_history_elastic_schema import AssetHistoryElasticSchema


T = TypeVar("T", bound="AssetHistoryEntitiesSchema")


@_attrs_define
class AssetHistoryEntitiesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[AssetHistoryElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[AssetHistoryElasticSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[AssetHistoryElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = AssetHistoryElasticSchema.from_dict(
                ...
                pass
            return cast(list[AssetHistoryElasticSchema] | None | Unset, data)
        ...
        asset_history_entities_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        asset_history_entities_schema.additional_properties = d
        return asset_history_entities_schema
