...
if TYPE_CHECKING:
    ...
    from ..models.collection_elastic_schema import CollectionElasticSchema


T = TypeVar("T", bound="CollectionContentsSchema")


@_attrs_define
class CollectionContentsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[AssetElasticSchema | CollectionElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[AssetElasticSchema | CollectionElasticSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[AssetElasticSchema | CollectionElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    ...
                    def _parse_objects_type_0_item(
                        data: object,
                    ) -> AssetElasticSchema | CollectionElasticSchema:
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            componentsschemas_collection_content_elastic_schema_type_0 = AssetElasticSchema.from_dict(
                                data
                            )

                            return componentsschemas_collection_content_elastic_schema_type_0
                        except (TypeError, ValueError, AttributeError, KeyError):
                            pass
                        if not isinstance(data, dict):
                            raise TypeError()
                        componentsschemas_collection_content_elastic_schema_type_1 = (
                            CollectionElasticSchema.from_dict(data)
                        )
                ...
                pass
            return cast(
                list[AssetElasticSchema | CollectionElasticSchema] | None | Unset, data
            )
        ...
        collection_contents_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        collection_contents_schema.additional_properties = d
        return collection_contents_schema
