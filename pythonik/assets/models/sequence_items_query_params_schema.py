...
T = TypeVar("T", bound="SequenceItemsQueryParamsSchema")


@_attrs_define
class SequenceItemsQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sequence_items_query_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        sequence_items_query_params_schema.additional_properties = d
        return sequence_items_query_params_schema
