...
T = TypeVar("T", bound="ReindexSystemDomainSchema")


@_attrs_define
class ReindexSystemDomainSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_system_domain_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_system_domain_schema.additional_properties = d
        return reindex_system_domain_schema
