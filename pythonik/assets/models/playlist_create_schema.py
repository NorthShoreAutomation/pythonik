...
if TYPE_CHECKING:
    from ..models.playlist_create_schema_keyframes_item import (
...
class PlaylistCreateSchema:
    ...
    Attributes:
        ...
        keyframes (list[PlaylistCreateSchemaKeyframesItem] | Unset):
        playlist_items (list[PlaylistItem] | Unset):
        project_id (UUID | Unset):
        status (PlaylistCreateSchemaStatus | Unset):
    ...
    keyframes: list[PlaylistCreateSchemaKeyframesItem] | Unset = UNSET
    playlist_items: list[PlaylistItem] | Unset = UNSET
    project_id: UUID | Unset = UNSET
    status: PlaylistCreateSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _keyframes is not UNSET:
            ...
            for keyframes_item_data in _keyframes:
                keyframes_item = PlaylistCreateSchemaKeyframesItem.from_dict(
                    keyframes_item_data
                )
        ...
        if _playlist_items is not UNSET:
            ...
            for playlist_items_item_data in _playlist_items:
                playlist_items_item = PlaylistItem.from_dict(playlist_items_item_data)
        ...
        if isinstance(_status, Unset):
            ...
            status = PlaylistCreateSchemaStatus(_status)
