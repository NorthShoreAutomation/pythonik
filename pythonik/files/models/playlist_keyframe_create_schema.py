...
from ..models.playlist_keyframe_create_schema_type import (
    PlaylistKeyframeCreateSchemaType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.playlist_keyframe_create_schema_status_type_1 import (
        PlaylistKeyframeCreateSchemaStatusType1,
    )
    from ..models.playlist_keyframe_create_schema_upload_credentials_type_0 import (
...
T = TypeVar("T", bound="PlaylistKeyframeCreateSchema")


@_attrs_define
class PlaylistKeyframeCreateSchema:
    """
    Attributes:
        type_ (PlaylistKeyframeCreateSchemaType):
        ...
        size (int | None | Unset):
        status (None | PlaylistKeyframeCreateSchemaStatusType1 | Unset):
        storage_id (None | Unset | UUID):
        time_code (None | TimeCodeType | Unset):
        upload_credentials (None | PlaylistKeyframeCreateSchemaUploadCredentialsType0 | Unset):
    ...
    status: None | PlaylistKeyframeCreateSchemaStatusType1 | Unset = UNSET
    storage_id: None | Unset | UUID = UNSET
    time_code: None | TimeCodeType | Unset = UNSET
    upload_credentials: (
        None | PlaylistKeyframeCreateSchemaUploadCredentialsType0 | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, PlaylistKeyframeCreateSchemaStatusType1):
        ...
        if isinstance(self.upload_credentials, Unset):
            ...
            self.upload_credentials, PlaylistKeyframeCreateSchemaUploadCredentialsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = PlaylistKeyframeCreateSchemaType(d.pop("type"))
        ...
        def _parse_status(
            data: object,
        ) -> None | PlaylistKeyframeCreateSchemaStatusType1 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                status_type_1 = PlaylistKeyframeCreateSchemaStatusType1.from_dict(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PlaylistKeyframeCreateSchemaStatusType1 | Unset, data)
        ...
        def _parse_upload_credentials(
            ...
            try:
                ...
                upload_credentials_type_0 = (
                    PlaylistKeyframeCreateSchemaUploadCredentialsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                None | PlaylistKeyframeCreateSchemaUploadCredentialsType0 | Unset, data
            )
        ...
        playlist_keyframe_create_schema = cls(
            type_=type_,
        ...
        playlist_keyframe_create_schema.additional_properties = d
        return playlist_keyframe_create_schema
