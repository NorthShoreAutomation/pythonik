...
T = TypeVar("T", bound="StorageGatewayParamsSchema")


@_attrs_define
class StorageGatewayParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        storage_gateway_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        storage_gateway_params_schema.additional_properties = d
        return storage_gateway_params_schema
