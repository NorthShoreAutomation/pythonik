...
T = TypeVar("T", bound="CollectionsSchema")
...
class CollectionsSchema:
    ...
    Attributes:
        ...
        objects (list[CollectionElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[CollectionElasticSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[CollectionElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = CollectionElasticSchema.from_dict(
                ...
                pass
            return cast(list[CollectionElasticSchema] | None | Unset, data)
        ...
        collections_schema.additional_properties = d
