...
T = TypeVar("T", bound="ArchiveSavedSearchRequestSchema")


@_attrs_define
class ArchiveSavedSearchRequestSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        archive_saved_search_request_schema = cls(
            id=id,
        ...
        archive_saved_search_request_schema.additional_properties = d
        return archive_saved_search_request_schema
