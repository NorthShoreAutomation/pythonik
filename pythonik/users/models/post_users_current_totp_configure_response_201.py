...
T = TypeVar("T", bound="PostUsersCurrentTotpConfigureResponse201")
...
class PostUsersCurrentTotpConfigureResponse201:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_users_current_totp_configure_response_201.additional_properties = d
        return post_users_current_totp_configure_response_201
