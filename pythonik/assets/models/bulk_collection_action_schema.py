...
if TYPE_CHECKING:
    from ..models.bulk_collection_action_schema_callback_data_request_type_0 import (
        BulkCollectionActionSchemaCallbackDataRequestType0,
    )
    from ..models.bulk_collection_action_schema_callback_data_type_0 import (
        BulkCollectionActionSchemaCallbackDataType0,
    )


T = TypeVar("T", bound="BulkCollectionActionSchema")


@_attrs_define
class BulkCollectionActionSchema:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.callback_data, Unset):
            ...
            self.callback_data, BulkCollectionActionSchemaCallbackDataType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_callback_data(
            data: object,
        ) -> BulkCollectionActionSchemaCallbackDataType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                callback_data_type_0 = (
                    BulkCollectionActionSchemaCallbackDataType0.from_dict(data)
                )
                ...
                pass
            return cast(
                BulkCollectionActionSchemaCallbackDataType0 | None | Unset, data
            )
        ...
        def _parse_callback_data_request(
            ...
            try:
                ...
                callback_data_request_type_0 = (
                    BulkCollectionActionSchemaCallbackDataRequestType0.from_dict(data)
                )
                ...
                pass
            return cast(
                BulkCollectionActionSchemaCallbackDataRequestType0 | None | Unset, data
            )
        ...
        bulk_collection_action_schema.additional_properties = d
        return bulk_collection_action_schema
