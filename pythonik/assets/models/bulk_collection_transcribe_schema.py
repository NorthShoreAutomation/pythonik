...
if TYPE_CHECKING:
    from ..models.bulk_collection_transcribe_schema_callback_data_request_type_0 import (
        BulkCollectionTranscribeSchemaCallbackDataRequestType0,
    )
    from ..models.bulk_collection_transcribe_schema_callback_data_type_0 import (
        BulkCollectionTranscribeSchemaCallbackDataType0,
    )


T = TypeVar("T", bound="BulkCollectionTranscribeSchema")


@_attrs_define
class BulkCollectionTranscribeSchema:
    """
    Attributes:
        ...
        callback_data (BulkCollectionTranscribeSchemaCallbackDataType0 | None | Unset):
        callback_data_request (BulkCollectionTranscribeSchemaCallbackDataRequestType0 | None | Unset):
    ...
    callback_data_request: (
        BulkCollectionTranscribeSchemaCallbackDataRequestType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.callback_data, Unset):
            ...
            self.callback_data, BulkCollectionTranscribeSchemaCallbackDataType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_callback_data(
            data: object,
        ) -> BulkCollectionTranscribeSchemaCallbackDataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                callback_data_type_0 = (
                    BulkCollectionTranscribeSchemaCallbackDataType0.from_dict(data)
                )
                ...
                pass
            return cast(
                BulkCollectionTranscribeSchemaCallbackDataType0 | None | Unset, data
            )
        ...
        def _parse_callback_data_request(
            ...
            try:
                ...
                callback_data_request_type_0 = (
                    BulkCollectionTranscribeSchemaCallbackDataRequestType0.from_dict(
                        data
                    )
                )
        ...
        bulk_collection_transcribe_schema = cls(
            collection_ids=collection_ids,
            include_assets=include_assets,
            include_collections=include_collections,
            job_id=job_id,
        ...
        bulk_collection_transcribe_schema.additional_properties = d
        return bulk_collection_transcribe_schema
