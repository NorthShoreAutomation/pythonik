...
T = TypeVar("T", bound="SearchHistoryListSchema")


@_attrs_define
class SearchHistoryListSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[SearchHistory] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[SearchHistory] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[SearchHistory] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = SearchHistory.from_dict(
                ...
                pass
            return cast(list[SearchHistory] | None | Unset, data)
        ...
        search_history_list_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        search_history_list_schema.additional_properties = d
        return search_history_list_schema
