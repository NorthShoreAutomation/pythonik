...
if TYPE_CHECKING:
    ...
    from ..models.playlist_item_elastic_schema_formats_type_0_item import (
        PlaylistItemElasticSchemaFormatsType0Item,
    )
    from ..models.playlist_item_elastic_schema_keyframes_type_0_item import (
...
class PlaylistItemElasticSchema:
    ...
    Attributes:
        ...
        keyframes (list[PlaylistItemElasticSchemaKeyframesType0Item] | None | Unset):
        ...
        metadata (None | PlaylistItemElasticSchemaMetadataType0 | Unset):
    ...
    formats: list[PlaylistItemElasticSchemaFormatsType0Item] | None | Unset = UNSET
    ...
    keyframes: list[PlaylistItemElasticSchemaKeyframesType0Item] | None | Unset = UNSET
    ...
    metadata: None | PlaylistItemElasticSchemaMetadataType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, PlaylistItemElasticSchemaMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_files(
            data: object,
        ) -> list[PlaylistItemElasticSchemaFilesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for files_type_0_item_data in _files_type_0:
                    files_type_0_item = (
                        PlaylistItemElasticSchemaFilesType0Item.from_dict(
                ...
                pass
            return cast(
                list[PlaylistItemElasticSchemaFilesType0Item] | None | Unset, data
            )
        ...
        def _parse_formats(
            data: object,
        ) -> list[PlaylistItemElasticSchemaFormatsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for formats_type_0_item_data in _formats_type_0:
                    formats_type_0_item = (
                        PlaylistItemElasticSchemaFormatsType0Item.from_dict(
                ...
                pass
            return cast(
                list[PlaylistItemElasticSchemaFormatsType0Item] | None | Unset, data
            )
        ...
        def _parse_keyframes(
            data: object,
        ) -> list[PlaylistItemElasticSchemaKeyframesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for keyframes_type_0_item_data in _keyframes_type_0:
                    keyframes_type_0_item = (
                        PlaylistItemElasticSchemaKeyframesType0Item.from_dict(
                ...
                pass
            return cast(
                list[PlaylistItemElasticSchemaKeyframesType0Item] | None | Unset, data
            )
        ...
        def _parse_metadata(
            data: object,
        ) -> None | PlaylistItemElasticSchemaMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = PlaylistItemElasticSchemaMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PlaylistItemElasticSchemaMetadataType0 | Unset, data)
        ...
        def _parse_proxies(
            data: object,
        ) -> list[PlaylistItemElasticSchemaProxiesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for proxies_type_0_item_data in _proxies_type_0:
                    proxies_type_0_item = (
                        PlaylistItemElasticSchemaProxiesType0Item.from_dict(
                ...
                pass
            return cast(
                list[PlaylistItemElasticSchemaProxiesType0Item] | None | Unset, data
            )
        ...
        def _parse_versions(data: object) -> list[AssetVersionSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for versions_type_0_item_data in _versions_type_0:
                    versions_type_0_item = AssetVersionSchema.from_dict(
                ...
                pass
            return cast(list[AssetVersionSchema] | None | Unset, data)
