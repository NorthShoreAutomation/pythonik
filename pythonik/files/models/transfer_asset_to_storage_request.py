...
T = TypeVar("T", bound="TransferAssetToStorageRequest")


@_attrs_define
class TransferAssetToStorageRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfer_asset_to_storage_request = cls(
            id=id,
        ...
        transfer_asset_to_storage_request.additional_properties = d
        return transfer_asset_to_storage_request
