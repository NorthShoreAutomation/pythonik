...
if TYPE_CHECKING:
    from ..models.storage_usages_elastic_schema import StorageUsagesElasticSchema


T = TypeVar("T", bound="StorageUsagesSchema")


@_attrs_define
class StorageUsagesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[StorageUsagesElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[StorageUsagesElasticSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[StorageUsagesElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = StorageUsagesElasticSchema.from_dict(
                ...
                pass
            return cast(list[StorageUsagesElasticSchema] | None | Unset, data)
        ...
        storage_usages_schema.additional_properties = d
        return storage_usages_schema
