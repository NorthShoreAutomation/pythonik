...
if TYPE_CHECKING:
    from ..models.discovery_entity_schema_metadata import DiscoveryEntitySchemaMetadata
...
class DiscoveryEntitySchema:
    ...
    Attributes:
        ...
        id (UUID | Unset):
        metadata (DiscoveryEntitySchemaMetadata | Unset):
    """
    ...
    id: UUID | Unset = UNSET
    metadata: DiscoveryEntitySchemaMetadata | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.discovery_entity_schema_metadata import (
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = DiscoveryEntitySchemaMetadata.from_dict(_metadata)
