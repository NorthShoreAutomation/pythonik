...
if TYPE_CHECKING:
    ...
    from ..models.transcoders_by_storage_schema_facets_type_0 import (
        TranscodersByStorageSchemaFacetsType0,
    )


T = TypeVar("T", bound="TranscodersByStorageSchema")


@_attrs_define
class TranscodersByStorageSchema:
    """
    Attributes:
        facets (None | TranscodersByStorageSchemaFacetsType0 | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[TranscoderByStorageReadSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: None | TranscodersByStorageSchemaFacetsType0 | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[TranscoderByStorageReadSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, TranscodersByStorageSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.transcoder_by_storage_read_schema import (
        ...
        def _parse_facets(
            data: object,
        ) -> None | TranscodersByStorageSchemaFacetsType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = TranscodersByStorageSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | TranscodersByStorageSchemaFacetsType0 | Unset, data)
        ...
        def _parse_objects(
            data: object,
        ) -> list[TranscoderByStorageReadSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = TranscoderByStorageReadSchema.from_dict(
                ...
                pass
            return cast(list[TranscoderByStorageReadSchema] | None | Unset, data)
        ...
        transcoders_by_storage_schema = cls(
            facets=facets,
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
        ...
        transcoders_by_storage_schema.additional_properties = d
        return transcoders_by_storage_schema
