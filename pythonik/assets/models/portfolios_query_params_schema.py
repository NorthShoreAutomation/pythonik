...
T = TypeVar("T", bound="PortfoliosQueryParamsSchema")


@_attrs_define
class PortfoliosQueryParamsSchema:
    """
    Attributes:
        ids (None | str | Unset): A comma separated list of portfolio IDs to filter by
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        portfolios_query_params_schema = cls(
            ids=ids,
            page=page,
            per_page=per_page,
            sort=sort,
        ...
        portfolios_query_params_schema.additional_properties = d
        return portfolios_query_params_schema
