...
if TYPE_CHECKING:
    from ..models.get_share_schema_drm_type_1 import GetShareSchemaDrmType1
    from ..models.get_share_schema_population_status_type_1 import (
        GetShareSchemaPopulationStatusType1,
    )
    from ..models.get_share_schema_watermark_type_1 import GetShareSchemaWatermarkType1
    from ..models.share_user import ShareUser
    from ..models.upload_storage import UploadStorage


T = TypeVar("T", bound="GetShareSchema")


@_attrs_define
class GetShareSchema:
    """
    Attributes:
        ...
        drm (GetShareSchemaDrmType1 | None | Unset):
        ...
        population_status (GetShareSchemaPopulationStatusType1 | None | Unset):
        ...
        upload_storage (None | Unset | UploadStorage):
        upload_storage_id (None | Unset | UUID):
        upload_storage_presign_md5_checksum (bool | None | Unset):
        url (None | str | Unset):
        users (list[ShareUser] | None | Unset):
        watermark (GetShareSchemaWatermarkType1 | None | Unset):
    """
    ...
    drm: GetShareSchemaDrmType1 | None | Unset = UNSET
    ...
    population_status: GetShareSchemaPopulationStatusType1 | None | Unset = UNSET
    ...
    upload_storage: None | Unset | UploadStorage = UNSET
    upload_storage_id: None | Unset | UUID = UNSET
    upload_storage_presign_md5_checksum: bool | None | Unset = UNSET
    url: None | str | Unset = UNSET
    users: list[ShareUser] | None | Unset = UNSET
    watermark: GetShareSchemaWatermarkType1 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.get_share_schema_watermark_type_1 import (
        ...
        if isinstance(self.drm, Unset):
            drm = UNSET
        elif isinstance(self.drm, GetShareSchemaDrmType1):
        ...
        elif isinstance(self.population_status, GetShareSchemaPopulationStatusType1):
        ...
        upload_storage: dict[str, Any] | None | Unset
        if isinstance(self.upload_storage, Unset):
            upload_storage = UNSET
        elif isinstance(self.upload_storage, UploadStorage):
            upload_storage = self.upload_storage.to_dict()
        else:
        ...
        upload_storage_presign_md5_checksum: bool | None | Unset
        if isinstance(self.upload_storage_presign_md5_checksum, Unset):
            upload_storage_presign_md5_checksum = UNSET
        else:
            upload_storage_presign_md5_checksum = (
                self.upload_storage_presign_md5_checksum
            )
        ...
        if isinstance(self.watermark, Unset):
            watermark = UNSET
        elif isinstance(self.watermark, GetShareSchemaWatermarkType1):
        ...
        if upload_storage is not UNSET:
            field_dict["upload_storage"] = upload_storage
        if upload_storage_id is not UNSET:
            field_dict["upload_storage_id"] = upload_storage_id
        if upload_storage_presign_md5_checksum is not UNSET:
            field_dict["upload_storage_presign_md5_checksum"] = (
                upload_storage_presign_md5_checksum
            )
        if url is not UNSET:
            field_dict["url"] = url
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_drm(data: object) -> GetShareSchemaDrmType1 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                drm_type_1 = GetShareSchemaDrmType1.from_dict(data)

                return drm_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetShareSchemaDrmType1 | None | Unset, data)
        ...
        def _parse_population_status(
            data: object,
        ) -> GetShareSchemaPopulationStatusType1 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                population_status_type_1 = (
                    GetShareSchemaPopulationStatusType1.from_dict(data)
                )

                return population_status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetShareSchemaPopulationStatusType1 | None | Unset, data)
        ...
        def _parse_upload_storage(data: object) -> None | Unset | UploadStorage:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                upload_storage_type_1 = UploadStorage.from_dict(data)

                return upload_storage_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UploadStorage, data)

        upload_storage = _parse_upload_storage(d.pop("upload_storage", UNSET))
        ...
        def _parse_upload_storage_presign_md5_checksum(
            data: object,
        ) -> bool | None | Unset:
            if data is None:
                return data
        ...
        upload_storage_presign_md5_checksum = (
            _parse_upload_storage_presign_md5_checksum(
                d.pop("upload_storage_presign_md5_checksum", UNSET)
            )
        )
        ...
        def _parse_users(data: object) -> list[ShareUser] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for users_type_0_item_data in _users_type_0:
                    users_type_0_item = ShareUser.from_dict(users_type_0_item_data)
                ...
                pass
            return cast(list[ShareUser] | None | Unset, data)

        users = _parse_users(d.pop("users", UNSET))

        def _parse_watermark(
            data: object,
        ) -> GetShareSchemaWatermarkType1 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                watermark_type_1 = GetShareSchemaWatermarkType1.from_dict(data)

                return watermark_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetShareSchemaWatermarkType1 | None | Unset, data)

        watermark = _parse_watermark(d.pop("watermark", UNSET))

        get_share_schema = cls(
            allow_approving_comments=allow_approving_comments,
            allow_comments=allow_comments,
            allow_download=allow_download,
            allow_setting_approve_status=allow_setting_approve_status,
            ...
            upload_storage_presign_md5_checksum=upload_storage_presign_md5_checksum,
            url=url,
            users=users,
            watermark=watermark,
        )

        get_share_schema.additional_properties = d
        return get_share_schema
