...
T = TypeVar("T", bound="PrioPatternSchema")


@_attrs_define
class PrioPatternSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        prio_pattern_schema = cls(
            pattern=pattern,
            priority=priority,
        )

        prio_pattern_schema.additional_properties = d
        return prio_pattern_schema
