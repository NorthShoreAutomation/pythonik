...
T = TypeVar("T", bound="PropagatingGroupACLSchema")
...
class PropagatingGroupACLSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        propagating_group_acl_schema = cls(
            permissions=permissions,
            group_id=group_id,
        ...
        propagating_group_acl_schema.additional_properties = d
        return propagating_group_acl_schema
