...
class BulkShareCreateSchema:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if share_by_url is not UNSET:
            field_dict["share_by_url"] = share_by_url
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_share_create_schema.additional_properties = d
        return bulk_share_create_schema
