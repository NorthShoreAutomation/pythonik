...
T = TypeVar("T", bound="ReindexMetadataViewSchema")


@_attrs_define
class ReindexMetadataViewSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_metadata_view_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_metadata_view_schema.additional_properties = d
        return reindex_metadata_view_schema
