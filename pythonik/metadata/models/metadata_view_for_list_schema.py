...
T = TypeVar("T", bound="MetadataViewForListSchema")


@_attrs_define
class MetadataViewForListSchema:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metadata_view_for_list_schema = cls(
            name=name,
            view_fields=view_fields,
        ...
        metadata_view_for_list_schema.additional_properties = d
        return metadata_view_for_list_schema
