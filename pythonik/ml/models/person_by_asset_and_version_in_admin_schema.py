...
from ..models.person_by_asset_and_version_in_admin_schema_status import (
    PersonByAssetAndVersionInAdminSchemaStatus,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonByAssetAndVersionInAdminSchema")


@_attrs_define
class PersonByAssetAndVersionInAdminSchema:
    """
    Attributes:
        asset_id (UUID):
        asset_title (str):
        ...
        status (PersonByAssetAndVersionInAdminSchemaStatus):
        version_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PersonByAssetAndVersionInAdminSchemaStatus(d.pop("status"))
        ...
        person_by_asset_and_version_in_admin_schema = cls(
            asset_id=asset_id,
            asset_title=asset_title,
            created_by_user=created_by_user,
            date_created=date_created,
        ...
        person_by_asset_and_version_in_admin_schema.additional_properties = d
        return person_by_asset_and_version_in_admin_schema
