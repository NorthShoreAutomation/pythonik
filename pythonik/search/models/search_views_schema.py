...
T = TypeVar("T", bound="SearchViewsSchema")


@_attrs_define
class SearchViewsSchema:
    """
    Attributes:
        objects (list[SearchViewSchema] | None | Unset):
    """

    objects: list[SearchViewSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[SearchViewSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = SearchViewSchema.from_dict(
                ...
                pass
            return cast(list[SearchViewSchema] | None | Unset, data)

        objects = _parse_objects(d.pop("objects", UNSET))

        search_views_schema = cls(
            objects=objects,
        )

        search_views_schema.additional_properties = d
        return search_views_schema
