...
class TeamSchema:
    ...
    Attributes:
        ...
        default_user_type (TeamSchemaDefaultUserType | Unset):
        description (str | Unset):
        external_id (None | str | Unset):
        group_type (TeamSchemaGroupType | Unset):
        id (UUID | Unset):
    ...
    default_user_type: TeamSchemaDefaultUserType | Unset = UNSET
    description: str | Unset = UNSET
    external_id: None | str | Unset = UNSET
    group_type: TeamSchemaGroupType | Unset = UNSET
    id: UUID | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_user_type, Unset):
            ...
            default_user_type = TeamSchemaDefaultUserType(_default_user_type)
        ...
        if isinstance(_group_type, Unset):
            ...
            group_type = TeamSchemaGroupType(_group_type)
        ...
        team_schema.additional_properties = d
        return team_schema
