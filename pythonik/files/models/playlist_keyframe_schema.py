...
T = TypeVar("T", bound="PlaylistKeyframeSchema")


@_attrs_define
class PlaylistKeyframeSchema:
    """
    Attributes:
        ...
        size (int | None | Unset):
        status (None | PlaylistKeyframeSchemaStatus | Unset):
    ...
    status: None | PlaylistKeyframeSchemaStatus | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, PlaylistKeyframeSchemaStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_status(data: object) -> None | PlaylistKeyframeSchemaStatus | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = PlaylistKeyframeSchemaStatus(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PlaylistKeyframeSchemaStatus | Unset, data)
        ...
        playlist_keyframe_schema.additional_properties = d
        return playlist_keyframe_schema
