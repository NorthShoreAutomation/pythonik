...
T = TypeVar("T", bound="StoragePrivateDataSchema")


@_attrs_define
class StoragePrivateDataSchema:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if bucket_location is not UNSET:
            field_dict["bucket_location"] = bucket_location
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        purpose = StoragePrivateDataSchemaPurpose(d.pop("purpose"))
        ...
        storage_private_data_schema.additional_properties = d
        return storage_private_data_schema
