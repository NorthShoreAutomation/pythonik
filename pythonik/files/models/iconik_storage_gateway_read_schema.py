...
class IconikStorageGatewayReadSchema:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.storages, Unset):
            storages = UNSET
        elif isinstance(self.storages, IconikStorageGatewayReadSchemaStoragesType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_roles(
            data: object,
        ) -> list[IconikStorageGatewayReadSchemaRolesType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for roles_type_0_item_data in _roles_type_0:
                    roles_type_0_item = IconikStorageGatewayReadSchemaRolesType0Item(
                ...
                pass
            return cast(
                list[IconikStorageGatewayReadSchemaRolesType0Item] | None | Unset, data
            )
        ...
        def _parse_storages(
            data: object,
        ) -> IconikStorageGatewayReadSchemaStoragesType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                storages_type_0 = IconikStorageGatewayReadSchemaStoragesType0.from_dict(
                    data
                )
                ...
                pass
            return cast(
                IconikStorageGatewayReadSchemaStoragesType0 | None | Unset, data
            )
