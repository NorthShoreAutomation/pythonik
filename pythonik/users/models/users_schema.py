...
if TYPE_CHECKING:
    from ..models.user_elastic_schema import UserElasticSchema
    from ..models.users_schema_facets_type_0 import UsersSchemaFacetsType0
...
class UsersSchema:
    """
    Attributes:
        facets (None | Unset | UsersSchemaFacetsType0):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[UserElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: None | Unset | UsersSchemaFacetsType0 = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[UserElasticSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, UsersSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(data: object) -> None | Unset | UsersSchemaFacetsType0:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = UsersSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UsersSchemaFacetsType0, data)
        ...
        def _parse_objects(data: object) -> list[UserElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = UserElasticSchema.from_dict(
                ...
                pass
            return cast(list[UserElasticSchema] | None | Unset, data)
