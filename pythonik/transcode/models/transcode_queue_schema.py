...
if TYPE_CHECKING:
    from ..models.transcode_queue_object_schema import TranscodeQueueObjectSchema
    from ..models.transcode_queue_schema_facets_type_0 import (
        TranscodeQueueSchemaFacetsType0,
    )


T = TypeVar("T", bound="TranscodeQueueSchema")


@_attrs_define
class TranscodeQueueSchema:
    """
    Attributes:
        facets (None | TranscodeQueueSchemaFacetsType0 | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[TranscodeQueueObjectSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: None | TranscodeQueueSchemaFacetsType0 | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[TranscodeQueueObjectSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, TranscodeQueueSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(
            data: object,
        ) -> None | TranscodeQueueSchemaFacetsType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = TranscodeQueueSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | TranscodeQueueSchemaFacetsType0 | Unset, data)
        ...
        def _parse_objects(
            data: object,
        ) -> list[TranscodeQueueObjectSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = TranscodeQueueObjectSchema.from_dict(
                ...
                pass
            return cast(list[TranscodeQueueObjectSchema] | None | Unset, data)
        ...
        transcode_queue_schema.additional_properties = d
        return transcode_queue_schema
