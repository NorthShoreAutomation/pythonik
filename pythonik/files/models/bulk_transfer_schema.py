...
from ..models.bulk_transfer_schema_object_type import BulkTransferSchemaObjectType
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkTransferSchema")


@_attrs_define
class BulkTransferSchema:
    """
    Attributes:
        object_ids (list[UUID]):
        object_type (BulkTransferSchemaObjectType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        object_type = BulkTransferSchemaObjectType(d.pop("object_type"))
        ...
        bulk_transfer_schema.additional_properties = d
        return bulk_transfer_schema
