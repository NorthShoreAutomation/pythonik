...
if TYPE_CHECKING:
    from ..models.recent_asset_elastic_schema import RecentAssetElasticSchema


T = TypeVar("T", bound="RecentAssetsSchema")


@_attrs_define
class RecentAssetsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[RecentAssetElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[RecentAssetElasticSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[RecentAssetElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = RecentAssetElasticSchema.from_dict(
                ...
                pass
            return cast(list[RecentAssetElasticSchema] | None | Unset, data)
        ...
        recent_assets_schema.additional_properties = d
        return recent_assets_schema
