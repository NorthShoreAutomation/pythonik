...
if TYPE_CHECKING:
    from ..models.playlist_keyframe_create_schema_upload_credentials import (
...
class PlaylistKeyframeCreateSchema:
    ...
    Attributes:
        ...
        size (int | None | Unset):
        status (PlaylistKeyframeCreateSchemaStatus | Unset):
        storage_id (UUID | Unset):
        time_code (TimeCodeType | Unset):
        upload_credentials (PlaylistKeyframeCreateSchemaUploadCredentials | Unset):
    ...
    status: PlaylistKeyframeCreateSchemaStatus | Unset = UNSET
    storage_id: UUID | Unset = UNSET
    time_code: TimeCodeType | Unset = UNSET
    upload_credentials: PlaylistKeyframeCreateSchemaUploadCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = PlaylistKeyframeCreateSchemaStatus(_status)
        ...
        if isinstance(_upload_credentials, Unset):
            ...
            upload_credentials = (
                PlaylistKeyframeCreateSchemaUploadCredentials.from_dict(
                    _upload_credentials
                )
            )
