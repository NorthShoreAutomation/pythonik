...
if TYPE_CHECKING:
    ...
    from ..models.person_list_schema_facets_type_0 import PersonListSchemaFacetsType0


T = TypeVar("T", bound="PersonListSchema")


@_attrs_define
class PersonListSchema:
    """
    Attributes:
        facets (None | PersonListSchemaFacetsType0 | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[Person] | None | Unset):
        page (int | None | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.person_list_schema_facets_type_0 import (
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, PersonListSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(data: object) -> None | PersonListSchemaFacetsType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = PersonListSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PersonListSchemaFacetsType0 | Unset, data)
        ...
        def _parse_objects(data: object) -> list[Person] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = Person.from_dict(objects_type_0_item_data)
                ...
                pass
            return cast(list[Person] | None | Unset, data)
        ...
        person_list_schema.additional_properties = d
        return person_list_schema
