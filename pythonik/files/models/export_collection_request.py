...
T = TypeVar("T", bound="ExportCollectionRequest")


@_attrs_define
class ExportCollectionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_collection_request.additional_properties = d
        return export_collection_request
