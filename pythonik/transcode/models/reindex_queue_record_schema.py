...
T = TypeVar("T", bound="ReindexQueueRecordSchema")


@_attrs_define
class ReindexQueueRecordSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_queue_record_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_queue_record_schema.additional_properties = d
        return reindex_queue_record_schema
