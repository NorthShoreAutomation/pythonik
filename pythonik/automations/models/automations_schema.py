...
T = TypeVar("T", bound="AutomationsSchema")


@_attrs_define
class AutomationsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[AutomationSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[AutomationSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[AutomationSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = AutomationSchema.from_dict(
                ...
                pass
            return cast(list[AutomationSchema] | None | Unset, data)
        ...
        automations_schema.additional_properties = d
        return automations_schema
