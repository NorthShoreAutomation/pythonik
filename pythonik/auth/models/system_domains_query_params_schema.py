...
T = TypeVar("T", bound="SystemDomainsQueryParamsSchema")


@_attrs_define
class SystemDomainsQueryParamsSchema:
    """
    Attributes:
        ...
        sort (None | str | Unset): A semicolon separated list of `field,order` pairs (name,asc;type,desc).
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        system_domains_query_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        system_domains_query_params_schema.additional_properties = d
        return system_domains_query_params_schema
