...
T = TypeVar("T", bound="UsersQueryParamsSchema")


@_attrs_define
class UsersQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_query_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        users_query_params_schema.additional_properties = d
        return users_query_params_schema
