...
T = TypeVar("T", bound="ResolutionTypeSchema")


@_attrs_define
class ResolutionTypeSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resolution_type_schema = cls(
            height=height,
            width=width,
        )

        resolution_type_schema.additional_properties = d
        return resolution_type_schema
