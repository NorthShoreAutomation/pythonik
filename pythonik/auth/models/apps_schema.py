...
class AppsSchema:
    ...
    Attributes:
        ...
        objects (list[AppSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[AppSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[AppSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = AppSchema.from_dict(objects_type_0_item_data)
                ...
                pass
            return cast(list[AppSchema] | None | Unset, data)
        ...
        apps_schema.additional_properties = d
        return apps_schema
