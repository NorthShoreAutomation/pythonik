...
class EmbeddingByFaceSchema:
    ...
    Attributes:
        ...
        type_ (EmbeddingByFaceSchemaType | None | Unset):
    """
    ...
    type_: EmbeddingByFaceSchemaType | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.type_, Unset):
            type_ = UNSET
        elif isinstance(self.type_, EmbeddingByFaceSchemaType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_type_(data: object) -> EmbeddingByFaceSchemaType | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                type_type_1 = EmbeddingByFaceSchemaType(data)

                return type_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EmbeddingByFaceSchemaType | None | Unset, data)
