...
from ...models.get_search_saved_by_search_id_response_default import (
...
def _get_kwargs(
    ...
    *,
    ...
    include_results: bool | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Any | GetSearchSavedBySearchIdResponseDefault | SavedSearchResultsSchema:
    ...
    response_default = GetSearchSavedBySearchIdResponseDefault.from_dict(
        response.json()
    )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | GetSearchSavedBySearchIdResponseDefault | SavedSearchResultsSchema]:
    return Response(
...
def sync(
    ...
    *,
    ...
    scroll_id: None | str | Unset = UNSET,
    search_after: GetSearchSavedBySearchIdSearchAfterType0 | None | Unset = UNSET,
) -> Any | GetSearchSavedBySearchIdResponseDefault | SavedSearchResultsSchema | None:
    """Returns results of saved search
