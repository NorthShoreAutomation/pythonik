...
T = TypeVar("T", bound="BulkMetadataDeleteSchema")


@_attrs_define
class BulkMetadataDeleteSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_metadata_delete_schema = cls(
            object_ids=object_ids,
        )

        bulk_metadata_delete_schema.additional_properties = d
        return bulk_metadata_delete_schema
