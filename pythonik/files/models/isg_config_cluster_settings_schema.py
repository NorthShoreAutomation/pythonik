...
T = TypeVar("T", bound="ISGConfigClusterSettingsSchema")


@_attrs_define
class ISGConfigClusterSettingsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        isg_config_cluster_settings_schema = cls(
        ...
        isg_config_cluster_settings_schema.additional_properties = d
        return isg_config_cluster_settings_schema
