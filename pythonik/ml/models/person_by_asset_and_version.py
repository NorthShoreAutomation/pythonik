...
from ..models.person_by_asset_and_version_status import PersonByAssetAndVersionStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="PersonByAssetAndVersion")


@_attrs_define
class PersonByAssetAndVersion:
    """
    Attributes:
        asset_id (UUID):
        ...
        status (PersonByAssetAndVersionStatus):
        version_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PersonByAssetAndVersionStatus(d.pop("status"))
        ...
        person_by_asset_and_version = cls(
            asset_id=asset_id,
            created_by_user=created_by_user,
            date_created=date_created,
            date_modified=date_modified,
        ...
        person_by_asset_and_version.additional_properties = d
        return person_by_asset_and_version
