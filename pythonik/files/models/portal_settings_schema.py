...
T = TypeVar("T", bound="PortalSettingsSchema")


@_attrs_define
class PortalSettingsSchema:
    """
    Attributes:
        delete (bool | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        portal_settings_schema.additional_properties = d
        return portal_settings_schema
