...
from ..models.jobs_bulk_edit_params_schema_status_type_0_item import (
    JobsBulkEditParamsSchemaStatusType0Item,
)
from ..models.jobs_bulk_edit_params_schema_type_type_0_item import (
    JobsBulkEditParamsSchemaTypeType0Item,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="JobsBulkEditParamsSchema")


@_attrs_define
class JobsBulkEditParamsSchema:
    """
    Attributes:
        ...
        merge_metadata (bool | None | Unset):
        metadata_automation_id (None | str | Unset):
        object_id (None | Unset | UUID):
        parent_id (None | Unset | UUID):
        query (None | str | Unset):
        status (list[JobsBulkEditParamsSchemaStatusType0Item] | None | Unset):
        type_ (list[JobsBulkEditParamsSchemaTypeType0Item] | None | Unset):
    """
    ...
    merge_metadata: bool | None | Unset = UNSET
    ...
    status: list[JobsBulkEditParamsSchemaStatusType0Item] | None | Unset = UNSET
    type_: list[JobsBulkEditParamsSchemaTypeType0Item] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        merge_metadata: bool | None | Unset
        if isinstance(self.merge_metadata, Unset):
            merge_metadata = UNSET
        else:
        ...
        if ids is not UNSET:
            field_dict["ids"] = ids
        if merge_metadata is not UNSET:
            field_dict["merge_metadata"] = merge_metadata
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_merge_metadata(data: object) -> bool | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        merge_metadata = _parse_merge_metadata(d.pop("merge_metadata", UNSET))
        ...
        def _parse_status(
            data: object,
        ) -> list[JobsBulkEditParamsSchemaStatusType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for status_type_0_item_data in _status_type_0:
                    status_type_0_item = JobsBulkEditParamsSchemaStatusType0Item(
                ...
                pass
            return cast(
                list[JobsBulkEditParamsSchemaStatusType0Item] | None | Unset, data
            )
        ...
        def _parse_type_(
            data: object,
        ) -> list[JobsBulkEditParamsSchemaTypeType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for type_type_0_item_data in _type_type_0:
                    type_type_0_item = JobsBulkEditParamsSchemaTypeType0Item(
                ...
                pass
            return cast(
                list[JobsBulkEditParamsSchemaTypeType0Item] | None | Unset, data
            )

        type_ = _parse_type_(d.pop("type", UNSET))

        jobs_bulk_edit_params_schema = cls(
        ...
        jobs_bulk_edit_params_schema.additional_properties = d
        return jobs_bulk_edit_params_schema
