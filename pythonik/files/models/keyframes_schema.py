...
T = TypeVar("T", bound="KeyframesSchema")


@_attrs_define
class KeyframesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[KeyframeSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[KeyframeSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[KeyframeSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = KeyframeSchema.from_dict(
                ...
                pass
            return cast(list[KeyframeSchema] | None | Unset, data)
        ...
        keyframes_schema.additional_properties = d
        return keyframes_schema
