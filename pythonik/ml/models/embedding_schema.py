...
class EmbeddingSchema:
    ...
    Attributes:
        ...
        status (EmbeddingSchemaStatus | Unset):
        system_domain_id (UUID | Unset):
        type_ (EmbeddingSchemaType | Unset):
    """
    ...
    status: EmbeddingSchemaStatus | Unset = UNSET
    system_domain_id: UUID | Unset = UNSET
    type_: EmbeddingSchemaType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = EmbeddingSchemaStatus(_status)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = EmbeddingSchemaType(_type_)
