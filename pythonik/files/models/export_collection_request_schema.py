...
T = TypeVar("T", bound="ExportCollectionRequestSchema")


@_attrs_define
class ExportCollectionRequestSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_collection_request_schema = cls(
            id=id,
        ...
        export_collection_request_schema.additional_properties = d
        return export_collection_request_schema
