...
T = TypeVar("T", bound="MetadataFieldCreateSchema")


@_attrs_define
class MetadataFieldCreateSchema:
    """
    Attributes:
        field_type (str):
        label (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metadata_field_create_schema = cls(
            field_type=field_type,
            label=label,
            name=name,
        ...
        metadata_field_create_schema.additional_properties = d
        return metadata_field_create_schema
