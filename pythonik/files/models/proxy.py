...
if TYPE_CHECKING:
    from ..models.proxy_upload_credentials import ProxyUploadCredentials
...
class Proxy:
    ...
    Attributes:
        ...
        status (ProxyStatus | Unset):
        storage_id (UUID | Unset):
        storage_method (str | Unset):
        upload_credentials (ProxyUploadCredentials | Unset):
    ...
    status: ProxyStatus | Unset = UNSET
    storage_id: UUID | Unset = UNSET
    storage_method: str | Unset = UNSET
    upload_credentials: ProxyUploadCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_upload_credentials, Unset):
            ...
            upload_credentials = ProxyUploadCredentials.from_dict(_upload_credentials)
