...
class ShareURLCreateSchema:
    ...
    Attributes:
        ...
        drm (ShareURLCreateSchemaDrm | Unset): DRM settings for the share
        ...
        watermark (ShareURLCreateSchemaWatermark | Unset): Watermark settings for the share
    """
    ...
    drm: ShareURLCreateSchemaDrm | Unset = UNSET
    ...
    watermark: ShareURLCreateSchemaWatermark | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        drm: ShareURLCreateSchemaDrm | Unset
        if isinstance(_drm, Unset):
            drm = UNSET
        else:
            drm = ShareURLCreateSchemaDrm(_drm)
        ...
        watermark: ShareURLCreateSchemaWatermark | Unset
        if isinstance(_watermark, Unset):
            watermark = UNSET
        else:
            watermark = ShareURLCreateSchemaWatermark(_watermark)
