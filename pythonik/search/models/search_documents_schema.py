...
if TYPE_CHECKING:
    from ..models.search_document_schema import SearchDocumentSchema
    from ..models.search_documents_schema_facets_type_0 import (
        SearchDocumentsSchemaFacetsType0,
    )


T = TypeVar("T", bound="SearchDocumentsSchema")


@_attrs_define
class SearchDocumentsSchema:
    """
    Attributes:
        facets (None | SearchDocumentsSchemaFacetsType0 | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[SearchDocumentSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: None | SearchDocumentsSchemaFacetsType0 | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[SearchDocumentSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, SearchDocumentsSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(
            data: object,
        ) -> None | SearchDocumentsSchemaFacetsType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = SearchDocumentsSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SearchDocumentsSchemaFacetsType0 | Unset, data)
        ...
        def _parse_objects(data: object) -> list[SearchDocumentSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = SearchDocumentSchema.from_dict(
                ...
                pass
            return cast(list[SearchDocumentSchema] | None | Unset, data)
        ...
        search_documents_schema.additional_properties = d
        return search_documents_schema
