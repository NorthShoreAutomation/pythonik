...
T = TypeVar("T", bound="IconikStorageGatewayClustersSchema")


@_attrs_define
class IconikStorageGatewayClustersSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[IconikStorageGatewayClusterReadSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[IconikStorageGatewayClusterReadSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[IconikStorageGatewayClusterReadSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = (
                        IconikStorageGatewayClusterReadSchema.from_dict(
                ...
                pass
            return cast(
                list[IconikStorageGatewayClusterReadSchema] | None | Unset, data
            )
        ...
        iconik_storage_gateway_clusters_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        iconik_storage_gateway_clusters_schema.additional_properties = d
        return iconik_storage_gateway_clusters_schema
