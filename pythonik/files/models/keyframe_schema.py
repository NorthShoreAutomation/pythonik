...
if TYPE_CHECKING:
    from ..models.keyframe_schema_upload_credentials import (
...
class KeyframeSchema:
    ...
    Attributes:
        ...
        size (int | None | Unset):
        status (KeyframeSchemaStatus | Unset):
        storage_id (UUID | Unset):
        storage_method (str | Unset):
        time_code (TimeCodeType | Unset):
        upload_credentials (KeyframeSchemaUploadCredentials | Unset):
    ...
    status: KeyframeSchemaStatus | Unset = UNSET
    storage_id: UUID | Unset = UNSET
    storage_method: str | Unset = UNSET
    time_code: TimeCodeType | Unset = UNSET
    upload_credentials: KeyframeSchemaUploadCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = KeyframeSchemaStatus(_status)
        ...
        if isinstance(_upload_credentials, Unset):
            ...
            upload_credentials = KeyframeSchemaUploadCredentials.from_dict(
                _upload_credentials
            )
