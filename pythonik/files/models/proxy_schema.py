...
if TYPE_CHECKING:
    from ..models.proxy_schema_upload_credentials import ProxySchemaUploadCredentials
...
class ProxySchema:
    ...
    Attributes:
        ...
        status (ProxySchemaStatus | Unset):
        storage_id (UUID | Unset):
        storage_method (str | Unset):
        upload_credentials (ProxySchemaUploadCredentials | Unset):
    ...
    status: ProxySchemaStatus | Unset = UNSET
    storage_id: UUID | Unset = UNSET
    storage_method: str | Unset = UNSET
    upload_credentials: ProxySchemaUploadCredentials | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.proxy_schema_upload_credentials import (
        ...
        if isinstance(_status, Unset):
            ...
            status = ProxySchemaStatus(_status)
        ...
        if isinstance(_upload_credentials, Unset):
            ...
            upload_credentials = ProxySchemaUploadCredentials.from_dict(
                _upload_credentials
            )
