...
if TYPE_CHECKING:
    from ..models.automation_run_schema import AutomationRunSchema


T = TypeVar("T", bound="AutomationRunsSchema")


@_attrs_define
class AutomationRunsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[AutomationRunSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[AutomationRunSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[AutomationRunSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = AutomationRunSchema.from_dict(
                ...
                pass
            return cast(list[AutomationRunSchema] | None | Unset, data)
        ...
        automation_runs_schema.additional_properties = d
        return automation_runs_schema
