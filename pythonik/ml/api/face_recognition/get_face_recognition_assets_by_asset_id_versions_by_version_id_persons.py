...
def _get_kwargs(
    ...
    *,
    ...
    params["fetch_image_url"] = fetch_image_url

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/face_recognition/assets/{asset_id}/versions/{version_id}/persons/".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = PersonByAssetAndVersionListSchema.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    kwargs = _get_kwargs(
        ...
        fetch_image_url=fetch_image_url,
    )
