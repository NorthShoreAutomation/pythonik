...
T = TypeVar("T", bound="ActionContextValue")


@_attrs_define
class ActionContextValue:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        action_context_value = cls(
            bulk=bulk,
            url=url,
        )

        action_context_value.additional_properties = d
        return action_context_value
