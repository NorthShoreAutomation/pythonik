...
class SegmentBaseSchema:
    ...
    Attributes:
        ...
        metadata (None | SegmentBaseSchemaMetadataType0 | Unset):
    ...
    metadata: None | SegmentBaseSchemaMetadataType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, SegmentBaseSchemaMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(
            data: object,
        ) -> None | SegmentBaseSchemaMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = SegmentBaseSchemaMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SegmentBaseSchemaMetadataType0 | Unset, data)
