...
T = TypeVar("T", bound="CreateShareActionParametersSchema")


@_attrs_define
class CreateShareActionParametersSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_share_action_parameters_schema = cls(
            allow_approving_comments=allow_approving_comments,
            allow_comments=allow_comments,
            allow_download=allow_download,
            allow_setting_approve_status=allow_setting_approve_status,
        ...
        create_share_action_parameters_schema.additional_properties = d
        return create_share_action_parameters_schema
