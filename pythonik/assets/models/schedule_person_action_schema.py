...
T = TypeVar("T", bound="SchedulePersonActionSchema")


@_attrs_define
class SchedulePersonActionSchema:
    """
    Attributes:
        job_id (UUID):
        queue_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schedule_person_action_schema = cls(
            job_id=job_id,
            queue_name=queue_name,
            new_person_id=new_person_id,
        )

        schedule_person_action_schema.additional_properties = d
        return schedule_person_action_schema
