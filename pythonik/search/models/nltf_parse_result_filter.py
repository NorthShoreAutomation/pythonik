...
T = TypeVar("T", bound="NltfParseResultFilter")


@_attrs_define
class NltfParseResultFilter:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nltf_parse_result_filter.additional_properties = additional_properties
        return nltf_parse_result_filter
