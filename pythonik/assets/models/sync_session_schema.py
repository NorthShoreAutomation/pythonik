...
T = TypeVar("T", bound="SyncSessionSchema")


@_attrs_define
class SyncSessionSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sync_session_schema.additional_properties = d
        return sync_session_schema
