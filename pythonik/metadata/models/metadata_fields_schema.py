...
T = TypeVar("T", bound="MetadataFieldsSchema")


@_attrs_define
class MetadataFieldsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[MetadataFieldSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[MetadataFieldSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[MetadataFieldSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = MetadataFieldSchema.from_dict(
                ...
                pass
            return cast(list[MetadataFieldSchema] | None | Unset, data)
        ...
        metadata_fields_schema.additional_properties = d
        return metadata_fields_schema
