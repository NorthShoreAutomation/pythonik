...
class RoleGroupSchema:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.role_categories, RoleCategoriesSchema):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_role_categories(data: object) -> None | RoleCategoriesSchema | Unset:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                role_categories_type_1 = RoleCategoriesSchema.from_dict(data)

                return role_categories_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | RoleCategoriesSchema | Unset, data)
        ...
        role_group_schema.additional_properties = d
        return role_group_schema
