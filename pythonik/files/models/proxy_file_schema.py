...
class ProxyFileSchema:
    ...
    Attributes:
        ...
        size (int | None | Unset):
        status (None | ProxyFileSchemaStatus | Unset):
        storage_id (None | Unset | UUID):
        template (None | str | Unset):
        template_engine (None | ProxyFileSchemaTemplateEngine | Unset):
    ...
    status: None | ProxyFileSchemaStatus | Unset = UNSET
    storage_id: None | Unset | UUID = UNSET
    template: None | str | Unset = UNSET
    template_engine: None | ProxyFileSchemaTemplateEngine | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, ProxyFileSchemaStatus):
        ...
        elif isinstance(self.template_engine, ProxyFileSchemaTemplateEngine):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_status(data: object) -> None | ProxyFileSchemaStatus | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = ProxyFileSchemaStatus(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProxyFileSchemaStatus | Unset, data)
        ...
        def _parse_template_engine(
            data: object,
        ) -> None | ProxyFileSchemaTemplateEngine | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                template_engine_type_1 = ProxyFileSchemaTemplateEngine(data)

                return template_engine_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProxyFileSchemaTemplateEngine | Unset, data)
