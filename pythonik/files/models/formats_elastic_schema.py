...
if TYPE_CHECKING:
    from ..models.format_elastic_schema import FormatElasticSchema
    from ..models.formats_elastic_schema_facets_type_0 import (
        FormatsElasticSchemaFacetsType0,
    )


T = TypeVar("T", bound="FormatsElasticSchema")


@_attrs_define
class FormatsElasticSchema:
    """
    Attributes:
        facets (FormatsElasticSchemaFacetsType0 | None | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[FormatElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: FormatsElasticSchemaFacetsType0 | None | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[FormatElasticSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, FormatsElasticSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(
            data: object,
        ) -> FormatsElasticSchemaFacetsType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = FormatsElasticSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(FormatsElasticSchemaFacetsType0 | None | Unset, data)
        ...
        def _parse_objects(data: object) -> list[FormatElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = FormatElasticSchema.from_dict(
                ...
                pass
            return cast(list[FormatElasticSchema] | None | Unset, data)
        ...
        formats_elastic_schema.additional_properties = d
        return formats_elastic_schema
