...
if TYPE_CHECKING:
    from ..models.bulk_collection_face_extraction_schema_callback_data_request_type_0 import (
        BulkCollectionFaceExtractionSchemaCallbackDataRequestType0,
    )
    from ..models.bulk_collection_face_extraction_schema_callback_data_type_0 import (
        BulkCollectionFaceExtractionSchemaCallbackDataType0,
    )


T = TypeVar("T", bound="BulkCollectionFaceExtractionSchema")


@_attrs_define
class BulkCollectionFaceExtractionSchema:
    """
    Attributes:
        ...
        callback_data (BulkCollectionFaceExtractionSchemaCallbackDataType0 | None | Unset):
        callback_data_request (BulkCollectionFaceExtractionSchemaCallbackDataRequestType0 | None | Unset):
    ...
    callback_data: (
        BulkCollectionFaceExtractionSchemaCallbackDataType0 | None | Unset
    ) = UNSET
    callback_data_request: (
        BulkCollectionFaceExtractionSchemaCallbackDataRequestType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.callback_data, Unset):
            ...
            self.callback_data, BulkCollectionFaceExtractionSchemaCallbackDataType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_callback_data(
            ...
            try:
                ...
                callback_data_type_0 = (
                    BulkCollectionFaceExtractionSchemaCallbackDataType0.from_dict(data)
                )
                ...
                pass
            return cast(
                BulkCollectionFaceExtractionSchemaCallbackDataType0 | None | Unset, data
            )
        ...
        def _parse_callback_data_request(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                callback_data_request_type_0 = BulkCollectionFaceExtractionSchemaCallbackDataRequestType0.from_dict(
                    data
                )
        ...
        bulk_collection_face_extraction_schema = cls(
            collection_ids=collection_ids,
            include_assets=include_assets,
            include_collections=include_collections,
            job_id=job_id,
        ...
        bulk_collection_face_extraction_schema.additional_properties = d
        return bulk_collection_face_extraction_schema
