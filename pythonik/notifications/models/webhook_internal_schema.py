...
from ..models.webhook_internal_schema_status import WebhookInternalSchemaStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="WebhookInternalSchema")


@_attrs_define
class WebhookInternalSchema:
    """
    Attributes:
        event_type (str): Type of events. Example assets, collections Example: assets.
        id (UUID):
        status (WebhookInternalSchemaStatus):  Example: ENABLED.
    ...
    event_type: str
    id: UUID
    status: WebhookInternalSchemaStatus
    url: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = WebhookInternalSchemaStatus(d.pop("status"))
        ...
        def _parse_headers(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        webhook_internal_schema.additional_properties = d
        return webhook_internal_schema
