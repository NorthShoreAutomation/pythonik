...
from ..models.reindex_bulk_action_schema_object_type import (
    ReindexBulkActionSchemaObjectType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReindexBulkActionSchema")


@_attrs_define
class ReindexBulkActionSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_bulk_action_schema.additional_properties = d
        return reindex_bulk_action_schema
