...
if TYPE_CHECKING:
    ...
    from ..models.export_locations_schema_facets_type_0 import (
        ExportLocationsSchemaFacetsType0,
    )


T = TypeVar("T", bound="ExportLocationsSchema")


@_attrs_define
class ExportLocationsSchema:
    """
    Attributes:
        facets (ExportLocationsSchemaFacetsType0 | None | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[ExportLocationSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: ExportLocationsSchemaFacetsType0 | None | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[ExportLocationSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, ExportLocationsSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(
            data: object,
        ) -> ExportLocationsSchemaFacetsType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = ExportLocationsSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ExportLocationsSchemaFacetsType0 | None | Unset, data)
        ...
        def _parse_objects(data: object) -> list[ExportLocationSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = ExportLocationSchema.from_dict(
                ...
                pass
            return cast(list[ExportLocationSchema] | None | Unset, data)
        ...
        export_locations_schema.additional_properties = d
        return export_locations_schema
