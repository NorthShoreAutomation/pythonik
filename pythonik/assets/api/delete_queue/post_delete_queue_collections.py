...
from ...models.post_delete_queue_collections_response_default import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    response_default = PostDeleteQueueCollectionsResponseDefault.from_dict(
        response.json()
    )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | PostDeleteQueueCollectionsResponseDefault]:
    return Response(
...
def sync(
    *,
    client: AuthenticatedClient | Client,
    body: DeleteQueueSchema,
) -> Any | PostDeleteQueueCollectionsResponseDefault | None:
    """Add collections to a delete queue (Mark collections as deleted)
