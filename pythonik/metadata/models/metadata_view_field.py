...
T = TypeVar("T", bound="MetadataViewField")


@_attrs_define
class MetadataViewField:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        metadata_view_field.additional_properties = d
        return metadata_view_field
