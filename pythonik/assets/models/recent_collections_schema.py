...
if TYPE_CHECKING:
    from ..models.recent_collection_elastic_schema import RecentCollectionElasticSchema


T = TypeVar("T", bound="RecentCollectionsSchema")


@_attrs_define
class RecentCollectionsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[RecentCollectionElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[RecentCollectionElasticSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.recent_collection_elastic_schema import (
        ...
        def _parse_objects(
            data: object,
        ) -> list[RecentCollectionElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = RecentCollectionElasticSchema.from_dict(
                ...
                pass
            return cast(list[RecentCollectionElasticSchema] | None | Unset, data)
        ...
        recent_collections_schema.additional_properties = d
        return recent_collections_schema
