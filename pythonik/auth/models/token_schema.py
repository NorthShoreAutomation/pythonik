...
class TokenSchema:
    ...
    Attributes:
        ...
        system_domain_status (TokenSchemaSystemDomainStatus | Unset):
    ...
    system_domain_status: TokenSchemaSystemDomainStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_system_domain_status, Unset):
            ...
            system_domain_status = TokenSchemaSystemDomainStatus(_system_domain_status)
