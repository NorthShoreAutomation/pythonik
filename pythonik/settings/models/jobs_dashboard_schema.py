...
T = TypeVar("T", bound="JobsDashboardSchema")


@_attrs_define
class JobsDashboardSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobs_dashboard_schema = cls(
            widgets=widgets,
        )

        jobs_dashboard_schema.additional_properties = d
        return jobs_dashboard_schema
