...
T = TypeVar("T", bound="ReindexPortfolioSchema")


@_attrs_define
class ReindexPortfolioSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_portfolio_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_portfolio_schema.additional_properties = d
        return reindex_portfolio_schema
