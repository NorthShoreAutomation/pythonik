...
T = TypeVar("T", bound="NotificationSettingsSchema")
...
class NotificationSettingsSchema:
    ...
    Attributes:
        ...
        objects (list[NotificationSettingSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[NotificationSettingSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[NotificationSettingSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = NotificationSettingSchema.from_dict(
                ...
                pass
            return cast(list[NotificationSettingSchema] | None | Unset, data)
        ...
        notification_settings_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        notification_settings_schema.additional_properties = d
        return notification_settings_schema
