...
if TYPE_CHECKING:
    from ..models.restore_collection_to_storage_request import (
        RestoreCollectionToStorageRequest,
    )


T = TypeVar("T", bound="BulkRestoreCollectionRequestSchema")


@_attrs_define
class BulkRestoreCollectionRequestSchema:
    """
    Attributes:
        destination_storage_id (None | Unset | UUID): ID of the storage to restore the saved searches to.
        objects (list[RestoreCollectionToStorageRequest] | None | Unset): List of collections to restore. Each
            collection should contain the collection ID.
    """

    destination_storage_id: None | Unset | UUID = UNSET
    objects: list[RestoreCollectionToStorageRequest] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[RestoreCollectionToStorageRequest] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = RestoreCollectionToStorageRequest.from_dict(
                ...
                pass
            return cast(list[RestoreCollectionToStorageRequest] | None | Unset, data)

        objects = _parse_objects(d.pop("objects", UNSET))

        bulk_restore_collection_request_schema = cls(
            destination_storage_id=destination_storage_id,
            objects=objects,
        )

        bulk_restore_collection_request_schema.additional_properties = d
        return bulk_restore_collection_request_schema
