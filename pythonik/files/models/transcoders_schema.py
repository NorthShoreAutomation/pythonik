...
if TYPE_CHECKING:
    from ..models.transcoder_read_schema import TranscoderReadSchema
    from ..models.transcoders_schema_facets_type_0 import TranscodersSchemaFacetsType0
...
class TranscodersSchema:
    """
    Attributes:
        facets (None | TranscodersSchemaFacetsType0 | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[TranscoderReadSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: None | TranscodersSchemaFacetsType0 | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[TranscoderReadSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.transcoders_schema_facets_type_0 import (
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, TranscodersSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(data: object) -> None | TranscodersSchemaFacetsType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = TranscodersSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | TranscodersSchemaFacetsType0 | Unset, data)
        ...
        def _parse_objects(data: object) -> list[TranscoderReadSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = TranscoderReadSchema.from_dict(
                ...
                pass
            return cast(list[TranscoderReadSchema] | None | Unset, data)
