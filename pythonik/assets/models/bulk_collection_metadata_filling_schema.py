...
if TYPE_CHECKING:
    from ..models.bulk_collection_metadata_filling_schema_callback_data_request_type_0 import (
        BulkCollectionMetadataFillingSchemaCallbackDataRequestType0,
    )
    from ..models.bulk_collection_metadata_filling_schema_callback_data_type_0 import (
        BulkCollectionMetadataFillingSchemaCallbackDataType0,
    )


T = TypeVar("T", bound="BulkCollectionMetadataFillingSchema")


@_attrs_define
class BulkCollectionMetadataFillingSchema:
    """
    Attributes:
        ...
        callback_data (BulkCollectionMetadataFillingSchemaCallbackDataType0 | None | Unset):
        callback_data_request (BulkCollectionMetadataFillingSchemaCallbackDataRequestType0 | None | Unset):
    ...
    callback_data: (
        BulkCollectionMetadataFillingSchemaCallbackDataType0 | None | Unset
    ) = UNSET
    callback_data_request: (
        BulkCollectionMetadataFillingSchemaCallbackDataRequestType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.callback_data, Unset):
            ...
            self.callback_data, BulkCollectionMetadataFillingSchemaCallbackDataType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_callback_data(
            ...
            try:
                ...
                callback_data_type_0 = (
                    BulkCollectionMetadataFillingSchemaCallbackDataType0.from_dict(data)
                )
        ...
        def _parse_callback_data_request(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                callback_data_request_type_0 = BulkCollectionMetadataFillingSchemaCallbackDataRequestType0.from_dict(
                    data
                )
        ...
        bulk_collection_metadata_filling_schema = cls(
            collection_ids=collection_ids,
            include_assets=include_assets,
            include_collections=include_collections,
            job_id=job_id,
        ...
        bulk_collection_metadata_filling_schema.additional_properties = d
        return bulk_collection_metadata_filling_schema
