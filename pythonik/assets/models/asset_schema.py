...
class AssetSchema:
    ...
    Attributes:
        title (str):
        analyze_status (AssetSchemaAnalyzeStatus | Unset):
        archive_status (AssetSchemaArchiveStatus | Unset):
        ...
        face_recognition_status (AssetSchemaFaceRecognitionStatus | Unset):
        favoured (bool | Unset):
    ...
    title: str
    analyze_status: AssetSchemaAnalyzeStatus | Unset = UNSET
    archive_status: AssetSchemaArchiveStatus | Unset = UNSET
    ...
    face_recognition_status: AssetSchemaFaceRecognitionStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_analyze_status, Unset):
            ...
            analyze_status = AssetSchemaAnalyzeStatus(_analyze_status)
        ...
        if isinstance(_archive_status, Unset):
            ...
            archive_status = AssetSchemaArchiveStatus(_archive_status)
        ...
        if isinstance(_face_recognition_status, Unset):
            ...
            face_recognition_status = AssetSchemaFaceRecognitionStatus(
        ...
        if isinstance(_status, Unset):
            ...
            status = AssetSchemaStatus(_status)
