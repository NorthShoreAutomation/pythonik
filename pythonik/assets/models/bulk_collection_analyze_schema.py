...
if TYPE_CHECKING:
    from ..models.bulk_collection_analyze_schema_callback_data_request_type_0 import (
        BulkCollectionAnalyzeSchemaCallbackDataRequestType0,
    )
    from ..models.bulk_collection_analyze_schema_callback_data_type_0 import (
        BulkCollectionAnalyzeSchemaCallbackDataType0,
    )


T = TypeVar("T", bound="BulkCollectionAnalyzeSchema")


@_attrs_define
class BulkCollectionAnalyzeSchema:
    """
    Attributes:
        ...
        callback_data (BulkCollectionAnalyzeSchemaCallbackDataType0 | None | Unset):
        callback_data_request (BulkCollectionAnalyzeSchemaCallbackDataRequestType0 | None | Unset):
    ...
    callback_data: BulkCollectionAnalyzeSchemaCallbackDataType0 | None | Unset = UNSET
    callback_data_request: (
        BulkCollectionAnalyzeSchemaCallbackDataRequestType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.callback_data, Unset):
            ...
            self.callback_data, BulkCollectionAnalyzeSchemaCallbackDataType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_callback_data(
            data: object,
        ) -> BulkCollectionAnalyzeSchemaCallbackDataType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                callback_data_type_0 = (
                    BulkCollectionAnalyzeSchemaCallbackDataType0.from_dict(data)
                )
                ...
                pass
            return cast(
                BulkCollectionAnalyzeSchemaCallbackDataType0 | None | Unset, data
            )
        ...
        def _parse_callback_data_request(
            ...
            try:
                ...
                callback_data_request_type_0 = (
                    BulkCollectionAnalyzeSchemaCallbackDataRequestType0.from_dict(data)
                )
                ...
                pass
            return cast(
                BulkCollectionAnalyzeSchemaCallbackDataRequestType0 | None | Unset, data
            )
        ...
        bulk_collection_analyze_schema = cls(
            collection_ids=collection_ids,
            include_assets=include_assets,
            include_collections=include_collections,
            job_id=job_id,
        ...
        bulk_collection_analyze_schema.additional_properties = d
        return bulk_collection_analyze_schema
