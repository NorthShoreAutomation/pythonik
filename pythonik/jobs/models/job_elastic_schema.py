...
if TYPE_CHECKING:
    ...
    from ..models.job_elastic_schema_children_progress import (
        JobElasticSchemaChildrenProgress,
    )
    from ..models.job_elastic_schema_job_context import JobElasticSchemaJobContext
    from ..models.job_elastic_schema_metadata import JobElasticSchemaMetadata
...
class JobElasticSchema:
    ...
    Attributes:
        ...
        children_progress (JobElasticSchemaChildrenProgress | Unset):
        ...
        id (UUID | Unset):
        job_context (JobElasticSchemaJobContext | Unset):
        message (str | Unset):
        metadata (JobElasticSchemaMetadata | Unset):
        ...
        steps (list[JobStepElastic] | Unset):
    ...
    children_progress: JobElasticSchemaChildrenProgress | Unset = UNSET
    ...
    id: UUID | Unset = UNSET
    job_context: JobElasticSchemaJobContext | Unset = UNSET
    message: str | Unset = UNSET
    metadata: JobElasticSchemaMetadata | Unset = UNSET
    ...
    steps: list[JobStepElastic] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_children_progress, Unset):
            ...
            children_progress = JobElasticSchemaChildrenProgress.from_dict(
                _children_progress
            )
        ...
        if isinstance(_job_context, Unset):
            ...
            job_context = JobElasticSchemaJobContext.from_dict(_job_context)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = JobElasticSchemaMetadata.from_dict(_metadata)
        ...
        if _steps is not UNSET:
            ...
            for steps_item_data in _steps:
                steps_item = JobStepElastic.from_dict(steps_item_data)
