...
T = TypeVar("T", bound="SavedSearchSchema")


@_attrs_define
class SavedSearchSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        saved_search_schema.additional_properties = d
        return saved_search_schema
