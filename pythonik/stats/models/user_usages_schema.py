...
if TYPE_CHECKING:
    from ..models.user_usages_elastic_schema import UserUsagesElasticSchema


T = TypeVar("T", bound="UserUsagesSchema")


@_attrs_define
class UserUsagesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[UserUsagesElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[UserUsagesElasticSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[UserUsagesElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = UserUsagesElasticSchema.from_dict(
                ...
                pass
            return cast(list[UserUsagesElasticSchema] | None | Unset, data)
        ...
        user_usages_schema.additional_properties = d
        return user_usages_schema
