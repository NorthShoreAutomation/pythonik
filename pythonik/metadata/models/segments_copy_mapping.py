...
T = TypeVar("T", bound="SegmentsCopyMapping")


@_attrs_define
class SegmentsCopyMapping:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        segments_copy_mapping.additional_properties = d
        return segments_copy_mapping
