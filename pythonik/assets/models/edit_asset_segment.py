...
class EditAssetSegment:
    ...
    Attributes:
        ...
        metadata (EditAssetSegmentMetadataType0 | None | Unset):
    ...
    metadata: EditAssetSegmentMetadataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, EditAssetSegmentMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(
            data: object,
        ) -> EditAssetSegmentMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = EditAssetSegmentMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EditAssetSegmentMetadataType0 | None | Unset, data)
