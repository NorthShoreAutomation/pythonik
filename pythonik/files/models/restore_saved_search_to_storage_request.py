...
T = TypeVar("T", bound="RestoreSavedSearchToStorageRequest")


@_attrs_define
class RestoreSavedSearchToStorageRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restore_saved_search_to_storage_request = cls(
            id=id,
        ...
        restore_saved_search_to_storage_request.additional_properties = d
        return restore_saved_search_to_storage_request
