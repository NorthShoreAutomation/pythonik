...
T = TypeVar("T", bound="RelationTypesSchema")


@_attrs_define
class RelationTypesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[RelationTypeSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[RelationTypeSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[RelationTypeSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = RelationTypeSchema.from_dict(
                ...
                pass
            return cast(list[RelationTypeSchema] | None | Unset, data)
        ...
        relation_types_schema.additional_properties = d
        return relation_types_schema
