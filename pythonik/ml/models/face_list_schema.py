...
T = TypeVar("T", bound="FaceListSchema")


@_attrs_define
class FaceListSchema:
    """
    Attributes:
        objects (list[Face] | None | Unset):
    """

    objects: list[Face] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[Face] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = Face.from_dict(objects_type_0_item_data)
                ...
                pass
            return cast(list[Face] | None | Unset, data)

        objects = _parse_objects(d.pop("objects", UNSET))

        face_list_schema = cls(
            objects=objects,
        )

        face_list_schema.additional_properties = d
        return face_list_schema
