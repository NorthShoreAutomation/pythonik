...
if TYPE_CHECKING:
    from ..models.job_elastic_schema import JobElasticSchema
    from ..models.jobs_schema_facets_type_0 import JobsSchemaFacetsType0


T = TypeVar("T", bound="JobsSchema")
...
class JobsSchema:
    """
    Attributes:
        facets (JobsSchemaFacetsType0 | None | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[JobElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: JobsSchemaFacetsType0 | None | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[JobElasticSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, JobsSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(data: object) -> JobsSchemaFacetsType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = JobsSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(JobsSchemaFacetsType0 | None | Unset, data)
        ...
        def _parse_objects(data: object) -> list[JobElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = JobElasticSchema.from_dict(
                ...
                pass
            return cast(list[JobElasticSchema] | None | Unset, data)
        ...
        jobs_schema.additional_properties = d
        return jobs_schema
