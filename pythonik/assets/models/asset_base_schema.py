...
class AssetBaseSchema:
    ...
    Attributes:
        title (str):
        analyze_status (AssetBaseSchemaAnalyzeStatus | Unset):
        archive_status (AssetBaseSchemaArchiveStatus | Unset):
        ...
        face_recognition_status (AssetBaseSchemaFaceRecognitionStatus | Unset):
        favoured (bool | Unset):
        ...
        status (AssetBaseSchemaStatus | Unset):
        time_end_milliseconds (int | Unset):
        time_start_milliseconds (int | Unset):
        type_ (AssetBaseSchemaType | Unset):
    ...
    title: str
    analyze_status: AssetBaseSchemaAnalyzeStatus | Unset = UNSET
    archive_status: AssetBaseSchemaArchiveStatus | Unset = UNSET
    ...
    face_recognition_status: AssetBaseSchemaFaceRecognitionStatus | Unset = UNSET
    ...
    status: AssetBaseSchemaStatus | Unset = UNSET
    time_end_milliseconds: int | Unset = UNSET
    time_start_milliseconds: int | Unset = UNSET
    type_: AssetBaseSchemaType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_analyze_status, Unset):
            ...
            analyze_status = AssetBaseSchemaAnalyzeStatus(_analyze_status)
        ...
        if isinstance(_archive_status, Unset):
            ...
            archive_status = AssetBaseSchemaArchiveStatus(_archive_status)
        ...
        if isinstance(_face_recognition_status, Unset):
            ...
            face_recognition_status = AssetBaseSchemaFaceRecognitionStatus(
        ...
        if isinstance(_status, Unset):
            ...
            status = AssetBaseSchemaStatus(_status)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = AssetBaseSchemaType(_type_)
