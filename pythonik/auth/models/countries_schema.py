...
T = TypeVar("T", bound="CountriesSchema")
...
class CountriesSchema:
    ...
    Attributes:
        ...
        objects (list[Country] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[Country] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[Country] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = Country.from_dict(objects_type_0_item_data)
        ...
        countries_schema.additional_properties = d
