...
class UserEditInternalSchema:
    ...
    Attributes:
        ...
        metadata (Any | Unset):
        onboarding_goal (UserEditInternalSchemaOnboardingGoal | Unset):
        password (str | Unset):
        ...
        status (UserEditInternalSchemaStatus | Unset):
    ...
    onboarding_goal: UserEditInternalSchemaOnboardingGoal | Unset = UNSET
    ...
    status: UserEditInternalSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_onboarding_goal, Unset):
            ...
            onboarding_goal = UserEditInternalSchemaOnboardingGoal(_onboarding_goal)
        ...
        if isinstance(_status, Unset):
            ...
            status = UserEditInternalSchemaStatus(_status)
