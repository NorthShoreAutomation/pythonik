...
T = TypeVar("T", bound="AnalysisProfileRevAISettingsSchema")


@_attrs_define
class AnalysisProfileRevAISettingsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        analysis_profile_rev_ai_settings_schema = cls(
            is_system=is_system,
            min_confidence=min_confidence,
        )

        analysis_profile_rev_ai_settings_schema.additional_properties = d
        return analysis_profile_rev_ai_settings_schema
