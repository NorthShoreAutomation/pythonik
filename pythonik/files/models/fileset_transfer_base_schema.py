...
if TYPE_CHECKING:
    from ..models.fileset_transfer_base_schema_job_steps import (
...
class FilesetTransferBaseSchema:
    ...
    Attributes:
        ...
        id (UUID | Unset):
        job_id (UUID | Unset):
        job_steps (FilesetTransferBaseSchemaJobSteps | Unset):
    ...
    job_steps: FilesetTransferBaseSchemaJobSteps | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_job_steps, Unset):
            ...
            job_steps = FilesetTransferBaseSchemaJobSteps.from_dict(_job_steps)
