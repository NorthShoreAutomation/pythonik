...
T = TypeVar("T", bound="JobStepsSchema")


@_attrs_define
class JobStepsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[JobStepSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[JobStepSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[JobStepSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = JobStepSchema.from_dict(
        ...
        job_steps_schema.additional_properties = d
        return job_steps_schema
