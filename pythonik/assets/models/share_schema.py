...
class ShareSchema:
    ...
    Attributes:
        ...
        drm (ShareSchemaDrm | Unset): DRM settings for the share
        ...
        owner_id (str | Unset):
        population_status (ShareSchemaPopulationStatus | Unset):
        ...
        url (None | str | Unset):
        watermark (ShareSchemaWatermark | Unset): Watermark settings for the share
    """
    ...
    drm: ShareSchemaDrm | Unset = UNSET
    ...
    population_status: ShareSchemaPopulationStatus | Unset = UNSET
    ...
    watermark: ShareSchemaWatermark | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        drm: ShareSchemaDrm | Unset
        if isinstance(_drm, Unset):
            drm = UNSET
        else:
            drm = ShareSchemaDrm(_drm)
        ...
        if isinstance(_population_status, Unset):
            ...
            population_status = ShareSchemaPopulationStatus(_population_status)
        ...
        watermark: ShareSchemaWatermark | Unset
        if isinstance(_watermark, Unset):
            watermark = UNSET
        else:
            watermark = ShareSchemaWatermark(_watermark)
        ...
        share_schema.additional_properties = d
        return share_schema
