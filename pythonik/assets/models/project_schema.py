...
if TYPE_CHECKING:
    from ..models.project_schema_status_type_1 import ProjectSchemaStatusType1
...
class ProjectSchema:
    ...
    Attributes:
        ...
        id (None | Unset | UUID):
        status (None | ProjectSchemaStatusType1 | Unset):
    ...
    status: None | ProjectSchemaStatusType1 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, ProjectSchemaStatusType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_status(data: object) -> None | ProjectSchemaStatusType1 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                status_type_1 = ProjectSchemaStatusType1.from_dict(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ProjectSchemaStatusType1 | Unset, data)
