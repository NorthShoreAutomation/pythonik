...
from ...models.post_storages_verifications_permissions_response_default import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    response_default = PostStoragesVerificationsPermissionsResponseDefault.from_dict(
        response.json()
    )
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Any | PostStoragesVerificationsPermissionsResponse200 | PostStoragesVerificationsPermissionsResponseDefault]
    """
...
def sync(
    *,
    ...
    Returns:
        Any | PostStoragesVerificationsPermissionsResponse200 | PostStoragesVerificationsPermissionsResponseDefault
    """
