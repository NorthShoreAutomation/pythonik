...
if TYPE_CHECKING:
    ...
    from ..models.users_basic_schema_facets import UsersBasicSchemaFacets
...
class UsersBasicSchema:
    """
    Attributes:
        facets (UsersBasicSchemaFacets | Unset):
        first_url (str | Unset):
        last_url (str | Unset):
        next_url (str | Unset):
        objects (list[UserBasicElasticSchema] | Unset):
        page (int | Unset):
        pages (int | Unset):
        per_page (int | Unset):
        prev_url (str | Unset):
    ...
    facets: UsersBasicSchemaFacets | Unset = UNSET
    first_url: str | Unset = UNSET
    last_url: str | Unset = UNSET
    next_url: str | Unset = UNSET
    objects: list[UserBasicElasticSchema] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_facets, Unset):
            ...
            facets = UsersBasicSchemaFacets.from_dict(_facets)
        ...
        if _objects is not UNSET:
            ...
            for objects_item_data in _objects:
                objects_item = UserBasicElasticSchema.from_dict(objects_item_data)
