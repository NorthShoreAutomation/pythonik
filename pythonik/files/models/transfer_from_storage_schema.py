...
if TYPE_CHECKING:
    from ..models.transfer_from_storage_schema_job_steps_type_0 import (
...
class TransferFromStorageSchema:
    ...
    Attributes:
        ...
        job_steps (None | TransferFromStorageSchemaJobStepsType0 | Unset):
    ...
    job_steps: None | TransferFromStorageSchemaJobStepsType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.job_steps, Unset):
            job_steps = UNSET
        elif isinstance(self.job_steps, TransferFromStorageSchemaJobStepsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_job_steps(
            data: object,
        ) -> None | TransferFromStorageSchemaJobStepsType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                job_steps_type_0 = TransferFromStorageSchemaJobStepsType0.from_dict(
                    data
                )
                ...
                pass
            return cast(None | TransferFromStorageSchemaJobStepsType0 | Unset, data)
