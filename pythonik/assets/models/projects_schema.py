...
T = TypeVar("T", bound="ProjectsSchema")
...
class ProjectsSchema:
    ...
    Attributes:
        ...
        objects (list[ProjectSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[ProjectSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[ProjectSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = ProjectSchema.from_dict(
                ...
                pass
            return cast(list[ProjectSchema] | None | Unset, data)
        ...
        projects_schema.additional_properties = d
