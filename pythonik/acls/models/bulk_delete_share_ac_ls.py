...
T = TypeVar("T", bound="BulkDeleteShareACLs")


@_attrs_define
class BulkDeleteShareACLs:
    """
    Attributes:
        share_ids (list[UUID]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_delete_share_ac_ls = cls(
            share_ids=share_ids,
        )

        bulk_delete_share_ac_ls.additional_properties = d
        return bulk_delete_share_ac_ls
