...
class AnalysisServiceAccountsSchema:
    """
    Attributes:
        objects (list[AnalysisServiceAccountReadSchema] | None | Unset):
    """

    objects: list[AnalysisServiceAccountReadSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[AnalysisServiceAccountReadSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = AnalysisServiceAccountReadSchema.from_dict(
                ...
                pass
            return cast(list[AnalysisServiceAccountReadSchema] | None | Unset, data)
