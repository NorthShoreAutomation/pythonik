...
class GroupWithRolesBaseSchema:
    ...
    Attributes:
        name (str):
        alias (str | Unset):
        default_user_type (GroupWithRolesBaseSchemaDefaultUserType | Unset):
        description (str | Unset):
        external_id (None | str | Unset):
        group_type (GroupWithRolesBaseSchemaGroupType | Unset):
        id (UUID | Unset):
    ...
    default_user_type: GroupWithRolesBaseSchemaDefaultUserType | Unset = UNSET
    description: str | Unset = UNSET
    external_id: None | str | Unset = UNSET
    group_type: GroupWithRolesBaseSchemaGroupType | Unset = UNSET
    id: UUID | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_user_type, Unset):
            ...
            default_user_type = GroupWithRolesBaseSchemaDefaultUserType(
                _default_user_type
            )
        ...
        if isinstance(_group_type, Unset):
            ...
            group_type = GroupWithRolesBaseSchemaGroupType(_group_type)
