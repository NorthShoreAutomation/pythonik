...
class AssetVersion:
    """
    Attributes:
        analyze_status (AssetVersionAnalyzeStatus | Unset):
        archive_status (AssetVersionArchiveStatus | Unset):
        created_by_user (UUID | Unset):
        created_by_user_info (User | Unset):
        date_created (datetime.datetime | Unset):
        face_recognition_status (AssetVersionFaceRecognitionStatus | Unset):
        has_unconfirmed_persons (bool | Unset):
        id (UUID | Unset):
        is_online (bool | Unset):
        person_ids (list[UUID] | Unset):
        status (AssetVersionStatus | Unset):
        transcribe_status (AssetVersionTranscribeStatus | Unset):
        transcribed_languages (list[str] | Unset):
        version_number (int | Unset):
    """

    analyze_status: AssetVersionAnalyzeStatus | Unset = UNSET
    archive_status: AssetVersionArchiveStatus | Unset = UNSET
    created_by_user: UUID | Unset = UNSET
    created_by_user_info: User | Unset = UNSET
    date_created: datetime.datetime | Unset = UNSET
    face_recognition_status: AssetVersionFaceRecognitionStatus | Unset = UNSET
    has_unconfirmed_persons: bool | Unset = UNSET
    id: UUID | Unset = UNSET
    is_online: bool | Unset = UNSET
    person_ids: list[UUID] | Unset = UNSET
    status: AssetVersionStatus | Unset = UNSET
    transcribe_status: AssetVersionTranscribeStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_analyze_status, Unset):
            ...
            analyze_status = AssetVersionAnalyzeStatus(_analyze_status)
        ...
        if isinstance(_archive_status, Unset):
            ...
            archive_status = AssetVersionArchiveStatus(_archive_status)
        ...
        if isinstance(_face_recognition_status, Unset):
            ...
            face_recognition_status = AssetVersionFaceRecognitionStatus(
        ...
        if isinstance(_status, Unset):
            ...
            status = AssetVersionStatus(_status)
        ...
        if isinstance(_transcribe_status, Unset):
            ...
            transcribe_status = AssetVersionTranscribeStatus(_transcribe_status)
