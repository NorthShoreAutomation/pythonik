...
T = TypeVar("T", bound="CollectionCopyKeyframesResponseSchema")


@_attrs_define
class CollectionCopyKeyframesResponseSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collection_copy_keyframes_response_schema = cls(
            custom_keyframe=custom_keyframe,
            custom_poster=custom_poster,
        )

        collection_copy_keyframes_response_schema.additional_properties = d
        return collection_copy_keyframes_response_schema
