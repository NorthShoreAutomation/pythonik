...
T = TypeVar("T", bound="TransferCollectionToStorageRequestSchema")


@_attrs_define
class TransferCollectionToStorageRequestSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfer_collection_to_storage_request_schema = cls(
            id=id,
        ...
        transfer_collection_to_storage_request_schema.additional_properties = d
        return transfer_collection_to_storage_request_schema
