...
from ..models.iconik_storage_gateway_telemetry_schema_start_status import (
    IconikStorageGatewayTelemetrySchemaStartStatus,
)
from ..models.iconik_storage_gateway_telemetry_schema_status import (
...
class IconikStorageGatewayTelemetrySchema:
    ...
    Attributes:
        ...
        start_status (IconikStorageGatewayTelemetrySchemaStartStatus | None | Unset):
        start_status_message (None | str | Unset):
        status (IconikStorageGatewayTelemetrySchemaStatus | None | Unset):
    ...
    start_status: IconikStorageGatewayTelemetrySchemaStartStatus | None | Unset = UNSET
    start_status_message: None | str | Unset = UNSET
    status: IconikStorageGatewayTelemetrySchemaStatus | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.start_status, Unset):
            ...
            self.start_status, IconikStorageGatewayTelemetrySchemaStartStatus
        ):
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, IconikStorageGatewayTelemetrySchemaStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_start_status(
            data: object,
        ) -> IconikStorageGatewayTelemetrySchemaStartStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                start_status_type_1 = IconikStorageGatewayTelemetrySchemaStartStatus(
                    data
                )
                ...
                pass
            return cast(
                IconikStorageGatewayTelemetrySchemaStartStatus | None | Unset, data
            )
        ...
        def _parse_status(
            data: object,
        ) -> IconikStorageGatewayTelemetrySchemaStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = IconikStorageGatewayTelemetrySchemaStatus(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(IconikStorageGatewayTelemetrySchemaStatus | None | Unset, data)
