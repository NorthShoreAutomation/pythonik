...
T = TypeVar("T", bound="GetStoragesByStorageIdVerificationsPermissionsResponse200")


@_attrs_define
class GetStoragesByStorageIdVerificationsPermissionsResponse200:
    """
    Example:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_storages_by_storage_id_verifications_permissions_response_200 = cls(
            cors=cors,
        ...
        get_storages_by_storage_id_verifications_permissions_response_200.additional_properties = d
        return get_storages_by_storage_id_verifications_permissions_response_200
