...
if TYPE_CHECKING:
    from ..models.bulk_collection_transcode_schema_callback_data_request_type_0 import (
        BulkCollectionTranscodeSchemaCallbackDataRequestType0,
    )
    from ..models.bulk_collection_transcode_schema_callback_data_type_0 import (
        BulkCollectionTranscodeSchemaCallbackDataType0,
    )


T = TypeVar("T", bound="BulkCollectionTranscodeSchema")


@_attrs_define
class BulkCollectionTranscodeSchema:
    """
    Attributes:
        ...
        callback_data (BulkCollectionTranscodeSchemaCallbackDataType0 | None | Unset):
        callback_data_request (BulkCollectionTranscodeSchemaCallbackDataRequestType0 | None | Unset):
    ...
    callback_data: BulkCollectionTranscodeSchemaCallbackDataType0 | None | Unset = UNSET
    callback_data_request: (
        BulkCollectionTranscodeSchemaCallbackDataRequestType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.callback_data, Unset):
            ...
            self.callback_data, BulkCollectionTranscodeSchemaCallbackDataType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_callback_data(
            data: object,
        ) -> BulkCollectionTranscodeSchemaCallbackDataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                callback_data_type_0 = (
                    BulkCollectionTranscodeSchemaCallbackDataType0.from_dict(data)
                )
                ...
                pass
            return cast(
                BulkCollectionTranscodeSchemaCallbackDataType0 | None | Unset, data
            )
        ...
        def _parse_callback_data_request(
            ...
            try:
                ...
                callback_data_request_type_0 = (
                    BulkCollectionTranscodeSchemaCallbackDataRequestType0.from_dict(
                        data
                    )
                )
        ...
        bulk_collection_transcode_schema = cls(
            collection_ids=collection_ids,
            include_assets=include_assets,
            include_collections=include_collections,
            job_id=job_id,
        ...
        bulk_collection_transcode_schema.additional_properties = d
        return bulk_collection_transcode_schema
