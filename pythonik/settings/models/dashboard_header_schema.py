...
T = TypeVar("T", bound="DashboardHeaderSchema")


@_attrs_define
class DashboardHeaderSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dashboard_header_schema = cls(
            expanded=expanded,
        )

        dashboard_header_schema.additional_properties = d
        return dashboard_header_schema
