...
T = TypeVar("T", bound="SegmentSchema")
...
class SegmentSchema:
    """
    Attributes:
        segment_type (SegmentSchemaSegmentType):
        ...
        metadata (None | SegmentSchemaMetadataType0 | Unset):
    ...
    metadata: None | SegmentSchemaMetadataType0 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, SegmentSchemaMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        segment_type = SegmentSchemaSegmentType(d.pop("segment_type"))
        ...
        def _parse_metadata(data: object) -> None | SegmentSchemaMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = SegmentSchemaMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SegmentSchemaMetadataType0 | Unset, data)
        ...
        segment_schema.additional_properties = d
