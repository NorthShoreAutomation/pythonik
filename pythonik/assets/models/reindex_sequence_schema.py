...
T = TypeVar("T", bound="ReindexSequenceSchema")


@_attrs_define
class ReindexSequenceSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_sequence_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_sequence_schema.additional_properties = d
        return reindex_sequence_schema
