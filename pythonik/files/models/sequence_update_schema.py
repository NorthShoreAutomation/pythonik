...
from ..models.sequence_update_schema_status import SequenceUpdateSchemaStatus
from ..models.sequence_update_schema_template_engine import (
...
class SequenceUpdateSchema:
    ...
    Attributes:
        ...
        size (int | None | Unset):
        status (None | SequenceUpdateSchemaStatus | Unset):
        storage_id (None | Unset | UUID):
        template (None | str | Unset):
        template_engine (None | SequenceUpdateSchemaTemplateEngine | Unset):
    ...
    status: None | SequenceUpdateSchemaStatus | Unset = UNSET
    storage_id: None | Unset | UUID = UNSET
    template: None | str | Unset = UNSET
    template_engine: None | SequenceUpdateSchemaTemplateEngine | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, SequenceUpdateSchemaStatus):
        ...
        elif isinstance(self.template_engine, SequenceUpdateSchemaTemplateEngine):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_status(data: object) -> None | SequenceUpdateSchemaStatus | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = SequenceUpdateSchemaStatus(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SequenceUpdateSchemaStatus | Unset, data)
        ...
        def _parse_template_engine(
            data: object,
        ) -> None | SequenceUpdateSchemaTemplateEngine | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                template_engine_type_1 = SequenceUpdateSchemaTemplateEngine(data)

                return template_engine_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SequenceUpdateSchemaTemplateEngine | Unset, data)
