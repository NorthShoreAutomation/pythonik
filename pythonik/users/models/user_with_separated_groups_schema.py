...
class UserWithSeparatedGroupsSchema:
    ...
    Attributes:
        ...
        disable_mixpanel (bool | Unset):
        email (str | Unset):
        email_marketing_consent (bool | None | Unset):
        first_name (None | str | Unset):
        groups (list[UUID] | Unset):
        has_domain_been_migrated_to_simplified_acls (bool | Unset):
        ...
        metadata (Any | Unset):
        onboarding_goal (UserWithSeparatedGroupsSchemaOnboardingGoal | Unset):
        password (str | Unset):
        ...
        role_groups (list[UUID] | Unset):
        status (UserWithSeparatedGroupsSchemaStatus | Unset):
        system_domain_id (UUID | Unset):
        system_domains (list[UUID] | Unset):
        system_metadata (UserSystemMetadataSchema | Unset):
        system_name (str | Unset):
        teams (list[UUID] | Unset):
    """
    ...
    disable_mixpanel: bool | Unset = UNSET
    email: str | Unset = UNSET
    email_marketing_consent: bool | None | Unset = UNSET
    first_name: None | str | Unset = UNSET
    groups: list[UUID] | Unset = UNSET
    has_domain_been_migrated_to_simplified_acls: bool | Unset = UNSET
    ...
    onboarding_goal: UserWithSeparatedGroupsSchemaOnboardingGoal | Unset = UNSET
    ...
    role_groups: list[UUID] | Unset = UNSET
    status: UserWithSeparatedGroupsSchemaStatus | Unset = UNSET
    system_domain_id: UUID | Unset = UNSET
    system_domains: list[UUID] | Unset = UNSET
    system_metadata: UserSystemMetadataSchema | Unset = UNSET
    system_name: str | Unset = UNSET
    teams: list[UUID] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        role_groups: list[str] | Unset = UNSET
        if not isinstance(self.role_groups, Unset):
            role_groups = []
            for role_groups_item_data in self.role_groups:
                role_groups_item = str(role_groups_item_data)
                role_groups.append(role_groups_item)
        ...
        if not isinstance(self.teams, Unset):
            ...
            for teams_item_data in self.teams:
                teams_item = str(teams_item_data)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        disable_mixpanel = d.pop("disable_mixpanel", UNSET)
        ...
        has_domain_been_migrated_to_simplified_acls = d.pop(
        ...
        if isinstance(_onboarding_goal, Unset):
            ...
            onboarding_goal = UserWithSeparatedGroupsSchemaOnboardingGoal(
                _onboarding_goal
            )
        ...
        _role_groups = d.pop("role_groups", UNSET)
        role_groups: list[UUID] | Unset = UNSET
        if _role_groups is not UNSET:
            role_groups = []
            for role_groups_item_data in _role_groups:
                role_groups_item = UUID(role_groups_item_data)
        ...
        if isinstance(_status, Unset):
            ...
            status = UserWithSeparatedGroupsSchemaStatus(_status)
        ...
        if isinstance(_system_metadata, Unset):
            ...
            system_metadata = UserSystemMetadataSchema.from_dict(_system_metadata)
        ...
        if _teams is not UNSET:
            ...
            for teams_item_data in _teams:
                teams_item = UUID(teams_item_data)
