...
T = TypeVar("T", bound="ProjectMemberBaseSchema")


@_attrs_define
class ProjectMemberBaseSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_member_base_schema = cls(
        ...
        project_member_base_schema.additional_properties = d
        return project_member_base_schema
