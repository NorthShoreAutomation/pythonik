...
from ..models.job_step_update_schema_status import JobStepUpdateSchemaStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="JobStepUpdateSchema")


@_attrs_define
class JobStepUpdateSchema:
    """
    Attributes:
        label (str):
        status (JobStepUpdateSchemaStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = JobStepUpdateSchemaStatus(d.pop("status"))
        ...
        job_step_update_schema.additional_properties = d
        return job_step_update_schema
