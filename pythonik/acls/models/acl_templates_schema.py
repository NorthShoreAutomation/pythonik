...
class ACLTemplatesSchema:
    """
    Attributes:
        objects (list[ACLTemplateSchema] | None | Unset):
    """

    objects: list[ACLTemplateSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[ACLTemplateSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = ACLTemplateSchema.from_dict(
                ...
                pass
            return cast(list[ACLTemplateSchema] | None | Unset, data)
