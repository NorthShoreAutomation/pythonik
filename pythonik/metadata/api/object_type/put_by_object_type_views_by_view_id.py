...
from ...models.put_by_object_type_views_by_view_id_response_default import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Any | PutByObjectTypeViewsByViewIdResponseDefault:
    ...
    response_default = PutByObjectTypeViewsByViewIdResponseDefault.from_dict(
        response.json()
    )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | PutByObjectTypeViewsByViewIdResponseDefault]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    body: MetadataValuesBatchSchema,
) -> Any | PutByObjectTypeViewsByViewIdResponseDefault | None:
    """Edit view metadata values for multiple objects (Assets, Collections or Segments)
