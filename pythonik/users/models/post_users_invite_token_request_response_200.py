...
T = TypeVar("T", bound="PostUsersInviteTokenRequestResponse200")
...
class PostUsersInviteTokenRequestResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_users_invite_token_request_response_200.additional_properties = d
        return post_users_invite_token_request_response_200
