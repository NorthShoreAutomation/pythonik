...
if TYPE_CHECKING:
    ...
    from ..models.local_transcode_job_schema_analysis_data import (
...
class LocalTranscodeJobSchema:
    ...
    Attributes:
        ...
        analysis_data (LocalTranscodeJobSchemaAnalysisData | Unset):
    ...
    analysis_data: LocalTranscodeJobSchemaAnalysisData | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_analysis_data, Unset):
            ...
            analysis_data = LocalTranscodeJobSchemaAnalysisData.from_dict(
                _analysis_data
            )
