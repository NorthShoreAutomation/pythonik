...
T = TypeVar("T", bound="SavedSearchGroupsSchema")


@_attrs_define
class SavedSearchGroupsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[SavedSearchGroupSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[SavedSearchGroupSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[SavedSearchGroupSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = SavedSearchGroupSchema.from_dict(
                ...
                pass
            return cast(list[SavedSearchGroupSchema] | None | Unset, data)
        ...
        saved_search_groups_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        saved_search_groups_schema.additional_properties = d
        return saved_search_groups_schema
