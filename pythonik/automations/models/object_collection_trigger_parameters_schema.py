...
T = TypeVar("T", bound="ObjectCollectionTriggerParametersSchema")


@_attrs_define
class ObjectCollectionTriggerParametersSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        object_collection_trigger_parameters_schema.additional_properties = d
        return object_collection_trigger_parameters_schema
