...
T = TypeVar("T", bound="StorageFilesQueryParamsSchema")
...
class StorageFilesQueryParamsSchema:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update({})
        if include_parent_statuses is not UNSET:
            field_dict["include_parent_statuses"] = include_parent_statuses
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        storage_files_query_params_schema.additional_properties = d
        return storage_files_query_params_schema
