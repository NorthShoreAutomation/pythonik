...
class AssetExportSchema:
    ...
    Attributes:
        ...
        metadata_format (AssetExportSchemaMetadataFormat | Unset):
    ...
    metadata_format: AssetExportSchemaMetadataFormat | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_metadata_format, Unset):
            ...
            metadata_format = AssetExportSchemaMetadataFormat(_metadata_format)
