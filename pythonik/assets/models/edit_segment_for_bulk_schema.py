...
if TYPE_CHECKING:
    ...
    from ..models.edit_segment_for_bulk_schema_metadata import (
...
class EditSegmentForBulkSchema:
    ...
    Attributes:
        ...
        metadata (EditSegmentForBulkSchemaMetadata | Unset):
        ...
        status (EditSegmentForBulkSchemaStatus | Unset):
    ...
    metadata: EditSegmentForBulkSchemaMetadata | Unset = UNSET
    ...
    status: EditSegmentForBulkSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = EditSegmentForBulkSchemaMetadata.from_dict(_metadata)
        ...
        if isinstance(_status, Unset):
            ...
            status = EditSegmentForBulkSchemaStatus(_status)
