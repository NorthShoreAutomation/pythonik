...
T = TypeVar("T", bound="ReindexExportLocationSchema")


@_attrs_define
class ReindexExportLocationSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_export_location_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_export_location_schema.additional_properties = d
        return reindex_export_location_schema
