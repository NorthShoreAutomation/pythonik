...
T = TypeVar("T", bound="ReindexAllAssetsSchema")


@_attrs_define
class ReindexAllAssetsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_all_assets_schema = cls(
            asset_ids=asset_ids,
            realms=realms,
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_all_assets_schema.additional_properties = d
        return reindex_all_assets_schema
