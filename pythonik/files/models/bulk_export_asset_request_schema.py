...
class BulkExportAssetRequestSchema:
    """
    Attributes:
        objects (list[ExportAssetRequest] | Unset): List of assets to export. Each asset should contain the asset ID.
        parent_job_id (None | Unset | UUID): Parent job ID
    """

    objects: list[ExportAssetRequest] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _objects is not UNSET:
            ...
            for objects_item_data in _objects:
                objects_item = ExportAssetRequest.from_dict(objects_item_data)
