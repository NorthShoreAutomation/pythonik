...
T = TypeVar("T", bound="CustomActionCreateSchema")


@_attrs_define
class CustomActionCreateSchema:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if read_access_for_everyone is not UNSET:
            field_dict["read_access_for_everyone"] = read_access_for_everyone
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        context = CustomActionCreateSchemaContext(d.pop("context"))
        ...
        custom_action_create_schema = cls(
            ...
            read_access_for_everyone=read_access_for_everyone,
            status=status,
        ...
        custom_action_create_schema.additional_properties = d
        return custom_action_create_schema
