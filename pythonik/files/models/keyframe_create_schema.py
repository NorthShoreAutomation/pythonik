...
T = TypeVar("T", bound="KeyframeCreateSchema")


@_attrs_define
class KeyframeCreateSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = KeyframeCreateSchemaType(d.pop("type"))
        ...
        keyframe_create_schema.additional_properties = d
        return keyframe_create_schema
