...
T = TypeVar("T", bound="TransferSavedSearchToStorageRequestSchema")


@_attrs_define
class TransferSavedSearchToStorageRequestSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfer_saved_search_to_storage_request_schema = cls(
            id=id,
        ...
        transfer_saved_search_to_storage_request_schema.additional_properties = d
        return transfer_saved_search_to_storage_request_schema
