...
if TYPE_CHECKING:
    ...
    from ..models.segment_base_schema_metadata import SegmentBaseSchemaMetadata
    from ..models.transcription_type import TranscriptionType
    from ..models.user import User


T = TypeVar("T", bound="SegmentBaseSchema")


@_attrs_define
class SegmentBaseSchema:
    """
    Attributes:
        segment_type (SegmentBaseSchemaSegmentType):
        asset_id (UUID | Unset):
        ...
        metadata (SegmentBaseSchemaMetadata | Unset):
        ...
        status (SegmentBaseSchemaStatus | Unset):
    ...
    metadata: SegmentBaseSchemaMetadata | Unset = UNSET
    ...
    status: SegmentBaseSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        segment_type = SegmentBaseSchemaSegmentType(d.pop("segment_type"))
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = SegmentBaseSchemaMetadata.from_dict(_metadata)
        ...
        if isinstance(_status, Unset):
            ...
            status = SegmentBaseSchemaStatus(_status)
        ...
        segment_base_schema.additional_properties = d
        return segment_base_schema
