...
T = TypeVar("T", bound="ReindexPropagatingACLSchema")


@_attrs_define
class ReindexPropagatingACLSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_propagating_acl_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_propagating_acl_schema.additional_properties = d
        return reindex_propagating_acl_schema
