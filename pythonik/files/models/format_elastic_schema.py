...
class FormatElasticSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(
            data: object,
        ) -> list[FormatElasticSchemaMetadataType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for metadata_type_0_item_data in _metadata_type_0:
                    metadata_type_0_item = (
                        FormatElasticSchemaMetadataType0Item.from_dict(
                ...
                pass
            return cast(list[FormatElasticSchemaMetadataType0Item] | None | Unset, data)
