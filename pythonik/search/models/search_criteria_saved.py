...
from ..models.search_criteria_saved_doc_types_type_0_item import (
...
T = TypeVar("T", bound="SearchCriteriaSaved")


@_attrs_define
class SearchCriteriaSaved:
    """
    Attributes:
        doc_types (list[SearchCriteriaSavedDocTypesType0Item] | None | Unset):
    ...
    doc_types: list[SearchCriteriaSavedDocTypesType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_doc_types(
            data: object,
        ) -> list[SearchCriteriaSavedDocTypesType0Item] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for doc_types_type_0_item_data in _doc_types_type_0:
                    doc_types_type_0_item = SearchCriteriaSavedDocTypesType0Item(
                ...
                pass
            return cast(list[SearchCriteriaSavedDocTypesType0Item] | None | Unset, data)
        ...
        search_criteria_saved.additional_properties = d
        return search_criteria_saved
