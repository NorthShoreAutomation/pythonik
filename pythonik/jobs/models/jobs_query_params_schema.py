...
T = TypeVar("T", bound="JobsQueryParamsSchema")


@_attrs_define
class JobsQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobs_query_params_schema.additional_properties = d
        return jobs_query_params_schema
