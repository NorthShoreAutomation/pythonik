...
if TYPE_CHECKING:
    from ..models.person_by_asset_and_version_in_admin import (
        PersonByAssetAndVersionInAdmin,
    )


T = TypeVar("T", bound="PersonAssetsVersionsListSchema")


@_attrs_define
class PersonAssetsVersionsListSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[PersonByAssetAndVersionInAdmin] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[PersonByAssetAndVersionInAdmin] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[PersonByAssetAndVersionInAdmin] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = PersonByAssetAndVersionInAdmin.from_dict(
                ...
                pass
            return cast(list[PersonByAssetAndVersionInAdmin] | None | Unset, data)
        ...
        person_assets_versions_list_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        person_assets_versions_list_schema.additional_properties = d
        return person_assets_versions_list_schema
