...
T = TypeVar("T", bound="CollectionKeyframesSchema")


@_attrs_define
class CollectionKeyframesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[CollectionKeyframeSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[CollectionKeyframeSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[CollectionKeyframeSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = CollectionKeyframeSchema.from_dict(
                ...
                pass
            return cast(list[CollectionKeyframeSchema] | None | Unset, data)
        ...
        collection_keyframes_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        collection_keyframes_schema.additional_properties = d
        return collection_keyframes_schema
