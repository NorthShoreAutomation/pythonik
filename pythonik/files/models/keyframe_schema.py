...
from ..models.keyframe_schema_type import KeyframeSchemaType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.keyframe_schema_status_type_1 import KeyframeSchemaStatusType1
    from ..models.keyframe_schema_upload_credentials_type_0 import (
...
T = TypeVar("T", bound="KeyframeSchema")


@_attrs_define
class KeyframeSchema:
    """
    Attributes:
        type_ (KeyframeSchemaType):
        ...
        size (int | None | Unset):
        status (KeyframeSchemaStatusType1 | None | Unset):
        storage_id (None | Unset | UUID):
        storage_method (None | str | Unset):
        time_code (None | TimeCodeType | Unset):
        upload_credentials (KeyframeSchemaUploadCredentialsType0 | None | Unset):
    ...
    status: KeyframeSchemaStatusType1 | None | Unset = UNSET
    storage_id: None | Unset | UUID = UNSET
    storage_method: None | str | Unset = UNSET
    time_code: None | TimeCodeType | Unset = UNSET
    upload_credentials: KeyframeSchemaUploadCredentialsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, KeyframeSchemaStatusType1):
        ...
        elif isinstance(self.upload_credentials, KeyframeSchemaUploadCredentialsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = KeyframeSchemaType(d.pop("type"))
        ...
        def _parse_status(data: object) -> KeyframeSchemaStatusType1 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                status_type_1 = KeyframeSchemaStatusType1.from_dict(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(KeyframeSchemaStatusType1 | None | Unset, data)
        ...
        def _parse_upload_credentials(
            data: object,
        ) -> KeyframeSchemaUploadCredentialsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                upload_credentials_type_0 = (
                    KeyframeSchemaUploadCredentialsType0.from_dict(data)
                )

                return upload_credentials_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(KeyframeSchemaUploadCredentialsType0 | None | Unset, data)
        ...
        keyframe_schema.additional_properties = d
        return keyframe_schema
