...
class MultiDomainUserSystemsSchema:
    ...
    Attributes:
        ...
        objects (list[MultiDomainUserSystemSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[MultiDomainUserSystemSchema] | None | Unset = UNSET
        ...
        def _parse_objects(
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = MultiDomainUserSystemSchema.from_dict(
