...
if TYPE_CHECKING:
    from ..models.token_output_schema import TokenOutputSchema


T = TypeVar("T", bound="TokensSchema")
...
class TokensSchema:
    ...
    Attributes:
        ...
        objects (list[TokenOutputSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[TokenOutputSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[TokenOutputSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = TokenOutputSchema.from_dict(
                ...
                pass
            return cast(list[TokenOutputSchema] | None | Unset, data)
        ...
        tokens_schema.additional_properties = d
