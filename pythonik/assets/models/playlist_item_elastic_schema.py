...
if TYPE_CHECKING:
    ...
    from ..models.playlist_item_elastic_schema_files_item import (
        PlaylistItemElasticSchemaFilesItem,
    )
    from ..models.playlist_item_elastic_schema_formats_item import (
        PlaylistItemElasticSchemaFormatsItem,
    )
    from ..models.playlist_item_elastic_schema_keyframes_item import (
        PlaylistItemElasticSchemaKeyframesItem,
    )
    from ..models.playlist_item_elastic_schema_metadata import (
        PlaylistItemElasticSchemaMetadata,
    )
    from ..models.playlist_item_elastic_schema_proxies_item import (
...
T = TypeVar("T", bound="PlaylistItemElasticSchema")


@_attrs_define
class PlaylistItemElasticSchema:
    """
    Attributes:
        title (str):
        analyze_status (PlaylistItemElasticSchemaAnalyzeStatus | Unset):
        ancestor_collections (list[str] | Unset): Unordered list of all ancestor collection ids
        approval (ApprovalSchema | Unset):
        archive_status (PlaylistItemElasticSchemaArchiveStatus | Unset):
        ...
        face_recognition_status (PlaylistItemElasticSchemaFaceRecognitionStatus | Unset):
        favoured (bool | Unset):
        files (list[PlaylistItemElasticSchemaFilesItem] | Unset):
        formats (list[PlaylistItemElasticSchemaFormatsItem] | Unset):
        has_unconfirmed_persons (bool | Unset):
        id (UUID | Unset):
        in_collections (list[str] | Unset):
        is_blocked (bool | Unset):
        is_online (bool | Unset):
        keyframes (list[PlaylistItemElasticSchemaKeyframesItem] | Unset):
        last_archive_restore_date (datetime.datetime | Unset):
        limit_download_to_groups (list[UUID] | None | Unset):
        media_type (None | str | Unset):
        metadata (PlaylistItemElasticSchemaMetadata | Unset):
        ...
        position (int | Unset):
        proxies (list[PlaylistItemElasticSchemaProxiesItem] | Unset):
        relations (list[RelationElastic] | Unset):
        site_name (None | str | Unset):
        status (PlaylistItemElasticSchemaStatus | Unset):
        time_end_milliseconds (int | Unset):
        time_start_milliseconds (int | Unset):
        type_ (PlaylistItemElasticSchemaType | Unset):
        updated_by_user (UUID | Unset):
        updated_by_user_info (User | Unset):
        versions (list[AssetVersionSchema] | Unset):
        versions_number (int | Unset):
        warning (None | str | Unset):
    """

    title: str
    analyze_status: PlaylistItemElasticSchemaAnalyzeStatus | Unset = UNSET
    ancestor_collections: list[str] | Unset = UNSET
    approval: ApprovalSchema | Unset = UNSET
    archive_status: PlaylistItemElasticSchemaArchiveStatus | Unset = UNSET
    ...
    files: list[PlaylistItemElasticSchemaFilesItem] | Unset = UNSET
    formats: list[PlaylistItemElasticSchemaFormatsItem] | Unset = UNSET
    ...
    keyframes: list[PlaylistItemElasticSchemaKeyframesItem] | Unset = UNSET
    ...
    metadata: PlaylistItemElasticSchemaMetadata | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_analyze_status, Unset):
            ...
            analyze_status = PlaylistItemElasticSchemaAnalyzeStatus(_analyze_status)
        ...
        if isinstance(_archive_status, Unset):
            ...
            archive_status = PlaylistItemElasticSchemaArchiveStatus(_archive_status)
        ...
        if isinstance(_face_recognition_status, Unset):
            ...
            face_recognition_status = PlaylistItemElasticSchemaFaceRecognitionStatus(
        ...
        if _files is not UNSET:
            ...
            for files_item_data in _files:
                files_item = PlaylistItemElasticSchemaFilesItem.from_dict(
                    files_item_data
                )
        ...
        if _formats is not UNSET:
            ...
            for formats_item_data in _formats:
                formats_item = PlaylistItemElasticSchemaFormatsItem.from_dict(
                    formats_item_data
                )
        ...
        if _keyframes is not UNSET:
            ...
            for keyframes_item_data in _keyframes:
                keyframes_item = PlaylistItemElasticSchemaKeyframesItem.from_dict(
                    keyframes_item_data
                )
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = PlaylistItemElasticSchemaMetadata.from_dict(_metadata)
        ...
        if _proxies is not UNSET:
            ...
            for proxies_item_data in _proxies:
                proxies_item = PlaylistItemElasticSchemaProxiesItem.from_dict(
                    proxies_item_data
                )
        ...
        if isinstance(_status, Unset):
            ...
            status = PlaylistItemElasticSchemaStatus(_status)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PlaylistItemElasticSchemaType(_type_)
        ...
        if _versions is not UNSET:
            ...
            for versions_item_data in _versions:
                versions_item = AssetVersionSchema.from_dict(versions_item_data)
        ...
        playlist_item_elastic_schema = cls(
            title=title,
        ...
        playlist_item_elastic_schema.additional_properties = d
        return playlist_item_elastic_schema
