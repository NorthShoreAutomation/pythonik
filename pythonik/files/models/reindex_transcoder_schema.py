...
T = TypeVar("T", bound="ReindexTranscoderSchema")


@_attrs_define
class ReindexTranscoderSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_transcoder_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_transcoder_schema.additional_properties = d
        return reindex_transcoder_schema
