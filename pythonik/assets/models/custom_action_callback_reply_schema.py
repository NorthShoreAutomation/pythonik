...
T = TypeVar("T", bound="CustomActionCallbackReplySchema")
...
class CustomActionCallbackReplySchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_action_callback_reply_schema.additional_properties = d
        return custom_action_callback_reply_schema
