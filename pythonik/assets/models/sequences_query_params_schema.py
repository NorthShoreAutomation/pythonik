...
T = TypeVar("T", bound="SequencesQueryParamsSchema")


@_attrs_define
class SequencesQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sequences_query_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        sequences_query_params_schema.additional_properties = d
        return sequences_query_params_schema
