...
T = TypeVar("T", bound="BulkSavedSearchObjectsDeleteSchema")


@_attrs_define
class BulkSavedSearchObjectsDeleteSchema:
    """
    Attributes:
        include_assets (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_saved_search_objects_delete_schema.additional_properties = d
        return bulk_saved_search_objects_delete_schema
