...
T = TypeVar("T", bound="UserSystemMetadataSchema")


@_attrs_define
class UserSystemMetadataSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_system_metadata_schema = cls(
            saml_created=saml_created,
        )

        user_system_metadata_schema.additional_properties = d
        return user_system_metadata_schema
