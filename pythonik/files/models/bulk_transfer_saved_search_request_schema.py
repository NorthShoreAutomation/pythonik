...
if TYPE_CHECKING:
    from ..models.transfer_saved_search_to_storage_request import (
        TransferSavedSearchToStorageRequest,
    )


T = TypeVar("T", bound="BulkTransferSavedSearchRequestSchema")
...
class BulkTransferSavedSearchRequestSchema:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_transfer_saved_search_request_schema.additional_properties = d
        return bulk_transfer_saved_search_request_schema
