...
if TYPE_CHECKING:
    from ..models.file_deletion_from_local_storage_schema import (
        FileDeletionFromLocalStorageSchema,
    )


T = TypeVar("T", bound="FileDeletionsSchema")


@_attrs_define
class FileDeletionsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[FileDeletionFromLocalStorageSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[FileDeletionFromLocalStorageSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[FileDeletionFromLocalStorageSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = FileDeletionFromLocalStorageSchema.from_dict(
                ...
                pass
            return cast(list[FileDeletionFromLocalStorageSchema] | None | Unset, data)
        ...
        file_deletions_schema.additional_properties = d
        return file_deletions_schema
