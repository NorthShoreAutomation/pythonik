...
if TYPE_CHECKING:
    from ..models.time_base_type import TimeBaseType


T = TypeVar("T", bound="TimeCodeType")
...
class TimeCodeType:
    ...
    Attributes:
        ...
        time_base (None | TimeBaseType | Unset):
    """

    frames_number: int | None | Unset = UNSET
    is_drop_frame: bool | None | Unset = UNSET
    time_base: None | TimeBaseType | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.time_base, Unset):
            time_base = UNSET
        elif isinstance(self.time_base, TimeBaseType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_time_base(data: object) -> None | TimeBaseType | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                time_base_type_1 = TimeBaseType.from_dict(data)

                return time_base_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | TimeBaseType | Unset, data)
        ...
        time_code_type.additional_properties = d
