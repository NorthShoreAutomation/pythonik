...
class BulkTransferCollectionRequestSchema:
    """
    Attributes:
        objects (list[TransferCollectionToStorageRequest] | None | Unset): List of collections to transfer. Each
            collection should contain the collection ID.
    """

    objects: list[TransferCollectionToStorageRequest] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[TransferCollectionToStorageRequest] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = TransferCollectionToStorageRequest.from_dict(
                ...
                pass
            return cast(list[TransferCollectionToStorageRequest] | None | Unset, data)
