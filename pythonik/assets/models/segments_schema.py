...
if TYPE_CHECKING:
    from ..models.segment_elastic_schema import SegmentElasticSchema
    from ..models.segments_schema_facets_type_0 import SegmentsSchemaFacetsType0


T = TypeVar("T", bound="SegmentsSchema")
...
class SegmentsSchema:
    """
    Attributes:
        facets (None | SegmentsSchemaFacetsType0 | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[SegmentElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: None | SegmentsSchemaFacetsType0 | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[SegmentElasticSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, SegmentsSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(data: object) -> None | SegmentsSchemaFacetsType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = SegmentsSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SegmentsSchemaFacetsType0 | Unset, data)
        ...
        def _parse_objects(data: object) -> list[SegmentElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = SegmentElasticSchema.from_dict(
                ...
                pass
            return cast(list[SegmentElasticSchema] | None | Unset, data)
        ...
        segments_schema.additional_properties = d
