...
class BulkRestoreCollectionRequestSchema:
    ...
    Attributes:
        ...
        objects (list[RestoreCollectionToStorageRequest] | Unset): List of collections to restore. Each collection
            should contain the collection ID.
    """

    destination_storage_id: None | Unset | UUID = UNSET
    objects: list[RestoreCollectionToStorageRequest] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _objects is not UNSET:
            ...
            for objects_item_data in _objects:
                objects_item = RestoreCollectionToStorageRequest.from_dict(
                    objects_item_data
                )
