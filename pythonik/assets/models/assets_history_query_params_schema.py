...
T = TypeVar("T", bound="AssetsHistoryQueryParamsSchema")


@_attrs_define
class AssetsHistoryQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assets_history_query_params_schema.additional_properties = d
        return assets_history_query_params_schema
