...
T = TypeVar("T", bound="FacetBucketSchema")


@_attrs_define
class FacetBucketSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        facet_bucket_schema = cls(
            doc_count=doc_count,
            key=key,
        )

        facet_bucket_schema.additional_properties = d
        return facet_bucket_schema
