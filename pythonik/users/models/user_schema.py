...
from ..models.user_schema_type import UserSchemaType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.user_schema_onboarding_goal_type_1 import (
        UserSchemaOnboardingGoalType1,
    )
    from ..models.user_schema_status_type_1 import UserSchemaStatusType1
...
class UserSchema:
    ...
    Attributes:
        ...
        metadata (Any | Unset):
        onboarding_goal (None | Unset | UserSchemaOnboardingGoalType1):
        ...
        status (None | Unset | UserSchemaStatusType1):
    ...
    onboarding_goal: None | Unset | UserSchemaOnboardingGoalType1 = UNSET
    ...
    status: None | Unset | UserSchemaStatusType1 = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.onboarding_goal, UserSchemaOnboardingGoalType1):
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, UserSchemaStatusType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = UserSchemaType(d.pop("type"))
        ...
        def _parse_onboarding_goal(
            data: object,
        ) -> None | Unset | UserSchemaOnboardingGoalType1:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                onboarding_goal_type_1 = UserSchemaOnboardingGoalType1.from_dict(data)

                return onboarding_goal_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UserSchemaOnboardingGoalType1, data)
        ...
        def _parse_status(data: object) -> None | Unset | UserSchemaStatusType1:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                status_type_1 = UserSchemaStatusType1.from_dict(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UserSchemaStatusType1, data)
