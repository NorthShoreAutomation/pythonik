...
if TYPE_CHECKING:
    ...
    from ..models.search_documents_schema_facets import SearchDocumentsSchemaFacets
...
class SearchDocumentsSchema:
    """
    Attributes:
        facets (SearchDocumentsSchemaFacets | Unset):
        first_url (str | Unset):
        last_url (str | Unset):
        next_url (str | Unset):
        objects (list[SearchDocumentSchema] | Unset):
        page (int | Unset):
        pages (int | Unset):
        per_page (int | Unset):
        prev_url (str | Unset):
    ...
    facets: SearchDocumentsSchemaFacets | Unset = UNSET
    first_url: str | Unset = UNSET
    last_url: str | Unset = UNSET
    next_url: str | Unset = UNSET
    objects: list[SearchDocumentSchema] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_facets, Unset):
            ...
            facets = SearchDocumentsSchemaFacets.from_dict(_facets)
        ...
        if _objects is not UNSET:
            ...
            for objects_item_data in _objects:
                objects_item = SearchDocumentSchema.from_dict(objects_item_data)
