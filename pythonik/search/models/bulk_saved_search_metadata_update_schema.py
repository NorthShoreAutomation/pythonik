...
T = TypeVar("T", bound="BulkSavedSearchMetadataUpdateSchema")


@_attrs_define
class BulkSavedSearchMetadataUpdateSchema:
    """
    Attributes:
        include_assets (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_saved_search_metadata_update_schema = cls(
            include_assets=include_assets,
            include_collections=include_collections,
            job_id=job_id,
            search_ids=search_ids,
        ...
        bulk_saved_search_metadata_update_schema.additional_properties = d
        return bulk_saved_search_metadata_update_schema
