...
@_attrs_define
class PortfolioCreateSchema:
    """
    Attributes:
        name (str):
        playlist_id (UUID):
        config (PortfolioConfigSchema | Unset):
        created_by_user (UUID | Unset):
        date_created (datetime.datetime | Unset):
        date_modified (datetime.datetime | Unset):
        id (UUID | Unset):
        status (PortfolioCreateSchemaStatus | Unset):
        system_domain_id (UUID | Unset):
    """

    name: str
    playlist_id: UUID
    config: PortfolioConfigSchema | Unset = UNSET
    created_by_user: UUID | Unset = UNSET
    date_created: datetime.datetime | Unset = UNSET
    date_modified: datetime.datetime | Unset = UNSET
    id: UUID | Unset = UNSET
    status: PortfolioCreateSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        playlist_id = UUID(d.pop("playlist_id"))
        ...
        if isinstance(_config, Unset):
            ...
            config = PortfolioConfigSchema.from_dict(_config)
        ...
        if isinstance(_status, Unset):
            ...
            status = PortfolioCreateSchemaStatus(_status)
        ...
        portfolio_create_schema.additional_properties = d
        return portfolio_create_schema
