...
T = TypeVar("T", bound="BulkSavedSearchFaceExtractionSchema")


@_attrs_define
class BulkSavedSearchFaceExtractionSchema:
    """
    Attributes:
        include_assets (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_saved_search_face_extraction_schema = cls(
            include_assets=include_assets,
            include_collections=include_collections,
            job_id=job_id,
            search_ids=search_ids,
        ...
        bulk_saved_search_face_extraction_schema.additional_properties = d
        return bulk_saved_search_face_extraction_schema
