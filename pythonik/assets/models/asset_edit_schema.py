...
class AssetEditSchema:
    ...
    Attributes:
        id (UUID):
        analyze_status (AssetEditSchemaAnalyzeStatus | Unset):
        archive_status (AssetEditSchemaArchiveStatus | Unset):
        ...
        face_recognition_status (AssetEditSchemaFaceRecognitionStatus | Unset):
        favoured (bool | Unset):
        ...
        status (AssetEditSchemaStatus | Unset):
        time_end_milliseconds (int | Unset):
        time_start_milliseconds (int | Unset):
        title (str | Unset):
        type_ (AssetEditSchemaType | Unset):
    ...
    id: UUID
    analyze_status: AssetEditSchemaAnalyzeStatus | Unset = UNSET
    archive_status: AssetEditSchemaArchiveStatus | Unset = UNSET
    ...
    face_recognition_status: AssetEditSchemaFaceRecognitionStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_analyze_status, Unset):
            ...
            analyze_status = AssetEditSchemaAnalyzeStatus(_analyze_status)
        ...
        if isinstance(_archive_status, Unset):
            ...
            archive_status = AssetEditSchemaArchiveStatus(_archive_status)
        ...
        if isinstance(_face_recognition_status, Unset):
            ...
            face_recognition_status = AssetEditSchemaFaceRecognitionStatus(
        ...
        if isinstance(_status, Unset):
            ...
            status = AssetEditSchemaStatus(_status)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = AssetEditSchemaType(_type_)
