...
T = TypeVar("T", bound="DeleteQueueFileSetsQueryParamsSchema")


@_attrs_define
class DeleteQueueFileSetsQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_queue_file_sets_query_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        delete_queue_file_sets_query_params_schema.additional_properties = d
        return delete_queue_file_sets_query_params_schema
