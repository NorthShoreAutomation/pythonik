...
T = TypeVar("T", bound="ProjectMembersQueryParamsSchema")


@_attrs_define
class ProjectMembersQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_members_query_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        project_members_query_params_schema.additional_properties = d
        return project_members_query_params_schema
