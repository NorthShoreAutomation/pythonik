...
if TYPE_CHECKING:
    ...
    from ..models.transcode_queue_schema_facets import TranscodeQueueSchemaFacets
...
class TranscodeQueueSchema:
    """
    Attributes:
        facets (TranscodeQueueSchemaFacets | Unset):
        first_url (str | Unset):
        last_url (str | Unset):
        next_url (str | Unset):
        objects (list[TranscodeQueueObjectSchema] | Unset):
        page (int | Unset):
        pages (int | Unset):
        per_page (int | Unset):
        prev_url (str | Unset):
    ...
    facets: TranscodeQueueSchemaFacets | Unset = UNSET
    first_url: str | Unset = UNSET
    last_url: str | Unset = UNSET
    next_url: str | Unset = UNSET
    objects: list[TranscodeQueueObjectSchema] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_facets, Unset):
            ...
            facets = TranscodeQueueSchemaFacets.from_dict(_facets)
        ...
        if _objects is not UNSET:
            ...
            for objects_item_data in _objects:
                objects_item = TranscodeQueueObjectSchema.from_dict(objects_item_data)
