...
from ..models.jobs_bulk_edit_params_schema_status_item import (
    JobsBulkEditParamsSchemaStatusItem,
)
from ..models.jobs_bulk_edit_params_schema_type_item import (
...
class JobsBulkEditParamsSchema:
    ...
    Attributes:
        ...
        ids (list[UUID] | Unset):
        merge_metadata (bool | Unset):
        metadata_automation_id (str | Unset):
        object_id (UUID | Unset):
        parent_id (UUID | Unset):
        query (str | Unset):
        status (list[JobsBulkEditParamsSchemaStatusItem] | Unset):
        type_ (list[JobsBulkEditParamsSchemaTypeItem] | Unset):
    """
    ...
    merge_metadata: bool | Unset = UNSET
    metadata_automation_id: str | Unset = UNSET
    object_id: UUID | Unset = UNSET
    parent_id: UUID | Unset = UNSET
    query: str | Unset = UNSET
    status: list[JobsBulkEditParamsSchemaStatusItem] | Unset = UNSET
    type_: list[JobsBulkEditParamsSchemaTypeItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        merge_metadata = d.pop("merge_metadata", UNSET)
        ...
        if _status is not UNSET:
            ...
            for status_item_data in _status:
                status_item = JobsBulkEditParamsSchemaStatusItem(status_item_data)
        ...
        if _type_ is not UNSET:
            ...
            for type_item_data in _type_:
                type_item = JobsBulkEditParamsSchemaTypeItem(type_item_data)
