...
class ShareBaseSchema:
    ...
    Attributes:
        ...
        drm (ShareBaseSchemaDrm | Unset): DRM settings for the share
        ...
        owner_id (str | Unset):
        population_status (ShareBaseSchemaPopulationStatus | Unset):
        ...
        url (None | str | Unset):
        watermark (ShareBaseSchemaWatermark | Unset): Watermark settings for the share
    """
    ...
    drm: ShareBaseSchemaDrm | Unset = UNSET
    ...
    population_status: ShareBaseSchemaPopulationStatus | Unset = UNSET
    ...
    watermark: ShareBaseSchemaWatermark | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        drm: ShareBaseSchemaDrm | Unset
        if isinstance(_drm, Unset):
            drm = UNSET
        else:
            drm = ShareBaseSchemaDrm(_drm)
        ...
        if isinstance(_population_status, Unset):
            ...
            population_status = ShareBaseSchemaPopulationStatus(_population_status)
        ...
        watermark: ShareBaseSchemaWatermark | Unset
        if isinstance(_watermark, Unset):
            watermark = UNSET
        else:
            watermark = ShareBaseSchemaWatermark(_watermark)
