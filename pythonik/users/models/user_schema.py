...
class UserSchema:
    ...
    Attributes:
        ...
        metadata (Any | Unset):
        onboarding_goal (UserSchemaOnboardingGoal | Unset):
        password (str | Unset):
    ...
    onboarding_goal: UserSchemaOnboardingGoal | Unset = UNSET
    ...
    status: UserSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_onboarding_goal, Unset):
            ...
            onboarding_goal = UserSchemaOnboardingGoal(_onboarding_goal)
        ...
        if isinstance(_status, Unset):
            ...
            status = UserSchemaStatus(_status)
