...
T = TypeVar("T", bound="ComponentsSchema")
...
class ComponentsSchema:
    ...
    Attributes:
        ...
        objects (list[ComponentSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[ComponentSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[ComponentSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = ComponentSchema.from_dict(
        ...
        components_schema.additional_properties = d
