...
if TYPE_CHECKING:
    from ..models.user_basic_elastic_schema import UserBasicElasticSchema
    from ..models.users_basic_schema_facets_type_0 import UsersBasicSchemaFacetsType0


T = TypeVar("T", bound="UsersBasicSchema")


@_attrs_define
class UsersBasicSchema:
    """
    Attributes:
        facets (None | Unset | UsersBasicSchemaFacetsType0):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[UserBasicElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: None | Unset | UsersBasicSchemaFacetsType0 = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[UserBasicElasticSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        from ..models.users_basic_schema_facets_type_0 import (
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, UsersBasicSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(data: object) -> None | Unset | UsersBasicSchemaFacetsType0:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = UsersBasicSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UsersBasicSchemaFacetsType0, data)
        ...
        def _parse_objects(data: object) -> list[UserBasicElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = UserBasicElasticSchema.from_dict(
                ...
                pass
            return cast(list[UserBasicElasticSchema] | None | Unset, data)
        ...
        users_basic_schema.additional_properties = d
        return users_basic_schema
