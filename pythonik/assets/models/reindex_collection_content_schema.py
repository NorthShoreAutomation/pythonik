...
T = TypeVar("T", bound="ReindexCollectionContentSchema")


@_attrs_define
class ReindexCollectionContentSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_collection_content_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_collection_content_schema.additional_properties = d
        return reindex_collection_content_schema
