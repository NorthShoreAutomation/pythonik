...
T = TypeVar("T", bound="RecentAssetsQueryParamsSchema")


@_attrs_define
class RecentAssetsQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recent_assets_query_params_schema = cls(
            page=page,
            per_page=per_page,
        ...
        recent_assets_query_params_schema.additional_properties = d
        return recent_assets_query_params_schema
