...
T = TypeVar("T", bound="SavedSearchGroupQueryParamsSchema")


@_attrs_define
class SavedSearchGroupQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        saved_search_group_query_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        saved_search_group_query_params_schema.additional_properties = d
        return saved_search_group_query_params_schema
