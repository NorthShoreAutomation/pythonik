...
from ...models.put_acl_by_object_type_bulk_response_default import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Any | PutAclByObjectTypeBulkResponseDefault | list[CreateACLsResultSchema]:
    ...
    response_default = PutAclByObjectTypeBulkResponseDefault.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Any | PutAclByObjectTypeBulkResponseDefault | list[CreateACLsResultSchema]]
    """
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    body: CreateMultipleACLsSchema,
) -> Any | PutAclByObjectTypeBulkResponseDefault | list[CreateACLsResultSchema] | None:
    """Create a new acl for multiple objects with multiple permissions
