...
T = TypeVar("T", bound="PropagatingACLSchema")


@_attrs_define
class PropagatingACLSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        propagating_acl_schema.additional_properties = d
        return propagating_acl_schema
