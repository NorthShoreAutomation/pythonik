...
T = TypeVar("T", bound="UsageHistory")
...
class UsageHistory:
    """
    Attributes:
        widgets (list[UsageHistoryWidget] | None | Unset):
    """

    widgets: list[UsageHistoryWidget] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_widgets(data: object) -> list[UsageHistoryWidget] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for widgets_type_0_item_data in _widgets_type_0:
                    widgets_type_0_item = UsageHistoryWidget.from_dict(
                ...
                pass
            return cast(list[UsageHistoryWidget] | None | Unset, data)
        ...
        usage_history.additional_properties = d
