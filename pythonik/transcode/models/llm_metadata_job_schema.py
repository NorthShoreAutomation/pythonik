...
if TYPE_CHECKING:
    ...
    from ..models.llm_metadata_job_schema_analysis_data_type_0 import (
...
class LLMMetadataJobSchema:
    ...
    Attributes:
        ...
        analysis_data (LLMMetadataJobSchemaAnalysisDataType0 | None | Unset):
    ...
    analysis_data: LLMMetadataJobSchemaAnalysisDataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.analysis_data, Unset):
            analysis_data = UNSET
        elif isinstance(self.analysis_data, LLMMetadataJobSchemaAnalysisDataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_analysis_data(
            data: object,
        ) -> LLMMetadataJobSchemaAnalysisDataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                analysis_data_type_0 = LLMMetadataJobSchemaAnalysisDataType0.from_dict(
                    data
                )
                ...
                pass
            return cast(LLMMetadataJobSchemaAnalysisDataType0 | None | Unset, data)
