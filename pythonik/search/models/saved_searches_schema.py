...
if TYPE_CHECKING:
    from ..models.saved_search_elastic_schema import SavedSearchElasticSchema
    from ..models.saved_searches_schema_facets_type_0 import (
        SavedSearchesSchemaFacetsType0,
    )


T = TypeVar("T", bound="SavedSearchesSchema")


@_attrs_define
class SavedSearchesSchema:
    """
    Attributes:
        facets (None | SavedSearchesSchemaFacetsType0 | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[SavedSearchElasticSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: None | SavedSearchesSchemaFacetsType0 | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[SavedSearchElasticSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, SavedSearchesSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(
            data: object,
        ) -> None | SavedSearchesSchemaFacetsType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = SavedSearchesSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SavedSearchesSchemaFacetsType0 | Unset, data)
        ...
        def _parse_objects(
            data: object,
        ) -> list[SavedSearchElasticSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = SavedSearchElasticSchema.from_dict(
                ...
                pass
            return cast(list[SavedSearchElasticSchema] | None | Unset, data)
        ...
        saved_searches_schema.additional_properties = d
        return saved_searches_schema
