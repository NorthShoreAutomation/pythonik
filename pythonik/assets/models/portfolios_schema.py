...
class PortfoliosSchema:
    ...
    Attributes:
        ...
        objects (list[PortfolioSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[PortfolioSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[PortfolioSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = PortfolioSchema.from_dict(
                ...
                pass
            return cast(list[PortfolioSchema] | None | Unset, data)
