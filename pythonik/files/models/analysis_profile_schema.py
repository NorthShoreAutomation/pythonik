...
class AnalysisProfileSchema:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.settings, Unset):
            settings = UNSET
        elif isinstance(self.settings, AnalysisProfileSchemaSettingsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_settings(
            data: object,
        ) -> AnalysisProfileSchemaSettingsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                settings_type_0 = AnalysisProfileSchemaSettingsType0.from_dict(data)

                return settings_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(AnalysisProfileSchemaSettingsType0 | None | Unset, data)
