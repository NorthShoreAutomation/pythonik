...
from ..models.unpublished_user_audit_schema_operation_type import (
    UnpublishedUserAuditSchemaOperationType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="UnpublishedUserAuditSchema")


@_attrs_define
class UnpublishedUserAuditSchema:
    """
    Attributes:
        log_recipient_id (UUID):
        operation_type (UnpublishedUserAuditSchemaOperationType):
        system_name (str):
        app_id (UUID | Unset):
        client_ip (str | Unset):
    ...
    def to_dict(self) -> dict[str, Any]:
        log_recipient_id = str(self.log_recipient_id)
        ...
        field_dict.update(
            {
                "log_recipient_id": log_recipient_id,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        log_recipient_id = UUID(d.pop("log_recipient_id"))
        ...
        unpublished_user_audit_schema = cls(
            log_recipient_id=log_recipient_id,
            operation_type=operation_type,
            system_name=system_name,
            app_id=app_id,
        ...
        unpublished_user_audit_schema.additional_properties = d
        return unpublished_user_audit_schema
