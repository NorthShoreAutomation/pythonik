...
T = TypeVar("T", bound="TranscodersQueryParamsSchema")


@_attrs_define
class TranscodersQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transcoders_query_params_schema = cls(
            page=page,
            per_page=per_page,
            sort=sort,
        )

        transcoders_query_params_schema.additional_properties = d
        return transcoders_query_params_schema
