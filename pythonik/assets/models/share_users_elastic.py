...
T = TypeVar("T", bound="ShareUsersElastic")


@_attrs_define
class ShareUsersElastic:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        share_users_elastic.additional_properties = d
        return share_users_elastic
