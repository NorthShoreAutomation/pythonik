...
T = TypeVar("T", bound="MultiDomainUserSystemsSchema")


@_attrs_define
class MultiDomainUserSystemsSchema:
    """
    Attributes:
        first_url (str | Unset):
        last_url (str | Unset):
        next_url (str | Unset):
        objects (list[MultiDomainUserSystemSchema] | Unset):
        page (int | Unset):
        pages (int | Unset):
        per_page (int | Unset):
        prev_url (str | Unset):
    ...
    objects: list[MultiDomainUserSystemSchema] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _objects is not UNSET:
            ...
            for objects_item_data in _objects:
                objects_item = MultiDomainUserSystemSchema.from_dict(objects_item_data)
        ...
        multi_domain_user_systems_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        multi_domain_user_systems_schema.additional_properties = d
        return multi_domain_user_systems_schema
