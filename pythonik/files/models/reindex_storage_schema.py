...
T = TypeVar("T", bound="ReindexStorageSchema")


@_attrs_define
class ReindexStorageSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reindex_storage_schema = cls(
            sync_to_another_dc=sync_to_another_dc,
        )

        reindex_storage_schema.additional_properties = d
        return reindex_storage_schema
