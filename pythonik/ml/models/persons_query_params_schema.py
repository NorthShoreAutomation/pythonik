...
T = TypeVar("T", bound="PersonsQueryParamsSchema")


@_attrs_define
class PersonsQueryParamsSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        persons_query_params_schema = cls(
            page=page,
            per_page=per_page,
            scroll=scroll,
            scroll_id=scroll_id,
        ...
        persons_query_params_schema.additional_properties = d
        return persons_query_params_schema
