...
T = TypeVar("T", bound="ZencoderSettingsSchema")


@_attrs_define
class ZencoderSettingsSchema:
    """
    Attributes:
        api_key (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        zencoder_settings_schema.additional_properties = d
        return zencoder_settings_schema
