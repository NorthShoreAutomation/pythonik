...
class GetShareSchema:
    ...
    Attributes:
        ...
        drm (GetShareSchemaDrm | Unset): DRM settings for the share
        ...
        owner_id (str | Unset):
        population_status (GetShareSchemaPopulationStatus | Unset):
        ...
        upload_storage (UploadStorage | Unset):
        upload_storage_id (None | Unset | UUID):
        upload_storage_presign_md5_checksum (bool | Unset):
        url (None | str | Unset):
        users (list[ShareUser] | Unset):
        watermark (GetShareSchemaWatermark | Unset): Watermark settings for the share
    """
    ...
    drm: GetShareSchemaDrm | Unset = UNSET
    ...
    population_status: GetShareSchemaPopulationStatus | Unset = UNSET
    ...
    upload_storage: UploadStorage | Unset = UNSET
    upload_storage_id: None | Unset | UUID = UNSET
    upload_storage_presign_md5_checksum: bool | Unset = UNSET
    url: None | str | Unset = UNSET
    users: list[ShareUser] | Unset = UNSET
    watermark: GetShareSchemaWatermark | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        upload_storage: dict[str, Any] | Unset = UNSET
        if not isinstance(self.upload_storage, Unset):
        ...
        upload_storage_presign_md5_checksum = self.upload_storage_presign_md5_checksum
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        drm: GetShareSchemaDrm | Unset
        if isinstance(_drm, Unset):
            drm = UNSET
        else:
            drm = GetShareSchemaDrm(_drm)
        ...
        if isinstance(_population_status, Unset):
            ...
            population_status = GetShareSchemaPopulationStatus(_population_status)
        ...
        _upload_storage = d.pop("upload_storage", UNSET)
        upload_storage: UploadStorage | Unset
        if isinstance(_upload_storage, Unset):
            upload_storage = UNSET
        else:
            upload_storage = UploadStorage.from_dict(_upload_storage)
        ...
        upload_storage_presign_md5_checksum = d.pop(
        ...
        if _users is not UNSET:
            ...
            for users_item_data in _users:
                users_item = ShareUser.from_dict(users_item_data)

                users.append(users_item)

        _watermark = d.pop("watermark", UNSET)
        watermark: GetShareSchemaWatermark | Unset
        if isinstance(_watermark, Unset):
            watermark = UNSET
        else:
            watermark = GetShareSchemaWatermark(_watermark)
