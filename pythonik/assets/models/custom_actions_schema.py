...
T = TypeVar("T", bound="CustomActionsSchema")


@_attrs_define
class CustomActionsSchema:
    """
    Attributes:
        objects (list[CustomActionSchema] | None | Unset):
    """

    objects: list[CustomActionSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[CustomActionSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = CustomActionSchema.from_dict(
                ...
                pass
            return cast(list[CustomActionSchema] | None | Unset, data)

        objects = _parse_objects(d.pop("objects", UNSET))

        custom_actions_schema = cls(
            objects=objects,
        )

        custom_actions_schema.additional_properties = d
        return custom_actions_schema
