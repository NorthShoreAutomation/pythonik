...
T = TypeVar("T", bound="AssetArchivedTriggerParameters")


@_attrs_define
class AssetArchivedTriggerParameters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        asset_archived_trigger_parameters = cls(
            storage_id=storage_id,
        )

        asset_archived_trigger_parameters.additional_properties = d
        return asset_archived_trigger_parameters
