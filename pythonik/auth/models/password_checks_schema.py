...
T = TypeVar("T", bound="PasswordChecksSchema")


@_attrs_define
class PasswordChecksSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        password_checks_schema.additional_properties = d
        return password_checks_schema
