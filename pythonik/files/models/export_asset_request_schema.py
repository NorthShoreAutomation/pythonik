...
T = TypeVar("T", bound="ExportAssetRequestSchema")


@_attrs_define
class ExportAssetRequestSchema:
    """
    Attributes:
        id (UUID): ID of the object to export.
        destination_filename (None | str | Unset): Name of the file to export.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        export_asset_request_schema = cls(
            id=id,
        ...
        export_asset_request_schema.additional_properties = d
        return export_asset_request_schema
