...
if TYPE_CHECKING:
    ...
    from ..models.segment_schema_metadata import SegmentSchemaMetadata
...
class SegmentSchema:
    ...
    Attributes:
        ...
        metadata (SegmentSchemaMetadata | Unset):
        ...
        status (SegmentSchemaStatus | Unset):
    ...
    metadata: SegmentSchemaMetadata | Unset = UNSET
    ...
    status: SegmentSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = SegmentSchemaMetadata.from_dict(_metadata)
        ...
        if isinstance(_status, Unset):
            ...
            status = SegmentSchemaStatus(_status)
