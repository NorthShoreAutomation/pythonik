...
if TYPE_CHECKING:
    from ..models.trigger_schema import TriggerSchema


T = TypeVar("T", bound="TriggersSchema")


@_attrs_define
class TriggersSchema:
    """
    Attributes:
        objects (list[TriggerSchema] | None | Unset):
    """

    objects: list[TriggerSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[TriggerSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = TriggerSchema.from_dict(
                ...
                pass
            return cast(list[TriggerSchema] | None | Unset, data)
        ...
        triggers_schema.additional_properties = d
        return triggers_schema
