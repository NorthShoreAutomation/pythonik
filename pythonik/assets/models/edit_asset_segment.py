...
if TYPE_CHECKING:
    ...
    from ..models.edit_asset_segment_metadata import EditAssetSegmentMetadata
    from ..models.face_bounding_box import FaceBoundingBox
    from ..models.transcription_type import TranscriptionType
    from ..models.user import User


T = TypeVar("T", bound="EditAssetSegment")


@_attrs_define
class EditAssetSegment:
    """
    Attributes:
        id (UUID):
        segment_type (EditAssetSegmentSegmentType):
        asset_id (UUID | Unset):
        ...
        metadata (EditAssetSegmentMetadata | Unset):
        ...
        status (EditAssetSegmentStatus | Unset):
    ...
    metadata: EditAssetSegmentMetadata | Unset = UNSET
    ...
    status: EditAssetSegmentStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        segment_type = EditAssetSegmentSegmentType(d.pop("segment_type"))
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = EditAssetSegmentMetadata.from_dict(_metadata)
        ...
        if isinstance(_status, Unset):
            ...
            status = EditAssetSegmentStatus(_status)
        ...
        edit_asset_segment.additional_properties = d
        return edit_asset_segment
