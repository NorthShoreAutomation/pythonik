...
if TYPE_CHECKING:
    from ..models.discovery_entity import DiscoveryEntity


T = TypeVar("T", bound="DiscoveryEntitiesSchema")


@_attrs_define
class DiscoveryEntitiesSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[DiscoveryEntity] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[DiscoveryEntity] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[DiscoveryEntity] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = DiscoveryEntity.from_dict(
                ...
                pass
            return cast(list[DiscoveryEntity] | None | Unset, data)
        ...
        discovery_entities_schema.additional_properties = d
        return discovery_entities_schema
