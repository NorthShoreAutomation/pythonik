...
T = TypeVar("T", bound="WebhooksSchema")
...
class WebhooksSchema:
    """
    Attributes:
        objects (list[WebhookSchema] | None | Unset):
    """

    objects: list[WebhookSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[WebhookSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = WebhookSchema.from_dict(
                ...
                pass
            return cast(list[WebhookSchema] | None | Unset, data)
        ...
        webhooks_schema.additional_properties = d
