...
T = TypeVar("T", bound="TranscodeQueueSchemaFacetsType0")


@_attrs_define
class TranscodeQueueSchemaFacetsType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        transcode_queue_schema_facets_type_0 = cls()
        ...
        transcode_queue_schema_facets_type_0.additional_properties = (
            additional_properties
        )
        return transcode_queue_schema_facets_type_0
