...
if TYPE_CHECKING:
    ...
    from ..models.segment_metadata_type_0 import SegmentMetadataType0
    from ..models.segment_status_type_1 import SegmentStatusType1
...
class Segment:
    ...
    Attributes:
        ...
        metadata (None | SegmentMetadataType0 | Unset):
        ...
        status (None | SegmentStatusType1 | Unset):
    ...
    metadata: None | SegmentMetadataType0 | Unset = UNSET
    ...
    status: None | SegmentStatusType1 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, SegmentMetadataType0):
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, SegmentStatusType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> None | SegmentMetadataType0 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = SegmentMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SegmentMetadataType0 | Unset, data)
        ...
        def _parse_status(data: object) -> None | SegmentStatusType1 | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                status_type_1 = SegmentStatusType1.from_dict(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SegmentStatusType1 | Unset, data)
