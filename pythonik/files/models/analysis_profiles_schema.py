...
T = TypeVar("T", bound="AnalysisProfilesSchema")


@_attrs_define
class AnalysisProfilesSchema:
    """
    Attributes:
        objects (list[AnalysisProfileSchema] | None | Unset):
    """

    objects: list[AnalysisProfileSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[AnalysisProfileSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = AnalysisProfileSchema.from_dict(
                ...
                pass
            return cast(list[AnalysisProfileSchema] | None | Unset, data)

        objects = _parse_objects(d.pop("objects", UNSET))

        analysis_profiles_schema = cls(
            objects=objects,
        )

        analysis_profiles_schema.additional_properties = d
        return analysis_profiles_schema
