...
if TYPE_CHECKING:
    from ..models.collection_elastic_keyframes_item import (
        CollectionElasticKeyframesItem,
    )
    from ..models.collection_elastic_metadata import CollectionElasticMetadata
...
class CollectionElastic:
    ...
    Attributes:
        ...
        custom_order_status (CollectionElasticCustomOrderStatus | Unset):
        ...
        keyframes (list[CollectionElasticKeyframesItem] | Unset):
        metadata (CollectionElasticMetadata | Unset):
        ...
        status (CollectionElasticStatus | Unset):
    ...
    custom_order_status: CollectionElasticCustomOrderStatus | Unset = UNSET
    ...
    keyframes: list[CollectionElasticKeyframesItem] | Unset = UNSET
    metadata: CollectionElasticMetadata | Unset = UNSET
    ...
    status: CollectionElasticStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_custom_order_status, Unset):
            ...
            custom_order_status = CollectionElasticCustomOrderStatus(
        ...
        if _keyframes is not UNSET:
            ...
            for keyframes_item_data in _keyframes:
                keyframes_item = CollectionElasticKeyframesItem.from_dict(
                    keyframes_item_data
                )
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = CollectionElasticMetadata.from_dict(_metadata)
        ...
        if isinstance(_status, Unset):
            ...
            status = CollectionElasticStatus(_status)
