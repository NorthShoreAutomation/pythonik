...
from ..models.search_criteria_saved_doc_types_item import (
...
class SearchCriteriaSaved:
    """
    Attributes:
        doc_types (list[SearchCriteriaSavedDocTypesItem] | Unset):
    ...
    doc_types: list[SearchCriteriaSavedDocTypesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _doc_types is not UNSET:
            ...
            for doc_types_item_data in _doc_types:
                doc_types_item = SearchCriteriaSavedDocTypesItem(doc_types_item_data)
