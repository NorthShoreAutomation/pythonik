...
from ...models.get_auth_saml_idp_by_identity_provider_id_response_default import (
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Any | GetAuthSamlIdpByIdentityProviderIdResponseDefault | IdentityProviderSchema:
    ...
    response_default = GetAuthSamlIdpByIdentityProviderIdResponseDefault.from_dict(
        response.json()
    )
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Any | GetAuthSamlIdpByIdentityProviderIdResponseDefault | IdentityProviderSchema]
    """
