...
T = TypeVar("T", bound="TransferActionParameters")


@_attrs_define
class TransferActionParameters:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transfer_action_parameters = cls(
            destination_storage_id=destination_storage_id,
            format_name=format_name,
        ...
        transfer_action_parameters.additional_properties = d
        return transfer_action_parameters
