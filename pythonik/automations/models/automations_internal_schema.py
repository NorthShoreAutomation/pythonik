...
if TYPE_CHECKING:
    from ..models.automation_internal_schema import AutomationInternalSchema


T = TypeVar("T", bound="AutomationsInternalSchema")


@_attrs_define
class AutomationsInternalSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[AutomationInternalSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[AutomationInternalSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[AutomationInternalSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = AutomationInternalSchema.from_dict(
                ...
                pass
            return cast(list[AutomationInternalSchema] | None | Unset, data)
        ...
        automations_internal_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        automations_internal_schema.additional_properties = d
        return automations_internal_schema
