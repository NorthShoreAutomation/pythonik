...
T = TypeVar("T", bound="RestoreSavedSearchToStorageRequestSchema")


@_attrs_define
class RestoreSavedSearchToStorageRequestSchema:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if restore_priority is not UNSET:
            field_dict["restore_priority"] = restore_priority
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restore_saved_search_to_storage_request_schema = cls(
            id=id,
        ...
        restore_saved_search_to_storage_request_schema.additional_properties = d
        return restore_saved_search_to_storage_request_schema
