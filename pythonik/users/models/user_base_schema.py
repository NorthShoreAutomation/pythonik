...
T = TypeVar("T", bound="UserBaseSchema")
...
class UserBaseSchema:
    ...
    Attributes:
        ...
        metadata (Any | Unset):
        onboarding_goal (UserBaseSchemaOnboardingGoal | Unset):
        password (str | Unset):
        ...
        status (UserBaseSchemaStatus | Unset):
    ...
    onboarding_goal: UserBaseSchemaOnboardingGoal | Unset = UNSET
    ...
    status: UserBaseSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = UserBaseSchemaType(d.pop("type"))
        ...
        if isinstance(_onboarding_goal, Unset):
            ...
            onboarding_goal = UserBaseSchemaOnboardingGoal(_onboarding_goal)
        ...
        if isinstance(_status, Unset):
            ...
            status = UserBaseSchemaStatus(_status)
        ...
        user_base_schema.additional_properties = d
