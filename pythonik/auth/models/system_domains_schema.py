...
if TYPE_CHECKING:
    ...
    from ..models.system_domains_schema_facets_type_0 import (
...
class SystemDomainsSchema:
    """
    Attributes:
        facets (None | SystemDomainsSchemaFacetsType0 | Unset):
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[SystemDomainSchema] | None | Unset):
        page (int | None | Unset):
    ...
    facets: None | SystemDomainsSchemaFacetsType0 | Unset = UNSET
    first_url: None | str | Unset = UNSET
    last_url: None | str | Unset = UNSET
    next_url: None | str | Unset = UNSET
    objects: list[SystemDomainSchema] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.facets, Unset):
            facets = UNSET
        elif isinstance(self.facets, SystemDomainsSchemaFacetsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_facets(
            data: object,
        ) -> None | SystemDomainsSchemaFacetsType0 | Unset:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                facets_type_0 = SystemDomainsSchemaFacetsType0.from_dict(data)

                return facets_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | SystemDomainsSchemaFacetsType0 | Unset, data)
        ...
        def _parse_objects(data: object) -> list[SystemDomainSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = SystemDomainSchema.from_dict(
                ...
                pass
            return cast(list[SystemDomainSchema] | None | Unset, data)
