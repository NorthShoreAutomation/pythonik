...
if TYPE_CHECKING:
    ...
    from ..models.groups_schema_facets import GroupsSchemaFacets
...
class GroupsSchema:
    """
    Attributes:
        facets (GroupsSchemaFacets | Unset):
        first_url (str | Unset):
        last_url (str | Unset):
        next_url (str | Unset):
    ...
    facets: GroupsSchemaFacets | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_facets, Unset):
            ...
            facets = GroupsSchemaFacets.from_dict(_facets)
