...
T = TypeVar("T", bound="ReferralCodesSchema")


@_attrs_define
class ReferralCodesSchema:
    """
    Attributes:
        objects (list[ReferralCodeSchema] | None | Unset):
    """

    objects: list[ReferralCodeSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[ReferralCodeSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = ReferralCodeSchema.from_dict(
                ...
                pass
            return cast(list[ReferralCodeSchema] | None | Unset, data)

        objects = _parse_objects(d.pop("objects", UNSET))

        referral_codes_schema = cls(
            objects=objects,
        )

        referral_codes_schema.additional_properties = d
        return referral_codes_schema
