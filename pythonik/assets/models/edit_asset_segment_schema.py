...
from ..models.edit_asset_segment_schema_segment_type import (
    EditAssetSegmentSchemaSegmentType,
)
from ..models.edit_asset_segment_schema_status import EditAssetSegmentSchemaStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.drawing_schema import DrawingSchema
    from ..models.edit_asset_segment_schema_metadata_type_0 import (
...
T = TypeVar("T", bound="EditAssetSegmentSchema")


@_attrs_define
class EditAssetSegmentSchema:
    """
    Attributes:
        id (UUID):
        segment_type (EditAssetSegmentSchemaSegmentType):
        ...
        metadata (EditAssetSegmentSchemaMetadataType0 | None | Unset):
        ...
        status (EditAssetSegmentSchemaStatus | None | Unset):
    ...
    metadata: EditAssetSegmentSchemaMetadataType0 | None | Unset = UNSET
    ...
    status: EditAssetSegmentSchemaStatus | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, Unset):
            metadata = UNSET
        elif isinstance(self.metadata, EditAssetSegmentSchemaMetadataType0):
        ...
        if isinstance(self.status, Unset):
            status = UNSET
        elif isinstance(self.status, EditAssetSegmentSchemaStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        segment_type = EditAssetSegmentSchemaSegmentType(d.pop("segment_type"))
        ...
        def _parse_metadata(
            data: object,
        ) -> EditAssetSegmentSchemaMetadataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = EditAssetSegmentSchemaMetadataType0.from_dict(data)

                return metadata_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EditAssetSegmentSchemaMetadataType0 | None | Unset, data)
        ...
        def _parse_status(data: object) -> EditAssetSegmentSchemaStatus | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                status_type_1 = EditAssetSegmentSchemaStatus(data)

                return status_type_1
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EditAssetSegmentSchemaStatus | None | Unset, data)
        ...
        edit_asset_segment_schema.additional_properties = d
        return edit_asset_segment_schema
