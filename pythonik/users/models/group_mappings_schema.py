...
T = TypeVar("T", bound="GroupMappingsSchema")


@_attrs_define
class GroupMappingsSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[GroupMappingSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[GroupMappingSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[GroupMappingSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = GroupMappingSchema.from_dict(
                ...
                pass
            return cast(list[GroupMappingSchema] | None | Unset, data)
        ...
        group_mappings_schema.additional_properties = d
        return group_mappings_schema
