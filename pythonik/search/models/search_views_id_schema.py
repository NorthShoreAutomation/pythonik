...
T = TypeVar("T", bound="SearchViewsIDSchema")


@_attrs_define
class SearchViewsIDSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        search_views_id_schema = cls(
            object_ids=object_ids,
        )

        search_views_id_schema.additional_properties = d
        return search_views_id_schema
