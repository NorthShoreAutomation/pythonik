...
class AssetPostEditSchema:
    ...
    Attributes:
        id (UUID):
        analyze_status (AssetPostEditSchemaAnalyzeStatus | Unset):
        archive_status (AssetPostEditSchemaArchiveStatus | Unset):
        ...
        face_recognition_status (AssetPostEditSchemaFaceRecognitionStatus | Unset):
        favoured (bool | Unset):
        ...
        publication_status (AssetPostEditSchemaPublicationStatus | Unset):  Default:
            AssetPostEditSchemaPublicationStatus.PUBLISHED.
        site_name (None | str | Unset):
        status (AssetPostEditSchemaStatus | Unset):
        time_end_milliseconds (int | Unset):
        time_start_milliseconds (int | Unset):
        title (str | Unset):
        type_ (AssetPostEditSchemaType | Unset):
    ...
    id: UUID
    analyze_status: AssetPostEditSchemaAnalyzeStatus | Unset = UNSET
    archive_status: AssetPostEditSchemaArchiveStatus | Unset = UNSET
    ...
    face_recognition_status: AssetPostEditSchemaFaceRecognitionStatus | Unset = UNSET
    ...
    publication_status: AssetPostEditSchemaPublicationStatus | Unset = (
        AssetPostEditSchemaPublicationStatus.PUBLISHED
    )
    site_name: None | str | Unset = UNSET
    status: AssetPostEditSchemaStatus | Unset = UNSET
    time_end_milliseconds: int | Unset = UNSET
    time_start_milliseconds: int | Unset = UNSET
    title: str | Unset = UNSET
    type_: AssetPostEditSchemaType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_analyze_status, Unset):
            ...
            analyze_status = AssetPostEditSchemaAnalyzeStatus(_analyze_status)
        ...
        if isinstance(_archive_status, Unset):
            ...
            archive_status = AssetPostEditSchemaArchiveStatus(_archive_status)
        ...
        if isinstance(_face_recognition_status, Unset):
            ...
            face_recognition_status = AssetPostEditSchemaFaceRecognitionStatus(
        ...
        if isinstance(_publication_status, Unset):
            ...
            publication_status = AssetPostEditSchemaPublicationStatus(
                _publication_status
            )
        ...
        if isinstance(_status, Unset):
            ...
            status = AssetPostEditSchemaStatus(_status)
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = AssetPostEditSchemaType(_type_)
