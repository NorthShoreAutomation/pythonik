...
T = TypeVar("T", bound="RangeFilterSchema")


@_attrs_define
class RangeFilterSchema:
    """
    Attributes:
        max_ (None | str | Unset):
        min_ (None | str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        range_filter_schema = cls(
            max_=max_,
            min_=min_,
            timezone=timezone,
        )

        range_filter_schema.additional_properties = d
        return range_filter_schema
