...
from ..models.jobs_bulk_params_schema_type_item import JobsBulkParamsSchemaTypeItem
...
class JobsBulkParamsSchema:
    ...
    Attributes:
        ...
        query (str | Unset):
        type_ (list[JobsBulkParamsSchemaTypeItem] | Unset):
    """
    ...
    type_: list[JobsBulkParamsSchemaTypeItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _type_ is not UNSET:
            ...
            for type_item_data in _type_:
                type_item = JobsBulkParamsSchemaTypeItem(type_item_data)
