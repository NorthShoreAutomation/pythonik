...
T = TypeVar("T", bound="RestoreCollectionToStorageRequestSchema")


@_attrs_define
class RestoreCollectionToStorageRequestSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        restore_collection_to_storage_request_schema.additional_properties = d
        return restore_collection_to_storage_request_schema
