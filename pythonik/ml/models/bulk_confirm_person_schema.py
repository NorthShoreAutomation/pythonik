...
T = TypeVar("T", bound="BulkConfirmPersonSchema")


@_attrs_define
class BulkConfirmPersonSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_confirm_person_schema = cls(
            all_instances_except_unconfirmed=all_instances_except_unconfirmed,
            version_ids=version_ids,
        )

        bulk_confirm_person_schema.additional_properties = d
        return bulk_confirm_person_schema
