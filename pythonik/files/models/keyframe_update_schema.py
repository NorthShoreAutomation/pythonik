...
T = TypeVar("T", bound="KeyframeUpdateSchema")


@_attrs_define
class KeyframeUpdateSchema:
    """
    Attributes:
        type_ (KeyframeUpdateSchemaType):
        ...
        size (int | None | Unset):
        status (KeyframeUpdateSchemaStatus | Unset):
    ...
    status: KeyframeUpdateSchemaStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = KeyframeUpdateSchemaType(d.pop("type"))
        ...
        if isinstance(_status, Unset):
            ...
            status = KeyframeUpdateSchemaStatus(_status)
        ...
        keyframe_update_schema.additional_properties = d
        return keyframe_update_schema
