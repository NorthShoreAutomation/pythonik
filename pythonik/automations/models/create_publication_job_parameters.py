...
if TYPE_CHECKING:
    from ..models.create_publication_job_parameters_metadata_overrides import (
...
class CreatePublicationJobParameters:
    ...
    Attributes:
        ...
        user_id (UUID):
        allow_transfer (bool | Unset):  Default: False.
        metadata_overrides (CreatePublicationJobParametersMetadataOverrides | Unset):
    ...
    template: CreatePublicationTemplate
    user_id: UUID
    allow_transfer: bool | Unset = False
    metadata_overrides: CreatePublicationJobParametersMetadataOverrides | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_metadata_overrides, Unset):
            ...
            metadata_overrides = (
                CreatePublicationJobParametersMetadataOverrides.from_dict(
                    _metadata_overrides
                )
            )
