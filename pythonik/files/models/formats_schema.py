...
T = TypeVar("T", bound="FormatsSchema")
...
class FormatsSchema:
    ...
    Attributes:
        ...
        objects (list[FormatSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[FormatSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(data: object) -> list[FormatSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = FormatSchema.from_dict(
                ...
                pass
            return cast(list[FormatSchema] | None | Unset, data)
        ...
        formats_schema.additional_properties = d
        return formats_schema
