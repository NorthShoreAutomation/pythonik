...
class AssetVersionsKeyframesSchema:
    """
    Attributes:
        objects (list[AssetVersionKeyframesSchema] | None | Unset):
    """

    objects: list[AssetVersionKeyframesSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_objects(
            data: object,
        ) -> list[AssetVersionKeyframesSchema] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = AssetVersionKeyframesSchema.from_dict(
                ...
                pass
            return cast(list[AssetVersionKeyframesSchema] | None | Unset, data)
