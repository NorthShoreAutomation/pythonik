...
T = TypeVar("T", bound="GroupCreateSchema")
...
class GroupCreateSchema:
    ...
    Attributes:
        ...
        default_user_type (GroupCreateSchemaDefaultUserType | Unset):
        description (str | Unset):
        external_id (None | str | Unset):
        group_type (GroupCreateSchemaGroupType | Unset):
        id (UUID | Unset):
    ...
    default_user_type: GroupCreateSchemaDefaultUserType | Unset = UNSET
    description: str | Unset = UNSET
    external_id: None | str | Unset = UNSET
    group_type: GroupCreateSchemaGroupType | Unset = UNSET
    id: UUID | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_user_type, Unset):
            ...
            default_user_type = GroupCreateSchemaDefaultUserType(_default_user_type)
        ...
        if isinstance(_group_type, Unset):
            ...
            group_type = GroupCreateSchemaGroupType(_group_type)
        ...
        group_create_schema.additional_properties = d
        return group_create_schema
