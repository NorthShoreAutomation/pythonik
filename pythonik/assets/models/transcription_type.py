...
if TYPE_CHECKING:
    from ..models.transcription_element_type import TranscriptionElementType


T = TypeVar("T", bound="TranscriptionType")
...
class TranscriptionType:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for words_item_data in _words:
            words_item = TranscriptionElementType.from_dict(words_item_data)
        ...
        transcription_type = cls(
            words=words,
            speaker=speaker,
        )

        transcription_type.additional_properties = d
        return transcription_type
