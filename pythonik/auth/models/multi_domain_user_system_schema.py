...
from ..models.multi_domain_user_system_schema_mfa_methods_configured_item import (
    MultiDomainUserSystemSchemaMfaMethodsConfiguredItem,
)
from ..models.multi_domain_user_system_schema_mfa_methods_item import (
...
class MultiDomainUserSystemSchema:
    ...
    Attributes:
        ...
        logo_url (str | Unset):
        mfa_methods (list[MultiDomainUserSystemSchemaMfaMethodsItem] | Unset):
        mfa_methods_configured (list[MultiDomainUserSystemSchemaMfaMethodsConfiguredItem] | Unset):
    ...
    mfa_methods: list[MultiDomainUserSystemSchemaMfaMethodsItem] | Unset = UNSET
    mfa_methods_configured: (
        list[MultiDomainUserSystemSchemaMfaMethodsConfiguredItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _mfa_methods is not UNSET:
            ...
            for mfa_methods_item_data in _mfa_methods:
                mfa_methods_item = MultiDomainUserSystemSchemaMfaMethodsItem(
