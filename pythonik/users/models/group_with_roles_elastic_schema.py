...
T = TypeVar("T", bound="GroupWithRolesElasticSchema")


@_attrs_define
class GroupWithRolesElasticSchema:
    """
    Attributes:
        name (str):
        alias (str | Unset):
        ...
        default_user_type (GroupWithRolesElasticSchemaDefaultUserType | Unset):
        description (str | Unset):
        external_id (None | str | Unset):
        group_type (GroupWithRolesElasticSchemaGroupType | Unset):
        id (UUID | Unset):
    ...
    default_user_type: GroupWithRolesElasticSchemaDefaultUserType | Unset = UNSET
    description: str | Unset = UNSET
    external_id: None | str | Unset = UNSET
    group_type: GroupWithRolesElasticSchemaGroupType | Unset = UNSET
    id: UUID | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default_user_type, Unset):
            ...
            default_user_type = GroupWithRolesElasticSchemaDefaultUserType(
                _default_user_type
            )
        ...
        if isinstance(_group_type, Unset):
            ...
            group_type = GroupWithRolesElasticSchemaGroupType(_group_type)
        ...
        group_with_roles_elastic_schema = cls(
            name=name,
            alias=alias,
        ...
        group_with_roles_elastic_schema.additional_properties = d
        return group_with_roles_elastic_schema
