...
T = TypeVar("T", bound="BulkSavedSearchActionSchema")


@_attrs_define
class BulkSavedSearchActionSchema:
    """
    Attributes:
        job_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        bulk_saved_search_action_schema = cls(
            job_id=job_id,
            search_ids=search_ids,
        )

        bulk_saved_search_action_schema.additional_properties = d
        return bulk_saved_search_action_schema
