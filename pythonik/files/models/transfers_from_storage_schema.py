...
T = TypeVar("T", bound="TransfersFromStorageSchema")


@_attrs_define
class TransfersFromStorageSchema:
    """
    Attributes:
        first_url (None | str | Unset):
        last_url (None | str | Unset):
        next_url (None | str | Unset):
        objects (list[TransferFromStorageReadSchema] | None | Unset):
        page (int | None | Unset):
    ...
    objects: list[TransferFromStorageReadSchema] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.transfer_from_storage_read_schema import (
        ...
        def _parse_objects(
            data: object,
        ) -> list[TransferFromStorageReadSchema] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for objects_type_0_item_data in _objects_type_0:
                    objects_type_0_item = TransferFromStorageReadSchema.from_dict(
                ...
                pass
            return cast(list[TransferFromStorageReadSchema] | None | Unset, data)
        ...
        transfers_from_storage_schema = cls(
            first_url=first_url,
            last_url=last_url,
            next_url=next_url,
            objects=objects,
        ...
        transfers_from_storage_schema.additional_properties = d
        return transfers_from_storage_schema
