...
T = TypeVar("T", bound="CheckPersonsStatusSchema")


@_attrs_define
class CheckPersonsStatusSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        check_persons_status_schema = cls(
            person_ids=person_ids,
        )

        check_persons_status_schema.additional_properties = d
        return check_persons_status_schema
